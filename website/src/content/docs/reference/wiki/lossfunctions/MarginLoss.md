...
| Constructor | Summary |
|:-----|:--------|
| `MarginLoss(Double,Double,Double)` | Initializes a new instance of the MarginLoss class with the specified parameters. |

## Methods

| Method | Summary |
|:-----|:--------|
| `CalculateDerivative(Vector<>,Vector<>)` | Calculates the derivative of the Margin loss function. |
| `CalculateLoss(Vector<>,Vector<>)` | Calculates the Margin loss between predicted and actual values. |
