---
title: "RootMeanSquaredErrorLoss<T>"
...
| Method | Summary |
|:-----|:--------|
| `CalculateDerivative(Vector<>,Vector<>)` | Calculates the derivative of the RMSE loss with respect to predicted values. |
| `CalculateLoss(Vector<>,Vector<>)` | Calculates the Root Mean Squared Error loss between predicted and actual values. |
