...
| Method | Summary |
|:-----|:--------|
| `CalculateDerivative(Vector<>,Vector<>)` | Calculates the derivative of the Wasserstein loss function. |
| `CalculateLoss(Vector<>,Vector<>)` | Calculates the Wasserstein loss between predicted critic scores and labels. |
