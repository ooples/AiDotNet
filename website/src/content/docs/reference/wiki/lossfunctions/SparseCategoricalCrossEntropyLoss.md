---
title: "SparseCategoricalCrossEntropyLoss<T>"
...
| Constructor | Summary |
|:-----|:--------|
| `SparseCategoricalCrossEntropyLoss` | Initializes a new instance of the SparseCategoricalCrossEntropyLoss class. |

## Methods

| Method | Summary |
|:-----|:--------|
| `CalculateDerivative(Vector<>,Vector<>)` | Calculates the derivative of the Sparse Categorical Cross Entropy loss function. |
| `CalculateLoss(Vector<>,Vector<>)` | Calculates the Sparse Categorical Cross Entropy loss between predicted probabilities and class indices. |
