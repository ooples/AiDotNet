...
| Constructor | Summary |
|:-----|:--------|
| `JaccardLoss` | Initializes a new instance of the JaccardLoss class. |

## Methods

| Method | Summary |
|:-----|:--------|
| `CalculateDerivative(Vector<>,Vector<>)` | Calculates the derivative of the Jaccard loss function. |
| `CalculateLoss(Vector<>,Vector<>)` | Calculates the Jaccard loss between predicted and actual values. |
