---
title: "BinaryCrossEntropyWithLogitsLoss<T>"
...
| Constructor | Summary |
|:-----|:--------|
| `BinaryCrossEntropyWithLogitsLoss` | Initializes a new instance of the BinaryCrossEntropyWithLogitsLoss class. |

## Methods

| Method | Summary |
|:-----|:--------|
| `CalculateDerivative(Vector<>,Vector<>)` | Calculates the derivative of BCE loss with respect to logits. |
| `CalculateLoss(Vector<>,Vector<>)` | Calculates BCE loss directly from raw logits using the numerically stable form. |
