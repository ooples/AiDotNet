...
This adapter lets you add LoRA to Dense or FullyConnected layers.
...
| Constructor | Summary |
|:-----|:--------|
| `DenseLoRAAdapter(ILayer<>,Int32,Double,Boolean)` | Initializes a new Dense LoRA adapter wrapping an existing Dense or FullyConnected layer. |
| `DenseLoRAAdapter(LayerBase<>,Int32,Int32,Double,Boolean)` | Initializes a new Dense LoRA adapter wrapping a base layer that is in deferred-shape state (e.g. |

## Methods

| Method | Summary |
|:-----|:--------|
| `MergeToOriginalLayer` | Merges the LoRA adaptation into the base layer and returns the merged Dense layer. |
