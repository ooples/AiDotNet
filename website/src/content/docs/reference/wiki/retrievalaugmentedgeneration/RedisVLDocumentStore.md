---
title: "RedisVLDocumentStore<T>"
description: "RedisVLDocumentStore<T> — Models & Types in AiDotNet.RetrievalAugmentedGeneration.DocumentStores."
...
| Constructor | Summary |
|:-----|:--------|
| `RedisVLDocumentStore(String,String,Int32)` | Initializes a new instance of the RedisVLDocumentStore class. |
