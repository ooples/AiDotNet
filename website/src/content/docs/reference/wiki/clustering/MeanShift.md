---
title: "MeanShift<T>"
description: "MeanShift<T> — Models & Types in AiDotNet.Clustering.Density."
...
var result = await new AiModelBuilder<double, Matrix<double>, Vector<double>>()
    .ConfigureModel(new MeanShift<double>())
    .ConfigureDataLoader(DataLoaders.FromMatrix(data))
    .BuildAsync();

var labels = result.Predict(data);
Console.WriteLine($"MeanShift: clustered {labels.Length} points.");
```
...
| Constructor | Summary |
|:-----|:--------|
| `MeanShift(MeanShiftOptions<>)` | Initializes a new MeanShift instance. |

## Properties

| Property | Summary |
|:-----|:--------|
| `Bandwidth` | Gets the bandwidth used for clustering. |
