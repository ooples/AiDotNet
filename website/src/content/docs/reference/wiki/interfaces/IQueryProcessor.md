---
title: "IQueryProcessor"
description: "Defines the contract for processing and transforming user queries before retrieval."
...
Query processors improve search results by refining your question.
...
| Method | Summary |
|:-----|:--------|
| `ProcessQuery(String)` | Processes and transforms the input query. |
