---
title: "IKernelFunction<T>"
description: "Defines an interface for kernel functions that measure similarity between data points in machine learning algorithms."
...
| Method | Summary |
|:-----|:--------|
| `Calculate(Vector<>,Vector<>)` | Calculates the similarity between two vectors using this kernel function. |
