...
## [1.0.0](https://github.com/ooples/AiDotNet/compare/v0.231.0...v1.0.0) (2026-09-18)
...
* **#2090:** add AudioHyperparameterOptions, the seventh family base ([944a1fd](https://github.com/ooples/AiDotNet/commit/944a1fd72dc59906b1102a0bcfbd04273e776696)), closes [#2090](https://github.com/ooples/AiDotNet/issues/2090)
* **#2090:** phase 1 — options family bases and the surface ratchet ([9f7fe07](https://github.com/ooples/AiDotNet/commit/9f7fe07b6ce05bb282281f0ea59b78d72f5f9ded)), closes [#2090](https://github.com/ooples/AiDotNet/issues/2090)
* **#2090:** phase 2 — migrate 15 more sequence models to options-driven config ([ee7e48e](https://github.com/ooples/AiDotNet/commit/ee7e48ed3351af2bfd41d9ab6042f8b96ecb14bd)), closes [#2090](https://github.com/ooples/AiDotNet/issues/2090)
* **#2090:** phase 2 — migrate MambaLanguageModel to options-driven config ([ba309b4](https://github.com/ooples/AiDotNet/commit/ba309b416ca647c3b2daee368f0b22e965f97b9f)), closes [#2090](https://github.com/ooples/AiDotNet/issues/2090)
...
* **#2090:** phase 2 — update call sites and lower the ratchet to 1004 ([0f7d208](https://github.com/ooples/AiDotNet/commit/0f7d2087095e4f63f67052b467e950dcca272afc)), closes [#2090](https://github.com/ooples/AiDotNet/issues/2090)
...
* **#2090:** revert exception-doc changes to six unrelated files ([c6b51c1](https://github.com/ooples/AiDotNet/commit/c6b51c15e5e073ca49315719577475962afec02c))
...
* **ci:** a dispatched shard that uploads nothing must not read as success ([4ef4934](https://github.com/ooples/AiDotNet/commit/4ef493410458a9281bf53f40da63fb74fdbfe9ad)), closes [#2086](https://github.com/ooples/AiDotNet/issues/2086)
...
* **ci:** allow instrumented Sonar build to finish ([362b3f0](https://github.com/ooples/AiDotNet/commit/362b3f0855014e1c87e3fc392135e8a2a2d24ba5))
* **ci:** announce a degraded shard map instead of failing silently ([c95b336](https://github.com/ooples/AiDotNet/commit/c95b33659243a08cc0a81108fb31775c00a34bbc))
* **ci:** apply timing noise floor at history envelope ([7912d29](https://github.com/ooples/AiDotNet/commit/7912d29bcb1f6430d336989c103d9c96a05a6e7b))
* **ci:** avoid artifact-list rate-limit storms ([ee25f7e](https://github.com/ooples/AiDotNet/commit/ee25f7eb7f6ad958c90e11b35732305be3a44288))
...
* **ci:** certify healthy selective shard maps ([d43d77b](https://github.com/ooples/AiDotNet/commit/d43d77bd6a54db67cb5494d2b9c62833afac8181))
* **ci:** certify healthy selective shard maps ([6baaff0](https://github.com/ooples/AiDotNet/commit/6baaff00ab3d6427215822f34d8ec8254b5e35ce))
...
* **ci:** execute resolver fixture on Linux ([3c3f61b](https://github.com/ooples/AiDotNet/commit/3c3f61b664732a581fb1d6b798c6eb64a09b1fbb))
...
* **ci:** fail closed on ambiguous shard inventories ([f274133](https://github.com/ooples/AiDotNet/commit/f2741331eff59ae2124ab3da5ef5935250873cce))
...
* **ci:** normalize uploaded artifact digest ([91aafaa](https://github.com/ooples/AiDotNet/commit/91aafaa9bb30703e1b20d5f9d9bdefdc44be4353))
...
* **ci:** preserve required CodeQL status ([213a7f4](https://github.com/ooples/AiDotNet/commit/213a7f427fbb451171cdcff4ccc03a10a36a20ec))
...
* **ci:** release canceled workflow runners ([03d87e7](https://github.com/ooples/AiDotNet/commit/03d87e7d9b2aee32c2009db238afe8e9eccaa22c))
...
* **ci:** resolve one curl executable ([1a2afb3](https://github.com/ooples/AiDotNet/commit/1a2afb3d1fc625d8fd946ce4c9cd70d113ef4ca1))
...
* **ci:** restrict artifact redirects to https ([f0e412f](https://github.com/ooples/AiDotNet/commit/f0e412fe0aabe49e43b498cf63027c45766a30c8))
...
* **ci:** revoke stale shard map certificates ([bd0de19](https://github.com/ooples/AiDotNet/commit/bd0de19bb162cc9a43367c97227d12bd51629ada))
...
* **ci:** suppress unrelated validation safely ([1f126d4](https://github.com/ooples/AiDotNet/commit/1f126d41c7673387d015931c528da9e011f37bc3))
...
* **ci:** validate selector output contracts ([9e600e1](https://github.com/ooples/AiDotNet/commit/9e600e145a56062f0af672749d81cf9360122d30))
...
* **clone:** preserve published shape semantics ([91152e3](https://github.com/ooples/AiDotNet/commit/91152e3feeaf123dee854af458881bfd62adc4ac))
...
* close parameter and CI regression gaps ([70676e7](https://github.com/ooples/AiDotNet/commit/70676e72c88acb8ca886debbd378d8f481ffb230))
...
* **gaussian-splatting:** invalidate the parameter layout after densification ([7288279](https://github.com/ooples/AiDotNet/commit/72882798263f8692a250d5175a52f8bc377e2665)), closes [#1835](https://github.com/ooples/AiDotNet/issues/1835)
...
* **layers:** preserve shape initialization failures ([680c4e9](https://github.com/ooples/AiDotNet/commit/680c4e9f718c26737e628d72c43ce610c7df37b8))
* **layers:** update trainable parameters in place instead of rebinding them ([a503750](https://github.com/ooples/AiDotNet/commit/a5037508bcbc7ba6cb4e8f80388eb288ef00b254)), closes [#1842](https://github.com/ooples/AiDotNet/issues/1842)
...
* **metadata:** stop model metadata from serializing the model eagerly ([b1e8aff](https://github.com/ooples/AiDotNet/commit/b1e8aff4538deea62fee1dd67629e31252113b09)), closes [#1830](https://github.com/ooples/AiDotNet/issues/1830)
...
* **metadata:** synchronize deferred model snapshots ([22e3ec6](https://github.com/ooples/AiDotNet/commit/22e3ec6747349f1489711bb622e5ae476fe11a48))
...
* **neural-networks:** centralize validation rollback ([a9288c3](https://github.com/ooples/AiDotNet/commit/a9288c323cdaf40f96c1fa0e45ad1a17a6910176))
* **neural-networks:** make architecture ownership atomic ([25cb8f6](https://github.com/ooples/AiDotNet/commit/25cb8f681f52d6b6ab9c3c2d16d6e1b5a27b9504))
...
* **neural-networks:** refuse a second model on one architecture instead of aliasing it ([8cf7315](https://github.com/ooples/AiDotNet/commit/8cf7315520fd878e757379408012a8b9baaccb91))
* **neural-networks:** roll back rejected layer claims ([08565ab](https://github.com/ooples/AiDotNet/commit/08565abdbecdf1dda18bf10a03ebcc4f2dc46518))
...
* **release:** preserve verified package recovery ([825a3e6](https://github.com/ooples/AiDotNet/commit/825a3e6a91797f14453deb2c1bb764c351155e75))
...
* add phase 8 for TTS/Speech/Audio and record what phase 1 found ([c51c66c](https://github.com/ooples/AiDotNet/commit/c51c66c91665324d377df8ec71cd7bbca5f32ab1)), closes [#2090](https://github.com/ooples/AiDotNet/issues/2090)
...
* correct the [#2090](https://github.com/ooples/AiDotNet/issues/2090) baseline to the measured 1067 ([a35f430](https://github.com/ooples/AiDotNet/commit/a35f43090292cbb67619c793d05131fe9bbf20ad))
...
* resolve open decisions and widen [#2090](https://github.com/ooples/AiDotNet/issues/2090) to Video and Document ([e02b1e2](https://github.com/ooples/AiDotNet/commit/e02b1e287dee7dd2f7f7bfb08998c32871d312c0))
...
* spec for making model Options the user-facing config surface ([#2090](https://github.com/ooples/AiDotNet/issues/2090)) ([f5d7d8f](https://github.com/ooples/AiDotNet/commit/f5d7d8f43d5360c5492fa3c32ae1d4d80fd8d4f8))
