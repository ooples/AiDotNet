...
namespace AiDotNetTests.UnitTests.Regularization
{
    public class L1RegularizationTests
    {
        ...
        public void Constructor_WithDefaultOptions_UsesDefaultStrength()
        {
            ...
            // Assert
            Assert.Equal(RegularizationType.L1, regularization.Options.Type);
            Assert.Equal(0.1, regularization.Options.Strength);
            Assert.Equal(1.0, regularization.Options.L1Ratio);
        }
