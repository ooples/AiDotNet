...
public class SinOperatorTests
{
    ...
    public void SinOperatorDouble_Invoke_Vector128_RangeReduction()
    {
        ...
        // sin(3Ï€) = sin(Ï€) = 0, sin(5Ï€/2) = sin(Ï€/2) = 1
    ...
    public void SinOperatorDouble_Invoke_Vector128_NegativeValues()
    {
        ...
        // Test negative values: sin(-Ï€/6) = -0.5, sin(-Ï€/2) = -1
    ...
    public void SinOperatorFloat_Invoke_Vector128_KnownValues()
    {
        ...
        // Test [0, Ï€/6, Ï€/4, Ï€/2] â†’ [0, 0.5, 0.707..., 1]
        ...
        Assert.Equal(0.5f, result[1], SimdFloatTolerance);
    ...
    public void SinOperatorFloat_Invoke_Vector128_RangeReduction()
    {
        ...
        // All should be approximately 0 (sin(n*Ï€) = 0)
        Assert.Equal(0.0f, result[0], SimdFloatTolerance);
        Assert.Equal(0.0f, result[1], SimdFloatTolerance);
        Assert.Equal(0.0f, result[2], SimdFloatTolerance);
    ...
    public void SinOperatorDouble_Invoke_Vector256_KnownValues()
    {
        ...
        Assert.Equal(0.0, result[0], SimdDoubleTolerance);
        Assert.Equal(0.5, result[1], SimdDoubleTolerance);
        Assert.Equal(0.7071067811865475, result[2], SimdDoubleTolerance);
    ...
    public void SinOperatorFloat_Invoke_Vector256_KnownValues()
    {
        ...
        Assert.Equal(0.5f, result[1], SimdFloatTolerance);
        Assert.Equal(0.70710678f, result[2], SimdFloatTolerance);
        Assert.Equal(0.86602540f, result[3], SimdFloatTolerance);
        Assert.Equal(1.0f, result[4], SimdFloatTolerance);
        Assert.Equal(0.0f, result[5], SimdFloatTolerance);
        Assert.Equal(-1.0f, result[6], SimdFloatTolerance);
        Assert.Equal(0.0f, result[7], SimdFloatTolerance);
    }
#endif
    ...
    public void SinOperatorDouble_Invoke_Vector512_KnownValues()
    {
        ...
        Assert.Equal(0.5, result[1], SimdDoubleTolerance);
        Assert.Equal(0.7071067811865475, result[2], SimdDoubleTolerance);
        Assert.Equal(0.8660254037844387, result[3], SimdDoubleTolerance);
        Assert.Equal(1.0, result[4], SimdDoubleTolerance);
        Assert.Equal(0.0, result[5], SimdDoubleTolerance);
        Assert.Equal(-1.0, result[6], SimdDoubleTolerance);
        Assert.Equal(0.0, result[7], SimdDoubleTolerance);
    }
#endif
    ...
    public void SinOperatorFloat_Invoke_Vector512_KnownValues()
    {
        ...
        Assert.Equal(-0.86602540f, result[10], SimdFloatTolerance);
        Assert.Equal(-1.0f, result[11], SimdFloatTolerance);
        Assert.Equal(0.0f, result[12], SimdFloatTolerance);
        Assert.Equal(1.0f, result[13], SimdFloatTolerance);
        Assert.Equal(0.0f, result[14], SimdFloatTolerance);
    ...
    public void SinOperatorFloat_Invoke_Vector512_RangeReduction()
    {
        ...
        // All multiples of Ï€ should be ~0
        Assert.Equal(0.0f, result[0], SimdFloatTolerance);
        Assert.Equal(0.0f, result[1], SimdFloatTolerance);
        Assert.Equal(0.0f, result[2], SimdFloatTolerance);
        Assert.Equal(0.0f, result[3], SimdFloatTolerance);

        // n*Ï€ + Ï€/2 should be Â±1
        Assert.Equal(1.0f, result[4], SimdFloatTolerance);
        Assert.Equal(-1.0f, result[5], SimdFloatTolerance);

        // n*Ï€ + Ï€/6 should be Â±0.5
        Assert.Equal(0.5f, result[6], SimdFloatTolerance);
        Assert.Equal(-0.5f, result[7], SimdFloatTolerance);
    }
#endif
