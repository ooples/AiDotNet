...
public class DataVersioningIntegrationTests : IDisposable
{
    ...
    [Fact(Timeout = 120000)]
    public async Task Constructor_WithStorageDirectory_CreatesDirectoryStructure()
    {
        // Act
    ...
    [Fact(Timeout = 120000)]
    public async Task Constructor_WithNullStorageDirectory_UsesDefaultDirectory()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Constructor_LoadsExistingData()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CreateDataset_WithValidName_CreatesDataset()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task CreateDataset_WithMetadata_StoresMetadata()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task CreateDataset_WithDuplicateName_ReturnsExistingId()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task CreateDataset_WithEmptyName_ThrowsArgumentException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task CreateDataset_WithWhitespaceName_ThrowsArgumentException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_WithSingleFile_CreatesVersion()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_WithDirectory_CreatesVersionWithAllFiles()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_WithUnchangedContent_ReturnsExistingVersion()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_WithModifiedContent_CreatesNewVersion()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_WithMetadata_StoresMetadata()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_WithNonexistentPath_ThrowsFileNotFoundException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_WithNonexistentDataset_ThrowsArgumentException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        CreateTestFile("data.csv", "content");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_WithEmptyDatasetId_ThrowsArgumentException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        CreateTestFile("data.csv", "content");
    ...
    [Fact(Timeout = 120000)]
    public async Task GetVersion_ByVersionId_ReturnsCorrectVersion()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task GetVersion_Latest_ReturnsLatestVersion()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task GetVersion_ByVersionNumber_ReturnsCorrectVersion()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task GetVersion_WithNoVersions_ThrowsInvalidOperationException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task GetVersion_NonexistentVersion_ThrowsArgumentException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task ListVersions_ReturnsVersionsInDescendingOrder()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task ListVersions_EmptyDataset_ReturnsEmptyList()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task ListDatasets_ReturnsAllDatasets()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task ListDatasets_OrderedByLastUpdated()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task GetDataPath_ReturnsValidPath()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task GetDataPath_Latest_ReturnsLatestVersionPath()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task GetDataPath_PreservesDirectoryStructure()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task CompareVersions_IdenticalVersions_NoChanges()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task CompareVersions_AddedFiles_DetectsAdditions()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task CompareVersions_RemovedFiles_DetectsRemovals()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task CompareVersions_ModifiedFiles_DetectsModifications()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task CompareVersions_Summary_ReturnsCorrectFormat()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task DeleteVersion_UpdatesDatasetMetadata()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task DeleteVersion_RemovesFilesFromDisk()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task DeleteVersion_NonexistentVersion_ThrowsArgumentException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task DeleteDataset_RemovesDatasetAndAllVersions()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task DeleteDataset_RemovesFilesFromDisk()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task DeleteDataset_AlsoDeletesLineageRecords()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task DeleteDataset_NonexistentDataset_ThrowsArgumentException()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task RecordLineage_StoresLineageInfo()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task RecordLineage_WithInputDatasets_StoresInputs()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task GetLineage_WithRecursiveUpstream_ResolvesFullLineage()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task GetLineage_NoLineageRecorded_ReturnsEmptyLineage()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task GetLineage_HandlesCircularReferences()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Persistence_DatasetsSurviveRestart()
    {
        // Arrange
        string datasetId;
        using (var dvc1 = new DVC(_storageDir))
    ...
    [Fact(Timeout = 120000)]
    public async Task Persistence_VersionsSurviveRestart()
    {
        // Arrange
        string datasetId;
        string versionId;
    ...
    [Fact(Timeout = 120000)]
    public async Task Persistence_LineageSurvivesRestart()
    {
        // Arrange
        string datasetId;
        string versionId;
    ...
    [Fact(Timeout = 120000)]
    public async Task DatasetInfo_DefaultValues()
    {
        // Arrange & Act
    ...
    [Fact(Timeout = 120000)]
    public async Task DataVersion_SizeFormatted_Bytes()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task DataVersion_SizeFormatted_Kilobytes()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task DataVersion_SizeFormatted_Megabytes()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task DataVersion_SizeFormatted_Gigabytes()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task DataFileInfo_DefaultValues()
    {
        // Arrange & Act
    ...
    [Fact(Timeout = 120000)]
    public async Task DataVersionDiff_SizeDelta_Calculation()
    {
        // Arrange
    ...
    [Fact(Timeout = 120000)]
    public async Task DataLineage_DefaultValues()
    {
        // Arrange & Act
    ...
    [Fact(Timeout = 120000)]
    public async Task ConcurrentCreateDatasets_ThreadSafe()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
    ...
    [Fact(Timeout = 120000)]
    public async Task ConcurrentAddVersions_ThreadSafe()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task ConcurrentReadAndWrite_ThreadSafe()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_LargeNumberOfFiles_HandledCorrectly()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_EmptyDirectory_CreatesVersionWithNoFiles()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task AddVersion_SpecialCharactersInFilename_HandledCorrectly()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
    ...
    [Fact(Timeout = 120000)]
    public async Task ContentHash_Deterministic_SameContentSameHash()
    {
        // Arrange
        using var dvc = new DVC(_storageDir);
        var datasetId = dvc.CreateDataset("test-dataset");
