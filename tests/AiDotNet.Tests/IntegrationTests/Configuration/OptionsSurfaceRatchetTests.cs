...
public class OptionsSurfaceRatchetTests
{
    ...
    /// (11 embedding and retrieval models, 77 params); phase 4b to 741 (10 GANs, 41 params); phase 5 to 697 (19 Document models, 148 params).
    ...
    /// </para>
    /// </remarks>
    private const int Baseline = 697;
    ...
    /// </para>
    /// </remarks>
    private const int ConstructorBaseline = 815;
