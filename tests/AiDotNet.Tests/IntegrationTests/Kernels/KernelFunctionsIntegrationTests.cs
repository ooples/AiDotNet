...
public class KernelFunctionsIntegrationTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task GaussianKernel_DifferentVectors_ReturnsLessThanOne()
    {
        var kernel = new GaussianKernel<double>(1.0);
        var x = V(1.0, 2.0, 3.0);
        var y = V(4.0, 5.0, 6.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task GaussianKernel_IsSymmetric()
    {
        var kernel = new GaussianKernel<double>(1.0);
        var x = V(1.0, 2.0);
        var y = V(3.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task GaussianKernel_LargerSigma_HigherSimilarityForDistantPoints()
    {
        var x = V(1.0, 2.0);
        var y = V(5.0, 6.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task GaussianKernel_DifferentLengthVectors_ThrowsArgumentException()
    {
        var kernel = new GaussianKernel<double>(1.0);
        var x = V(1.0, 2.0);
        var y = V(1.0, 2.0, 3.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task LinearKernel_Calculate_ReturnsDotProduct()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LinearKernel_IsSymmetric()
    {
        var kernel = new LinearKernel<double>();
        var x = V(1.0, 3.0);
        var y = V(2.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task PolynomialKernel_Degree2_ComputesCorrectly()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task PolynomialKernel_Degree1_ReducesToLinear()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task PolynomialKernel_IsSymmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SigmoidKernel_Calculate_ReturnsBounded()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LaplacianKernel_IdenticalVectors_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LaplacianKernel_DifferentVectors_ReturnsLessThanOne()
    {
        var kernel = new LaplacianKernel<double>(1.0);
        var x = V(1.0, 2.0);
        var y = V(3.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task LaplacianKernel_IsSymmetric()
    {
        var kernel = new LaplacianKernel<double>(1.0);
        var x = V(1.0, 2.0);
        var y = V(3.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task ExponentialKernel_IdenticalVectors_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ExponentialKernel_IsSymmetric()
    {
        var kernel = new ExponentialKernel<double>(1.0);
        var x = V(1.0, 2.0);
        var y = V(3.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task MaternKernel_IdenticalVectors_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MaternKernel_IsSymmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CauchyKernel_IdenticalVectors_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CauchyKernel_AlwaysPositive()
    {
        var kernel = new CauchyKernel<double>(1.0);
        var x = V(1.0, 2.0);
        var y = V(10.0, 20.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task RationalQuadraticKernel_IdenticalVectors_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task RationalQuadraticKernel_IsSymmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CosineKernel_IdenticalVectors_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WhiteNoiseKernel_IdenticalVectors_ReturnsVariance()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WhiteNoiseKernel_DifferentVectors_ReturnsZero()
    {
        var kernel = new WhiteNoiseKernel<double>(2.0);
        var x = V(1.0, 2.0);
        var y = V(1.0, 2.001);
    ...
    [Fact(Timeout = 120000)]
    public async Task ConstantKernel_AlwaysReturnsConstant()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task DotProductKernel_Calculate_ReturnsDotProduct()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MultiquadricKernel_IdenticalVectors_ReturnsConstant()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MultiquadricKernel_IsSymmetric()
    {
        var kernel = new MultiquadricKernel<double>(1.0);
        var x = V(1.0, 2.0);
        var y = V(3.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseMultiquadricKernel_IdenticalVectors_ReturnsMax()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task HellingerKernel_IdenticalVectors_ReturnsMax()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task HellingerKernel_IsSymmetric()
    {
        var kernel = new HellingerKernel<double>();
        var x = V(0.1, 0.4, 0.5);
        var y = V(0.3, 0.3, 0.4);
    ...
    [Fact(Timeout = 120000)]
    public async Task TanimotoKernel_IdenticalVectors_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TanimotoKernel_IsSymmetric()
    {
        var kernel = new TanimotoKernel<double>();
        var x = V(1.0, 2.0);
        var y = V(3.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task AllKernels_Symmetry_KxyEqualsKyx()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AllKernels_SelfSimilarity_NoNaN()
    {
        var kernels = new IKernelFunction<double>[]
        {
            new GaussianKernel<double>(1.0),
