...
public class DistributionFunctionsIntegrationTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalCDF_StandardNormal_AtZero_Returns0_5()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalCDF_StandardNormal_AtOne_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalCDF_StandardNormal_AtNegativeOne_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalCDF_StandardNormal_AtTwo_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalCDF_NonStandard_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalCDF_AtMean_Returns0_5()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalCDF_SymmetryAroundMean()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalPDF_StandardNormal_AtZero_ReturnsMaximum()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalPDF_StandardNormal_AtOne_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalPDF_StandardNormal_SymmetricAroundMean()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalPDF_NonStandard_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalPDF_LargerStdDev_SmallerPeakValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseNormalCDF_Standard_At0_5_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseNormalCDF_Standard_At0_975_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseNormalCDF_Standard_At0_025_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseNormalCDF_NonStandard_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseNormalCDF_InverseOfCDF_ReturnsOriginalValue()
    {
        double x = 1.5;
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquareCDF_DF1_AtOne_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquareCDF_DF5_AtFive_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquareCDF_DF10_AtTen_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquareCDF_AtZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquareCDF_IsMonotonicallyIncreasing()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquarePDF_DF1_AtOne_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquarePDF_DF5_AtThree_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquarePDF_AtZero_DF1_ReturnsInfinity()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquarePDF_IsNonNegative()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseChiSquareCDF_DF1_At0_95_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseChiSquareCDF_DF5_At0_5_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseChiSquareCDF_InverseOfCDF_ReturnsOriginalValue()
    {
        double x = 7.5;
        int df = 5;
    ...
    [Fact(Timeout = 120000)]
    public async Task StudentPDF_AtZero_MaximumValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task StudentPDF_SymmetricAroundMean()
    {
        double mean = 5.0;
        double stdDev = 2.0;
        int df = 10;
    ...
    [Fact(Timeout = 120000)]
    public async Task StudentPDF_HighDF_ApproachesNormal()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task StudentPDF_LowDF_HeavierTails()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseStudentTCDF_At0_5_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseStudentTCDF_DF10_At0_975_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseStudentTCDF_HighDF_ApproachesNormal()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BetaCDF_UniformBeta_Linear()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BetaCDF_StandardExample_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BetaCDF_AtZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BetaCDF_AtOne_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BetaCDF_SymmetricBeta_SymmetricCDF()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseBetaCDF_At0_5_Uniform_Returns0_5()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseBetaCDF_StandardExample_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseBetaCDF_InverseOfCDF_ReturnsOriginalValue()
    {
        double x = 0.3;
    ...
    [Fact(Timeout = 120000)]
    public async Task ExponentialPDF_AtZero_ReturnsLambda()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ExponentialPDF_StandardExample_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ExponentialPDF_DecaysExponentially()
    {
        double lambda = 1.0;
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseExponentialCDF_StandardExample_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WeibullPDF_K1_IsExponential()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WeibullPDF_K2_IsRayleigh()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WeibullPDF_IsNonNegative()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogNormalPDF_StandardExample_ReturnsExactValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogNormalPDF_AtZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogNormalPDF_IsNonNegative()
    {
        for (double x = 0.1; x <= 5; x += 0.5)
        {
    ...
    [Fact(Timeout = 120000)]
    public async Task LaplacePDF_AtMedian_ReturnsMaximum()
    {
        double median = 0.0;
        double mad = 1.0;
    ...
    [Fact(Timeout = 120000)]
    public async Task LaplacePDF_SymmetricAroundMedian()
    {
        double median = 5.0;
        double mad = 2.0;
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseLaplaceCDF_At0_5_ReturnsMedian()
    {
        double median = 10.0;
        double mad = 2.0;
    ...
    [Fact(Timeout = 120000)]
    public async Task InverseLaplaceCDF_SymmetricAroundMedian()
    {
        double median = 5.0;
        double mad = 2.0;
    ...
    [Fact(Timeout = 120000)]
    public async Task NormalCDF_FloatType_ReturnsCorrectValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ChiSquareCDF_FloatType_ReturnsCorrectValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BetaCDF_FloatType_ReturnsCorrectValue()
    {
