...
public class AdvancedActivationFunctionsTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task SwishActivation_ActivateZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SwishActivation_LargePositive_ApproachesInput()
    {
        var swish = new SwishActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SwishActivation_NegativeInput_AllowsSomeNegative()
    {
        var swish = new SwishActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SwishActivation_Derivative_AtZero_IsHalf()
    {
        var swish = new SwishActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SiLUActivation_MatchesSwish()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MishActivation_ActivateZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MishActivation_LargePositive_ApproachesInput()
    {
        var mish = new MishActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task MishActivation_NegativeInput_AllowsSomeNegative()
    {
        var mish = new MishActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task MishActivation_Derivative_NotNaN()
    {
        var mish = new MishActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SELUActivation_ActivatePositive_ReturnsScaledInput()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SELUActivation_ActivateZero_ReturnsZero()
    {
        var selu = new SELUActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SELUActivation_ActivateNegative_ReturnsBoundedNegative()
    {
        var selu = new SELUActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SELUActivation_DerivativePositive_IsLambda()
    {
        var selu = new SELUActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task CELUActivation_ActivatePositive_ReturnsInput()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CELUActivation_ActivateNegative_ReturnsBoundedNegative()
    {
        var celu = new CELUActivation<double>(1.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task CELUActivation_ActivateZero_ReturnsZero()
    {
        var celu = new CELUActivation<double>(1.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task CELUActivation_DifferentAlpha_AffectsNegativeRange()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftPlusActivation_AlwaysPositive()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftPlusActivation_ActivateZero_ReturnsLn2()
    {
        var sp = new SoftPlusActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftPlusActivation_LargePositive_ApproachesInput()
    {
        var sp = new SoftPlusActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftPlusActivation_DerivativeIsSigmoid()
    {
        var sp = new SoftPlusActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftSignActivation_ActivateZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftSignActivation_OutputBoundedNegOneToOne()
    {
        var ss = new SoftSignActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftSignActivation_KnownValue()
    {
        var ss = new SoftSignActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftSignActivation_IsOddFunction()
    {
        var ss = new SoftSignActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task HardSwishActivation_ActivateZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task HardSwishActivation_LargePositive_ReturnsInput()
    {
        var hs = new HardSwishActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task HardSwishActivation_LargeNegative_ReturnsZero()
    {
        var hs = new HardSwishActivation<double>();
        var result = hs.Activate(-5.0);
        Assert.Equal(0.0, result, Tolerance);
    ...
    [Fact(Timeout = 120000)]
    public async Task ReLU6Activation_PositiveBelow6_ReturnsInput()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ReLU6Activation_Above6_Returns6()
    {
        var relu6 = new ReLU6Activation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task ReLU6Activation_Negative_ReturnsZero()
    {
        var relu6 = new ReLU6Activation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task ReLU6Activation_DerivativeInRange_ReturnsOne()
    {
        var relu6 = new ReLU6Activation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task ReLU6Activation_DerivativeAbove6_ReturnsZero()
    {
        var relu6 = new ReLU6Activation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task PReLUActivation_PositiveInput_ReturnsInput()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task PReLUActivation_NegativeInput_ReturnsScaled()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ThresholdedReLUActivation_AboveThreshold_ReturnsInput()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ThresholdedReLUActivation_BelowThreshold_ReturnsZero()
    {
        var trelu = new ThresholdedReLUActivation<double>(1.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task ThresholdedReLUActivation_Negative_ReturnsZero()
    {
        var trelu = new ThresholdedReLUActivation<double>(1.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task RReLUActivation_PositiveInput_ReturnsInput()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task RReLUActivation_NegativeInput_ReturnsScaledBetweenBounds()
    {
        var rrelu = new RReLUActivation<double>(0.125, 0.333);
    ...
    [Fact(Timeout = 120000)]
    public async Task ISRUActivation_ActivateZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ISRUActivation_OutputBounded()
    {
        var isru = new ISRUActivation<double>(1.0);
        var inputs = new[] { -10.0, -1.0, 0.0, 1.0, 10.0 };
        foreach (var x in inputs)
    ...
    [Fact(Timeout = 120000)]
    public async Task LiSHTActivation_ActivateZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LiSHTActivation_PositiveInput_ReturnsPositive()
    {
        var lisht = new LiSHTActivation<double>();
        // LiSHT(x) = x * tanh(x)
    ...
    [Fact(Timeout = 120000)]
    public async Task LiSHTActivation_NegativeInput_ReturnsPositive()
    {
        var lisht = new LiSHTActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task LiSHTActivation_IsEvenFunction()
    {
        var lisht = new LiSHTActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task BentIdentityActivation_ActivateZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BentIdentityActivation_LargePositive_ApproachesInput()
    {
        var bi = new BentIdentityActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task BentIdentityActivation_Derivative_NotNaN()
    {
        var bi = new BentIdentityActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SignActivation_PositiveInput_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SignActivation_NegativeInput_ReturnsMinusOne()
    {
        var sign = new SignActivation<double>();
        var result = sign.Activate(-5.0);
        Assert.Equal(-1.0, result, Tolerance);
    ...
    [Fact(Timeout = 120000)]
    public async Task SignActivation_Zero_ReturnsZero()
    {
        var sign = new SignActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SquashActivation_OutputBounded()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ScaledTanhActivation_ActivateZero_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ScaledTanhActivation_DifferentBeta_AffectsScale()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SQRBFActivation_ActivateZero_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SQRBFActivation_LargeInput_ApproachesZero()
    {
        var sqrbf = new SQRBFActivation<double>(1.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task LogSoftmaxActivation_VectorOutput_LogProbabilities()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftminActivation_VectorOutput_SumsToOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SoftminActivation_SmallestInputGetsLargestProbability()
    {
        var sm = new SoftminActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SparsemaxActivation_VectorOutput_SumsToOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SparsemaxActivation_ProducesSparseOutput()
    {
        var sm = new SparsemaxActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task TaylorSoftmaxActivation_VectorOutput_AllPositive()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogSoftminActivation_VectorOutput_AllNonPositive()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SphericalSoftmaxActivation_VectorOutput_AllPositive()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BinarySpikingActivation_AboveThreshold_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BinarySpikingActivation_BelowThreshold_ReturnsZero()
    {
        var bs = new BinarySpikingActivation<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task MaxoutActivation_ReturnsMaxOfPieces()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task HierarchicalSoftmaxActivation_VectorOutput_AllPositive()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AllScalarActivations_VectorActivate_PreservesLength()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AllScalarActivations_Derivative_NoNaN()
    {
        var activations = new IActivationFunction<double>[]
        {
            new SwishActivation<double>(),
    ...
    [Fact(Timeout = 120000)]
    public async Task AllScalarActivations_TensorActivate_PreservesShape()
    {
        var activations = new IActivationFunction<double>[]
        {
            new SwishActivation<double>(),
