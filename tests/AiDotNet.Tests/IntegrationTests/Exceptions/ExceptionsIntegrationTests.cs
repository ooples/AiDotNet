...
public class ExceptionsIntegrationTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task AiDotNetException_DefaultConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AiDotNetException_MessageConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AiDotNetException_MessageAndInnerException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorShapeMismatch_DefaultConstructor_SetsDefaults()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorShapeMismatch_MessageConstructor_SetsDefaults()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorShapeMismatch_WithInnerException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorShapeMismatch_FullConstructor_StoresProperties()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorShapeMismatch_FullConstructor_FormatsMessage()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorShapeMismatch_ThreeArgConstructor_SetsOperationToUnknown()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorShapeMismatch_WithInnerAndShapes()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorShapeMismatch_InheritsFromAiDotNetException()
    {
        var ex = new TensorShapeMismatchException();
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorRankException_StoresProperties()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorRankException_FormatsMessage()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorRankException_InheritsFromAiDotNetException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorDimensionException_StoresProperties()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorDimensionException_FormatsMessage()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task TensorDimensionException_InheritsFromAiDotNetException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task VectorLengthMismatch_StoresProperties()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task VectorLengthMismatch_FormatsMessage()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task VectorLengthMismatch_InheritsFromAiDotNetException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ForwardPassRequired_TwoArgConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ForwardPassRequired_ThreeArgConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ForwardPassRequired_InheritsFromAiDotNetException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidDataValue_DefaultConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidDataValue_MessageConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidDataValue_WithInnerException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidDataValue_WithContext()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidDataValue_WithContextAndInner()
    {
        var inner = new Exception("root");
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidDataValue_InheritsFromAiDotNetException()
    {
        var ex = new InvalidDataValueException();
        Assert.IsAssignableFrom<AiDotNetException>(ex);
    }
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputDimension_DefaultConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputDimension_MessageConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputDimension_WithInnerException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputDimension_WithContext()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputDimension_WithContextAndInner()
    {
        var inner = new Exception("root");
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputDimension_InheritsFromAiDotNetException()
    {
        var ex = new InvalidInputDimensionException();
        Assert.IsAssignableFrom<AiDotNetException>(ex);
    }
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputType_StoresProperties()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputType_FormatsMessage()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task InvalidInputType_InheritsFromAiDotNetException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModelTrainingException_DefaultConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModelTrainingException_MessageConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModelTrainingException_WithInnerException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModelTrainingException_InheritsFromAiDotNetException()
    {
        var ex = new ModelTrainingException();
        Assert.IsAssignableFrom<AiDotNetException>(ex);
    }
    ...
    [Fact(Timeout = 120000)]
    public async Task SerializationException_DefaultConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SerializationException_MessageConstructor()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SerializationException_WithInnerException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SerializationException_WithContext()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SerializationException_WithContextAndInner()
    {
        var inner = new Exception("root");
    ...
    [Fact(Timeout = 120000)]
    public async Task SerializationException_InheritsFromAiDotNetException()
    {
        var ex = new AiDotNet.Exceptions.SerializationException();
        Assert.IsAssignableFrom<AiDotNetException>(ex);
    }
    ...
    [Fact(Timeout = 120000)]
    public async Task AllExceptions_DeriveFromAiDotNetException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AllExceptions_DeriveFromSystemException()
    {
