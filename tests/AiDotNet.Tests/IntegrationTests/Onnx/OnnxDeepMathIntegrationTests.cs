...
public class OnnxDeepMathIntegrationTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_ModelNameEmpty()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_DescriptionNull()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_ProducerNameNull()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_ProducerVersionNull()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_OpsetVersionZero()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_InputsEmpty()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_OutputsEmpty()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_DomainNull()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_GraphNameNull()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_Defaults_CustomMetadataEmpty()
    {
        var metadata = new OnnxModelMetadata();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelMetadata_SetProperties()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_Defaults_NameEmpty()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_Defaults_ShapeEmpty()
    {
        var info = new OnnxTensorInfo();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_Defaults_ElementTypeFloat()
    {
        var info = new OnnxTensorInfo();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_StaticShape_NotDynamic()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_DynamicBatchDim_IsDynamic()
    {
        var info = new OnnxTensorInfo { Shape = new[] { -1, 3, 224, 224 } };
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_MultipleDynamic_IsDynamic()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_EmptyShape_NotDynamic()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_TotalElements_StaticShape()
    {
        var info = new OnnxTensorInfo { Shape = new[] { 1, 3, 224, 224 } };
        // 1 * 3 * 224 * 224 = 150528
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_TotalElements_DynamicShape_ReturnsNegativeOne()
    {
        var info = new OnnxTensorInfo { Shape = new[] { -1, 3, 224, 224 } };
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_TotalElements_SingleDim()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_TotalElements_ScalarShape()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_TotalElements_LargeShape()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_ToString_StaticShape()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_ToString_DynamicShape()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxTensorInfo_ToString_DoublePrecision()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_ExecutionProviderAuto()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_FallbackProviders()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_GpuDeviceIdZero()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_MemoryPatternEnabled()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_MemoryArenaEnabled()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_ThreadsZero()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_OptimizationLevelAll()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_ProfilingDisabled()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_CustomOptionsEmpty()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_LogLevelWarning()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_AutoWarmUpDisabled()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_CudaMemoryLimitZero()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_Defaults_CudaArenaEnabled()
    {
        var options = new OnnxModelOptions();
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_ForCpu_SetsProviderAndEmptyFallbacks()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_ForCpu_CustomThreads()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_ForCuda_SetsProviderAndFallback()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_ForCuda_CustomDevice()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_ForDirectML_SetsProviderAndFallback()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_ForTensorRT_SetsProviderAndFallbacks()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_ForTensorRT_CustomDevice()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxModelOptions_CustomValues_AllSet()
    {
        var options = new OnnxModelOptions
        {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxExecutionProvider_HasNineValues()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task GraphOptimizationLevel_HasFourValues()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OnnxLogLevel_HasFiveValues()
    {
