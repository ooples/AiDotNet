...
public class VectorExtensionsIntegrationTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task Slice_MiddleElements_ReturnsCorrectSlice()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Slice_FromStart_ReturnsCorrectSlice()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Slice_ToEnd_ReturnsCorrectSlice()
    {
        var vector = new Vector<double>([1, 2, 3, 4, 5]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Norm_SimpleVector_ReturnsCorrectNorm()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Norm_ZeroVector_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Norm_UnitVector_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ToVectorList_Indices_CreatesVectorsFromInts()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ToIntList_Vectors_ConvertsBackToInts()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CreateDiagonal_SimpleVector_CreatesDiagonalMatrix()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Argsort_UnsortedVector_ReturnsSortedIndices()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Argsort_SortedVector_ReturnsSequentialIndices()
    {
        var vector = new Vector<double>([1, 2, 3, 4, 5]);
        var indices = vector.Argsort();
    ...
    [Fact(Timeout = 120000)]
    public async Task Repeat_Vector_RepeatsCorrectly()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Repeat_Once_ReturnsCopy()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Add_TwoVectors_ReturnsSum()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Add_DifferentLengths_ThrowsException()
    {
        var a = new Vector<double>([1, 2, 3]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Add_Scalar_AddsToEachElement()
    {
        var vector = new Vector<double>([1, 2, 3]);
    ...
    [Fact(Timeout = 120000)]
    public async Task PointwiseExp_SimpleVector_ReturnsExponential()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task PointwiseLog_SimpleVector_ReturnsLogarithm()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Subtract_TwoVectors_ReturnsDifference()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Subtract_Scalar_SubtractsFromEach()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task DotProduct_TwoVectors_ReturnsCorrectResult()
    {
        var a = new Vector<double>([1, 2, 3]);
        var b = new Vector<double>([4, 5, 6]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Divide_ByScalar_DividesEachElement()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Multiply_ByScalar_MultipliesEachElement()
    {
        var vector = new Vector<double>([1, 2, 3]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Multiply_VectorByMatrix_ReturnsCorrectResult()
    {
        var vector = new Vector<double>([1, 2, 3]);
    ...
    [Fact(Timeout = 120000)]
    public async Task PointwiseMultiply_TwoVectors_ReturnsHadamardProduct()
    {
        var a = new Vector<double>([1, 2, 3]);
        var b = new Vector<double>([4, 5, 6]);
    ...
    [Fact(Timeout = 120000)]
    public async Task PointwiseMultiplyInPlace_ModifiesLeftVector()
    {
        var a = new Vector<double>([1, 2, 3]);
        var b = new Vector<double>([4, 5, 6]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Magnitude_SimpleVector_ReturnsCorrectMagnitude()
    {
        var vector = new Vector<double>([3, 4]);
    ...
    [Fact(Timeout = 120000)]
    public async Task PointwiseDivide_TwoVectors_DividesElementwise()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Max_Vector_ReturnsMaximumValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Max_EmptyVector_ThrowsException()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Min_Vector_ReturnsMinimumValue()
    {
        var vector = new Vector<double>([3, 7, 2, 5]);
        var min = vector.Min();
    ...
    [Fact(Timeout = 120000)]
    public async Task Average_Vector_ReturnsArithmeticMean()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Sum_Vector_ReturnsTotalSum()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task PointwiseSign_MixedVector_ReturnsCorrectSigns()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AbsoluteMaximum_MixedVector_ReturnsLargestAbsoluteValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task PointwiseAbs_MixedVector_ReturnsAbsoluteValues()
    {
        var vector = new Vector<double>([-5, 0, 3]);
    ...
    [Fact(Timeout = 120000)]
    public async Task PointwiseSqrt_PerfectSquares_ReturnsCorrectRoots()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Maximum_WithScalar_ReturnsElementwiseMaximum()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Transform_AppliesFunction()
    {
        var vector = new Vector<double>([1, 2, 3]);
    ...
    [Fact(Timeout = 120000)]
    public async Task MaxIndex_Vector_ReturnsIndexOfMaximum()
    {
        var vector = new Vector<double>([3, 7, 2, 5]);
    ...
    [Fact(Timeout = 120000)]
    public async Task MinIndex_Vector_ReturnsIndexOfMinimum()
    {
        var vector = new Vector<double>([3, 7, 2, 5]);
    ...
    [Fact(Timeout = 120000)]
    public async Task SubVector_ByRange_ExtractsCorrectElements()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SubVector_ByIndices_ExtractsCorrectElements()
    {
        var vector = new Vector<double>([5, 10, 15, 20, 25]);
    ...
    [Fact(Timeout = 120000)]
    public async Task ToDiagonalMatrix_CreatesCorrectMatrix()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ToRowMatrix_CreatesCorrectMatrix()
    {
        var vector = new Vector<double>([3, 5, 7]);
    ...
    [Fact(Timeout = 120000)]
    public async Task ToColumnMatrix_CreatesCorrectMatrix()
    {
        var vector = new Vector<double>([3, 5, 7]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Extract_FirstNElements_ReturnsCorrectSubset()
    {
        var vector = new Vector<double>([5, 10, 15, 20, 25]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Reshape_VectorToMatrix_CorrectDimensions()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Reshape_IncompatibleSize_ThrowsException()
    {
        var vector = new Vector<double>([1, 2, 3, 4, 5]);
    ...
    [Fact(Timeout = 120000)]
    public async Task StandardDeviation_KnownData_ReturnsCorrectValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task StandardDeviation_SingleElement_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Median_OddLength_ReturnsMiddleValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Median_EvenLength_ReturnsAverageOfMiddle()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Median_UnsortedVector_ReturnsCorrectMedian()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task EuclideanDistance_TwoVectors_ReturnsCorrectDistance()
    {
        var a = new Vector<double>([1, 2]);
    ...
    [Fact(Timeout = 120000)]
    public async Task EuclideanDistance_SameVectors_ReturnsZero()
    {
        var a = new Vector<double>([1, 2, 3]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Minimum_Vector_ReturnsSmallestValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Transform_ToDoubleFromInt_TransformsCorrectly()
    {
        var vector = new Vector<double>([1, 2, 3, 4, 5]);
    ...
    [Fact(Timeout = 120000)]
    public async Task Transform_WithTypeChange_PreservesLength()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ToRealVector_ExtractsRealPartFromComplex()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ToRealVector_PureImaginary_ReturnsZeros()
    {
