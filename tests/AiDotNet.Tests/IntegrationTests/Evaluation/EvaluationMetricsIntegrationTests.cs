...
public class EvaluationMetricsIntegrationTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task R2Score_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MaxError_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MedianAbsoluteError_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ExplainedVariance_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_KnownValues_ReturnsCorrectResult()
    {
        var metric = new MAEMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_KnownValues_ReturnsCorrectResult()
    {
        var metric = new MSEMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_KnownValues_IsSqrtOfMSE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MaxError_KnownValues_ReturnsMaxAbsError()
    {
        var metric = new MaxErrorMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task R2Score_MeanPredictions_ReturnsZero()
    {
        var metric = new R2ScoreMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task R2Score_BadPredictions_IsNegative()
    {
        var metric = new R2ScoreMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task MeanBiasError_OverPredictions_IsPositive()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MeanBiasError_UnderPredictions_IsNegative()
    {
        var metric = new MeanBiasErrorMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task PearsonCorrelation_PerfectPositive_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task PearsonCorrelation_PerfectNegative_ReturnsMinusOne()
    {
        var metric = new PearsonCorrelationMetric<double>();
        var result = metric.Compute(BadPredictions, Actuals);
        Assert.Equal(-1.0, result, Tolerance);
    ...
    [Fact(Timeout = 120000)]
    public async Task SpearmanCorrelation_PerfectPositive_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SpearmanCorrelation_PerfectNegative_ReturnsMinusOne()
    {
        var metric = new SpearmanCorrelationMetric<double>();
        var result = metric.Compute(BadPredictions, Actuals);
        Assert.Equal(-1.0, result, Tolerance);
    ...
    [Fact(Timeout = 120000)]
    public async Task HuberLoss_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogCoshLoss_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AllNonNegativeRegressionMetrics_AlwaysNonNegative()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_AlwaysGreaterThanOrEqualTo_MAESquared()
    {
        var mse = new MSEMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task Accuracy_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Accuracy_WorstPredictions_ReturnsZero()
    {
        var metric = new AccuracyMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task ErrorRate_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Recall_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task F1Score_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Specificity_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MatthewsCorrelation_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CohensKappa_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task HammingLoss_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ZeroOneLoss_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Accuracy_KnownValues_ReturnsCorrectResult()
    {
        var metric = new AccuracyMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task AccuracyPlusErrorRate_SumsToOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BalancedAccuracy_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task JaccardScore_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ThreatScore_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NPV_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task FalsePositiveRate_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task FalseNegativeRate_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task FalseDiscoveryRate_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task FalseOmissionRate_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AllBoundedClassificationMetrics_InRange()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Sensitivity_EqualTo_Recall()
    {
        var recall = new RecallMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task SpecificityPlusFPR_SumsToOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task PrecisionPlusFDR_SumsToOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task NPVPlusFOR_SumsToOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AllRegressionMetrics_HaveValidMetadata()
    {
        var metrics = new IRegressionMetric<double>[]
        {
    ...
    [Fact(Timeout = 120000)]
    public async Task AllClassificationMetrics_HaveValidMetadata()
    {
        var metrics = new IClassificationMetric<double>[]
        {
            new AccuracyMetric<double>(),
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_MismatchedLengths_Throws()
    {
        var metric = new MAEMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_EmptyInput_ReturnsZero()
    {
        var metric = new MAEMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_EmptyInput_ReturnsZero()
    {
        var metric = new MSEMetric<double>();
        var result = metric.Compute(ReadOnlySpan<double>.Empty, ReadOnlySpan<double>.Empty);
        Assert.Equal(0.0, result, Tolerance);
    ...
    [Fact(Timeout = 120000)]
    public async Task MAPE_PerfectPredictions_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SMAPE_IsSymmetric()
    {
        var metric = new SymmetricMAPEMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task MAPE_NonNegative()
    {
        var metric = new MAPEMetric<double>();
        var result = metric.Compute(BadPredictions, Actuals);
        Assert.True(result >= 0);
    ...
    [Fact(Timeout = 120000)]
    public async Task SMAPE_TimeSeries_NonNegative()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task R2Score_ComputeWithCI_ReturnsValidInterval()
    {
        var metric = new R2ScoreMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task Accuracy_ComputeWithCI_ReturnsValidInterval()
    {
        var metric = new AccuracyMetric<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task AllRegressionMetrics_ValidInput_NoNaN()
    {
        var metrics = new IRegressionMetric<double>[]
        {
            new R2ScoreMetric<double>(),
    ...
    [Fact(Timeout = 120000)]
    public async Task AllClassificationMetrics_ValidInput_NoNaN()
    {
        var metrics = new IClassificationMetric<double>[]
        {
            new AccuracyMetric<double>(),
    ...
    [Fact(Timeout = 120000)]
    public async Task MeanDirectionalAccuracy_PerfectDirection_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AdjustedR2_PerfectPredictions_ReturnsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AdjustedR2_LessThanOrEqualToR2()
    {
