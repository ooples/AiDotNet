...
public class NumericalStabilityHelperIntegrationTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task DefaultEpsilon_IsSmallPositive()
    {
        Assert.Equal(1e-7, NumericalStabilityHelper.DefaultEpsilon);
    }

    [Fact(Timeout = 120000)]
    public async Task SmallEpsilon_IsSmaller()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LargeEpsilon_IsLarger()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task GetEpsilon_Default_ReturnsDefaultEpsilon()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task GetEpsilon_Custom_ReturnsCustomValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeLog_PositiveValue_ReturnsCorrectLog()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeLog_Zero_ReturnsFiniteValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeLog_NegativeValue_ReturnsFiniteValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeDiv_NormalDivision_ReturnsCorrectResult()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeDiv_VerySmallDenominator_ReturnsFiniteValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeDiv_ZeroNumerator_ReturnsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeSqrt_PositiveValue_ReturnsCorrectResult()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeSqrt_Zero_ReturnsFiniteValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeSqrt_NegativeValue_ReturnsFiniteValue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ClampProbability_ValidProbability_Unchanged()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ClampProbability_One_ClampsToLessThanOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ClampProbability_GreaterThanOne_ClampsToLessThanOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeLogProbability_ValidProbability_ReturnsNegative()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SafeLogProbability_Zero_ReturnsFinite()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ContainsNaN_Vector_CleanVector_ReturnsFalse()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ContainsNaN_Vector_WithNaN_ReturnsTrue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ContainsInfinity_Vector_WithInfinity_ReturnsTrue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ContainsNonFinite_Vector_WithBoth_ReturnsTrue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ContainsNonFinite_Vector_Clean_ReturnsFalse()
    {
        var v = new Vector<double>(new double[] { 1.0, 2.0, 3.0 });
    ...
    [Fact(Timeout = 120000)]
    public async Task ContainsNaN_Tensor_CleanTensor_ReturnsFalse()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ContainsNaN_Tensor_WithNaN_ReturnsTrue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ContainsInfinity_Tensor_WithInfinity_ReturnsTrue()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ReplaceNaN_ReplacesNaNWithZero()
    {
        var v = new Vector<double>(new double[] { 1.0, double.NaN, 3.0 });
    ...
    [Fact(Timeout = 120000)]
    public async Task ReplaceNaN_Null_ReturnsNull()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ReplaceInfinity_ReplacesInfWithZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ReplaceNonFinite_ReplacesBoth()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CountNaN_NoNaN_ReturnsZero()
    {
        var v = new Vector<double>(new double[] { 1.0, 2.0, 3.0 });
    ...
    [Fact(Timeout = 120000)]
    public async Task CountNaN_MultipleNaN_ReturnsCount()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CountInfinity_MultipleInf_ReturnsCount()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task StableSoftmax_HighestLogitGetsHighestProbability()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task StableSoftmax_EqualLogits_EqualProbabilities()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task StableSoftmax_LargeValues_NoOverflow()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task StableSoftmax_Null_ReturnsNull()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task StableLogSoftmax_AllNegative()
    {
        var logits = new Vector<double>(new double[] { 1.0, 2.0, 3.0 });
    ...
    [Fact(Timeout = 120000)]
    public async Task StableLogSoftmax_ExponentiatesToSoftmax()
    {
        var logits = new Vector<double>(new double[] { 1.0, 2.0, 3.0 });
    ...
    [Fact(Timeout = 120000)]
    public async Task StableLogSoftmax_LargeValues_NoOverflow()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task AssertFinite_Value_FiniteValue_DoesNotThrow()
    {
        NumericalStabilityHelper.AssertFinite(42.0);
    }

    [Fact(Timeout = 120000)]
    public async Task AssertFinite_Value_NaN_Throws()
    {
        Assert.Throws<ArgumentException>(() => NumericalStabilityHelper.AssertFinite(double.NaN));
    }

    [Fact(Timeout = 120000)]
    public async Task AssertFinite_Value_Infinity_Throws()
    {
        Assert.Throws<ArgumentException>(() => NumericalStabilityHelper.AssertFinite(double.PositiveInfinity));
    }

    [Fact(Timeout = 120000)]
    public async Task AssertFinite_Vector_AllFinite_DoesNotThrow()
    {
        var v = new Vector<double>(new double[] { 1.0, 2.0, 3.0 });
    ...
    [Fact(Timeout = 120000)]
    public async Task AssertFinite_Vector_WithNaN_Throws()
    {
        var v = new Vector<double>(new double[] { 1.0, double.NaN, 3.0 });
    ...
    [Fact(Timeout = 120000)]
    public async Task AssertFinite_Tensor_AllFinite_DoesNotThrow()
    {
        var t = new Tensor<double>(new[] { 3 }, new Vector<double>(new double[] { 1.0, 2.0, 3.0 }));
    ...
    [Fact(Timeout = 120000)]
    public async Task AssertFinite_Tensor_WithInfinity_Throws()
    {
        var t = new Tensor<double>(new[] { 3 }, new Vector<double>(new double[] { 1.0, double.PositiveInfinity, 3.0 }));
