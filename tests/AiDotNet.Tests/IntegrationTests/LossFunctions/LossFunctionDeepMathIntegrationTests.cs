...
public class LossFunctionDeepMathIntegrationTests
{
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_HandCalculated_TwoElements()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_Symmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_Derivative_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_SingleElement()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_SmallError_IsQuadratic()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_LargeError_IsLinear()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_AtDeltaBoundary_QuadraticAndLinearMatch()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_MultipleElements_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_CustomDelta_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_Derivative_QuadraticRegion()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_Derivative_LinearRegion()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_PerfectPrediction_IsZero()
    {
        var loss = new HuberLoss<double>(delta: 1.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task BCE_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BCE_PerfectPrediction_NearZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BCE_ConfidentWrongPrediction_HighLoss()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BCE_MultiElement_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task BCE_Derivative_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task KL_IdenticalDistributions_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task KL_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task KL_NonNegative()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task KL_NotSymmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task KL_Derivative_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Dice_PerfectOverlap_IsZero()
    {
        // pred = actual = [1, 1, 0, 0]
    ...
    [Fact(Timeout = 120000)]
    public async Task Dice_NoOverlap_IsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Dice_PartialOverlap_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Dice_Bounded_ZeroToOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Focal_GammaZero_EquivalentToBCE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Focal_HighGamma_DownWeightsEasyExamples()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Focal_HardExample_NotDownWeightedMuch()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Focal_AlphaWeighting_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Focal_NegativeClass_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CosineSimilarity_IdenticalVectors_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CosineSimilarity_OrthogonalVectors_IsOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CosineSimilarity_OppositeVectors_IsTwo()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task CosineSimilarity_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Quantile_Median_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Quantile_Median_Symmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Quantile_90th_PenalizesUnderestimationMore()
    {
        // quantile=0.9
    ...
    [Fact(Timeout = 120000)]
    public async Task Quantile_10th_PenalizesOverestimationMore()
    {
        // quantile=0.1
    ...
    [Fact(Timeout = 120000)]
    public async Task Quantile_PerfectPrediction_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Quantile_InvalidQuantile_Throws()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Quantile_Derivative_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Quantile_Derivative_Overestimation()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogCosh_SmallError_ApproximatesMSEHalf()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogCosh_LargeError_ApproximatesMAE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogCosh_Symmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogCosh_PerfectPrediction_IsZero()
    {
        var loss = new LogCoshLoss<double>();
        Assert.Equal(0.0, loss.CalculateLoss(V(5, 10), V(5, 10)), Tolerance);
    }
    ...
    [Fact(Timeout = 120000)]
    public async Task LogCosh_Derivative_IsTanh()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Poisson_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Poisson_PerfectPrediction_IsMinimum()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Poisson_Derivative_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Poisson_Derivative_AtPerfect_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Charbonnier_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Charbonnier_ZeroError_ReturnsEpsilon()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Charbonnier_ApproximatesL1_ForLargeErrors()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Charbonnier_SmoothAtZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Charbonnier_Derivative_HandCalculated()
    {
        // epsilon=1e-6, predicted=[3], actual=[1]
        // diff = 2, diffSquared = 4
    ...
    [Fact(Timeout = 120000)]
    public async Task Contrastive_SimilarPair_DistanceSquared()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Contrastive_DissimilarPair_InsideMargin()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Contrastive_DissimilarPair_OutsideMargin()
    {
        // Dissimilar pair (label=0), distance > margin
    ...
    [Fact(Timeout = 120000)]
    public async Task Contrastive_IdenticalPairs_ZeroLossForSimilar()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Triplet_HandCalculated_ActiveTriplet()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Triplet_InactiveTriplet_ZeroLoss()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Triplet_LargerMargin_MoreActiveTriplets()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Triplet_BatchAveraged()
    {
        // Batch of 2 triplets
    ...
    [Fact(Timeout = 120000)]
    public async Task ElasticNet_PureL1_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ElasticNet_PureL2_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ElasticNet_Mixed_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ElasticNet_ZeroAlpha_ReducesToMSE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ElasticNet_InvalidL1Ratio_Throws()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_LargeDelta_ConvergesToMSE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task LogCosh_VsHuber_BothSmootherThanMSE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Charbonnier_VsMAE_ApproachesAsEpsilonShrinks()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MSE_GradientCheck_NumericalDifference()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_GradientCheck_NumericalDifference()
    {
        var loss = new HuberLoss<double>(delta: 1.0);
        var pred = V(2.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task LogCosh_GradientCheck_NumericalDifference()
    {
        var loss = new LogCoshLoss<double>();
        var pred = V(2.5, 0.5);
        var actual = V(1.0, 3.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task Poisson_GradientCheck_NumericalDifference()
    {
        var loss = new PoissonLoss<double>();
        var pred = V(2.0, 5.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task Charbonnier_GradientCheck_NumericalDifference()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Dice_GradientCheck_NumericalDifference()
    {
        var loss = new DiceLoss<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task CosineSimilarity_GradientCheck_NumericalDifference()
    {
        var loss = new CosineSimilarityLoss<double>();
        var pred = V(3.0, 4.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task KL_GradientCheck_NumericalDifference()
    {
        var loss = new KullbackLeiblerDivergence<double>();
        var pred = V(0.4, 0.6);
    ...
    [Fact(Timeout = 120000)]
    public async Task AllLossFunctions_LengthMismatch_Throws()
    {
        var pred2 = V(1, 2);
        var actual3 = V(1, 2, 3);
    ...
    [Fact(Timeout = 120000)]
    public async Task BCE_NumericalStability_NearZeroAndOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Poisson_NumericalStability_NearZeroPrediction()
    {
