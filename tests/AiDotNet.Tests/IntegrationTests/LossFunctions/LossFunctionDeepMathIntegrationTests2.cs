...
public class LossFunctionDeepMathIntegrationTests2
{
    ...
    [Fact(Timeout = 120000)]
    public async Task Hinge_HandCalculated_CorrectClassification()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Hinge_PerfectMargin_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Hinge_Misclassification_HighLoss()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Hinge_ExactBoundary_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Hinge_Derivative_ActiveAndInactiveRegions()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Hinge_Derivative_NegativeLabel()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SquaredHinge_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SquaredHinge_PerfectClassification_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SquaredHinge_LargerThanHinge()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SquaredHinge_Derivative_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task SquaredHinge_Derivative_InactiveRegion()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_Symmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_NotSensitiveToOutliers_ComparedToMSE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_Derivative_SignFunction()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_PerfectPrediction_IsZero()
    {
        var loss = new RootMeanSquaredErrorLoss<double>();
        double result = loss.CalculateLoss(V(1, 2, 3), V(1, 2, 3));
        Assert.Equal(0.0, result, Tolerance);
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_GreaterThanOrEqualMAE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_EqualsMAE_ForUniformErrors()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_Derivative_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_QuadraticRegion_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_LinearRegion_HandCalculated()
    {
        // z = y*f(x) = 1*(-2) = -2, z < -1
        // -4*z = -4*(-2) = 8
        // loss = 8/1 = 8
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_BoundaryZ_NegativeOne()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_PerfectClassification_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_ContinuityAtBoundary()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_Derivative_QuadraticRegion()
    {
        // z = 1*0.5 = 0.5, -1 <= z < 1
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_Derivative_LinearRegion()
    {
        // z = 1*(-2) = -2 < -1
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_Derivative_ZeroWhenCorrect()
    {
        // z = 1*2 = 2 >= 1 => deriv = 0
        var loss = new ModifiedHuberLoss<double>();
        var deriv = loss.CalculateDerivative(V(2.0), V(1.0));
    ...
    [Fact(Timeout = 120000)]
    public async Task MBE_HandCalculated_UnderPrediction()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MBE_ErrorsCancelOut()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MBE_PerfectPrediction_IsZero()
    {
        var loss = new MeanBiasErrorLoss<double>();
        double result = loss.CalculateLoss(V(1, 2, 3), V(1, 2, 3));
        Assert.Equal(0.0, result, Tolerance);
    ...
    [Fact(Timeout = 120000)]
    public async Task MBE_Derivative_ConstantNegativeOneOverN()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MBE_Antisymmetric()
    {
        // MBE(p, a) = -MBE(a, p)
        var loss = new MeanBiasErrorLoss<double>();
        double l1 = loss.CalculateLoss(V(1, 3), V(5, 7));
    ...
    [Fact(Timeout = 120000)]
    public async Task Wasserstein_HandCalculated_AllReal()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Wasserstein_HandCalculated_AllFake()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Wasserstein_MixedRealFake()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Wasserstein_GoodCritic_NegativeLoss()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Wasserstein_Derivative_HandCalculated()
    {
        // deriv[i] = -actual[i] / n
        // actual=[1, -1], n=2
        // deriv = [-0.5, 0.5]
    ...
    [Fact(Timeout = 120000)]
    public async Task Jaccard_PerfectOverlap_IsZero()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Jaccard_NoOverlap_IsOne()
    {
    ...
    public async Task Jaccard_PartialOverlap_HandCalculated()
    {
        ...
        // JaccardLoss uses the PyTorch-style soft IoU formulation
        // (intersection = Σ(p*a), union = Σp + Σa - Σ(p*a)) which is
        // differentiable and matches the implementation's derivative — the
        // min/max set-theoretic formula isn't directly differentiable.
        // intersection = 0.8*1 + 0.2*0 + 0.6*0.5 = 1.1
        // union       = (0.8+0.2+0.6) + (1.0+0.0+0.5) - 1.1 = 1.6 + 1.5 - 1.1 = 2.0
    ...
    [Fact(Timeout = 120000)]
    public async Task Jaccard_Symmetric()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Jaccard_RelationToDice()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Margin_ClassPresent_BelowMPlus()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Margin_ClassPresent_AboveMPlus_IsZero()
    {
        // y=1, v=0.95, m+=0.9
    ...
    [Fact(Timeout = 120000)]
    public async Task Margin_ClassAbsent_AboveMMinus()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Margin_ClassAbsent_BelowMMinus_IsZero()
    {
        // y=0, v=0.05, m-=0.1
    ...
    [Fact(Timeout = 120000)]
    public async Task Margin_MultipleClasses_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Margin_Derivative_ClassPresent()
    {
        // y=1, v=0.7, m+=0.9
    ...
    [Fact(Timeout = 120000)]
    public async Task Exponential_CorrectPrediction_LowLoss()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Exponential_IncorrectPrediction_HighLoss()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Exponential_ZeroPrediction()
    {
        // y=1, f(x)=0 => exp(0) = 1.0
        var loss = new ExponentialLoss<double>();
    ...
    [Fact(Timeout = 120000)]
    public async Task Exponential_HandCalculated_TwoElements()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Exponential_Derivative_HandCalculated()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Exponential_AlwaysPositive()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WeightedCE_UniformWeights_EqualsBCE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WeightedCE_HandCalculated_WithWeights()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WeightedCE_HigherWeight_HigherLoss()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task WeightedCE_ZeroWeight_ZeroContribution()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OrdinalRegression_HandCalculated_3Classes()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OrdinalRegression_LowestClass()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OrdinalRegression_NotAveraged()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task OrdinalRegression_InvalidNumClasses_Throws()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task HingeLoss_UpperBoundsOnSquaredHinge()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task MAE_EqualsQuantile05()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_SquaredEqualsMSE()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Huber_Delta1_LinearRegionEqualsMAE_Minus_HalfDelta()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_ReducesToSquaredHinge_InQuadraticRegion()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Hinge_GradientNumericalCheck()
    {
        var loss = new HingeLoss<double>();
        var pred = V(0.3);
        var actual = V(1.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task SquaredHinge_GradientNumericalCheck()
    {
        var loss = new SquaredHingeLoss<double>();
        var pred = V(0.3);
        var actual = V(1.0);
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_GradientNumericalCheck_QuadraticRegion()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task ModifiedHuber_GradientNumericalCheck_LinearRegion()
    {
    ...
    [Fact(Timeout = 120000)]
    public async Task Exponential_GradientNumericalCheck()
    {
        var loss = new ExponentialLoss<double>();
        var actual = V(1.0);
        double eps = 1e-5;
    ...
    [Fact(Timeout = 120000)]
    public async Task Wasserstein_GradientNumericalCheck()
    {
        var loss = new WassersteinLoss<double>();
        var actual = V(1.0);
        double eps = 1e-5;
    ...
    [Fact(Timeout = 120000)]
    public async Task Margin_GradientNumericalCheck_ClassPresent()
    {
        var loss = new MarginLoss<double>(mPlus: 0.9, mMinus: 0.1, lambda: 0.5);
        var actual = V(1.0);
        double eps = 1e-5;
    ...
    [Fact(Timeout = 120000)]
    public async Task RMSE_GradientNumericalCheck()
    {
        var loss = new RootMeanSquaredErrorLoss<double>();
        var pred = V(1.0, 3.0);
