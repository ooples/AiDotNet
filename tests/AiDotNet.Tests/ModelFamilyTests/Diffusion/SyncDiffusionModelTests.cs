...
public class SyncDiffusionModelTests : DiffusionModelTestBase<float>
{
    // Per Lee et al. 2023: synchronized multi-window latent diffusion
    ...
    protected override IDiffusionModel<float> CreateModel()
    {
        ...
        return new SyncDiffusionModel<float>(predictor: unet, vae: vae, seed: 42);
    }
}
