...
public class StitchDiffusionModelTests : DiffusionModelTestBase<float>
{
    // Per Wang et al. 2023: latent diffusion with boundary stitching
    ...
    protected override IDiffusionModel<float> CreateModel()
    {
        ...
        return new StitchDiffusionModel<float>(predictor: unet, vae: vae, seed: 42);
    }
}
