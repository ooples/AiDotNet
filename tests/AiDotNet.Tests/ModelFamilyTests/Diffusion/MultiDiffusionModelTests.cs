...
public class MultiDiffusionModelTests : DiffusionModelTestBase<float>
{
    // Per Bar-Tal et al. 2023: operates in latent space, same UNet as SD
    ...
    protected override IDiffusionModel<float> CreateModel()
    {
        ...
        return new MultiDiffusionModel<float>(predictor: unet, vae: vae, seed: 42);
    }
}
