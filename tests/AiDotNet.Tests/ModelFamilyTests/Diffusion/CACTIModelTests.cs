...
public class CACTIModelTests : DiffusionModelTestBase<float>
{
    ...
    // CACTI wraps a full SD1.5 UNet (320 base, [1,2,4,4]) + VAE: a single forward over the 64x64 latent
