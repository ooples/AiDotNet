...
public class FederatedLearningHeterogeneityCorrectionIntegrationTests
{
    ...
    [InlineData("FedNova")]
    [InlineData("FedDyn")]
    public async Task BuildAsync_WithHeterogeneityCorrection_CompletesAndReportsCorrection(string algorithm)
    {
        ...
        Assert.Equal(algorithm, metadata!.HeterogeneityCorrectionUsed);
