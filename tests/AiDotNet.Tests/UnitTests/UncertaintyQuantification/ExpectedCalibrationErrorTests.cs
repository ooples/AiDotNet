...
public class ExpectedCalibrationErrorTests
{
    ...
    public void Compute_WithPerfectCalibration_ReturnsZero()
    {
        ...
        var probabilities = new Vector<double>(new double[] { 0.9, 0.8, 0.7, 0.6, 0.5 });
        var predictions = new Vector<int>(new int[] { 1, 1, 1, 1, 0 });
        var trueLabels = new Vector<int>(new int[] { 1, 1, 1, 1, 0 });
