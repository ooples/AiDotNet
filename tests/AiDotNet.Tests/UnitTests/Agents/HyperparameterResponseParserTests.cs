...
public class HyperparameterResponseParserTests
{
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithJsonCodeBlock_ExtractsParameters()
    {
...
These values should work well for your dataset.";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithRawJsonObject_ExtractsParameters()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithJsonCodeBlockNoLanguageTag_ExtractsParameters()
    {
...
```";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithJsonBooleans_ExtractsCorrectTypes()
    {
        var response = @"```json
...
```";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithMarkdownBold_ExtractsParameters()
    {
...
- **subsample:** 0.8";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithMarkdownBoldAndTrailingPunctuation_TrimsCorrectly()
    {
...
**max_depth:** 5;";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithColonSeparated_ExtractsParameters()
    {
...
learning_rate: 0.03";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithEqualsSeparated_ExtractsParameters()
    {
...
epochs = 50";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithBulletPoints_ExtractsParameters()
    {
...
* weights: distance";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_SkipsCommonNonParameters()
    {
        var response = @"step: 1
model: RandomForest
n_estimators: 200
...
example: try this";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithEmptyInput_ReturnsEmptyDictionary()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithNullInput_ReturnsEmptyDictionary()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithWhitespaceOnly_ReturnsEmptyDictionary()
    {
        var result = _parser.Parse("   \n  \t  ");
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithNoHyperparameters_ReturnsEmptyDictionary()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_WithMalformedJson_FallsBackToOtherStrategies()
    {
        var response = @"```json
{invalid json here}
```
...
**max_depth:** 5";
    ...
    [Fact(Timeout = 60000)]
    public async Task InferTypedValue_WithIntegerString_ReturnsInt()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task InferTypedValue_WithDoubleString_ReturnsDouble()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task InferTypedValue_WithBoolString_ReturnsBool()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task InferTypedValue_WithNonNumericString_ReturnsString()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task InferTypedValue_WithQuotedString_RemovesQuotes()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task InferTypedValue_WithEmptyString_ReturnsNull()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task InferTypedValue_WithScientificNotation_ReturnsDouble()
    {
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_JsonTakesPriorityOverMarkdown()
    {
...
```";
    ...
    [Fact(Timeout = 60000)]
    public async Task Parse_MarkdownTakesPriorityOverColon()
    {
        var response = @"n_estimators: 999
**n_estimators:** 200";
