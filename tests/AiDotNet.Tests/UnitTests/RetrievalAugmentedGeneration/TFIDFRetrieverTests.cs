...
namespace AiDotNetTests.UnitTests.RetrievalAugmentedGeneration
{
    ...
    public class TFIDFRetrieverTests
    {
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_MatchingDocument_ReturnsDocument()
        {
            // Arrange
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_MultipleDocuments_ReturnsRankedByRelevance()
        {
            // Arrange
            var store = CreateStoreWithDocuments(
                ("doc1", "the quick brown fox jumps over the lazy dog"),
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_NoMatchingTerms_ReturnsZeroScoreDocuments()
        {
            // Arrange
            var store = CreateStoreWithDocuments(
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_HigherTermFrequency_GetsHigherScore()
        {
            // Arrange
            var store = CreateStoreWithDocuments(
                ("doc1", "fox"),
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_RareTermsGetHigherWeight()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_CommonTermsGetLowerWeight()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_MoreQueryTermsMatch_GetHigherScore()
        {
            // Arrange
            var store = CreateStoreWithDocuments(
                ("doc1", "the quick brown fox"),
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_RepeatedCalls_UsesCachedStatistics()
        {
            // Arrange
            var store = CreateStoreWithDocuments(
                ("doc1", "the quick brown fox"),
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_AfterDocumentCountChange_InvalidatesCache()
        {
            // Arrange
            var store = CreateStoreWithDocuments(
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_HandlesSpecialCharacters()
        {
            // Arrange - Need multiple documents for meaningful IDF scores
            var store = CreateStoreWithDocuments(
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_HandlesTabs_And_Newlines()
        {
            // Arrange - Need multiple documents for meaningful IDF scores
            var store = CreateStoreWithDocuments(
                ("doc1", "first\tsecond\nthird"),
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_EmptyDocumentContent_HandlesCorrectly()
        {
            // Arrange
            var store = CreateStoreWithDocuments(
                ("doc1", ""),
        ...
        [Fact(Timeout = 60000)]
        public async Task Retrieve_SingleWordDocument_HandlesCorrectly()
        {
            // Arrange
            var store = CreateStoreWithDocuments(("doc1", "fox"));
            var retriever = new TFIDFRetriever<double>(store);
