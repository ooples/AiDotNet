...
namespace AiDotNetTests.UnitTests.Data.Sampling
{
    ...
    public class DynamicBatchSamplerTests
    {
        ...
        [Fact(Timeout = 60000)]
        public async Task Constructor_WithNullSampleLengths_ThrowsArgumentException()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task Constructor_WithEmptySampleLengths_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>(() =>
        ...
        [Fact(Timeout = 60000)]
        public async Task Constructor_WithZeroMaxTokens_ThrowsArgumentOutOfRangeException()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task Constructor_WithZeroMaxSamples_ThrowsArgumentOutOfRangeException()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
        ...
        [Fact(Timeout = 60000)]
        public async Task Constructor_WithNegativeSampleLength_ThrowsArgumentOutOfRangeException()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
        ...
        [Fact(Timeout = 60000)]
        public async Task Constructor_WithZeroSampleLength_ThrowsArgumentOutOfRangeException()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_RespectsTokenBudget()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_VariableLengths_PacksEfficiently()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_SingleSampleExceedsBudget_GetsOwnBatch()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_MaxSamplesPerBatch_LimitsBatchSize()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_DropLastFalse_IncludesIncompleteBatch()
        {
            var sampler = new DynamicBatchSampler(
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_DropLastTrue_ExcludesIncompleteBatch()
        {
            var sampler = new DynamicBatchSampler(
                sampleLengths: new[] { 50, 50, 50 },
                maxTokensPerBatch: 100,
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_SeededShuffle_IsDeterministic()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_DifferentSeeds_ProduceDifferentOrder()
        {
        ...
        [Fact(Timeout = 60000)]
        public async Task GetBatchIndices_NoShuffle_ReturnsSequentialOrder()
        {
            var sampler = new DynamicBatchSampler(
                sampleLengths: new[] { 10, 20, 30, 40, 50 },
                maxTokensPerBatch: 1000,
        ...
        [Fact(Timeout = 60000)]
        public async Task GetIndices_ReturnsAllSampleIndices()
        {
            var sampler = new DynamicBatchSampler(
