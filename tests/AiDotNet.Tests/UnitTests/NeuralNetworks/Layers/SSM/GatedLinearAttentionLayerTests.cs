...
/// <summary>
/// Unit tests for <see cref="GatedLinearAttentionLayer{T}"/>.
/// </summary>
public class GatedLinearAttentionLayerTests
{
    ...
    public void Constructor_ValidParameters_CreatesLayer()
    {
        ...
        var layer = new GatedLinearAttentionLayer<float>(seqLen, modelDim, numHeads);
    ...
    public void Forward_DeterministicWithSameParameters()
    {
        ...
        int modelDim = 32;
        int numHeads = 4;
        var layer1 = new GatedLinearAttentionLayer<float>(seqLen, modelDim, numHeads);
        var layer2 = new GatedLinearAttentionLayer<float>(seqLen, modelDim, numHeads);
    ...
    public void GetQueryWeights_ReturnsValidTensor()
    {
        int modelDim = 64;
        int numHeads = 8;
        var layer = new GatedLinearAttentionLayer<float>(8, modelDim, numHeads);
    ...
    public void Forward_Double_ProducesValidOutput()
    {
        ...
        int modelDim = 32;
        int numHeads = 4;
        var layer = new GatedLinearAttentionLayer<double>(seqLen, modelDim, numHeads);
