...
namespace AiDotNetTests.UnitTests.Helpers
{
    public class EnumHelperTests
    {
        ...
        public void GetEnumValues_WithActivationFunction_ReturnsValues()
        {
            ...
            // Assert
            Assert.NotNull(result);
            Assert.DoesNotContain(ActivationFunction.None, result);
        }
        ...
        [Fact]
        public void GetEnumValues_WithNullIgnoreName_WorksCorrectly()
        {
            // Act
        ...
        [Fact]
        public void GetEnumValues_WithEmptyStringIgnoreName_WorksCorrectly()
        {
            // Act
            var result = EnumHelper.GetEnumValues<TestEnum>("");
