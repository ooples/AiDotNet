...
public class ElasticNetRegularization<T, TInput, TOutput> : RegularizationBase<T, TInput, TOutput>
{
    ...
    /// <inheritdoc />
    /// <remarks>
    /// Elastic-Net gradient contribution: combines L1 and L2 terms via
    /// <see cref="ElasticRegularizationOptions.L1Ratio"/>. Override
    /// avoids the wrap/unwrap round-trip the base
