...
{
    /// <summary>
    /// Pinecone-based document store for managed vector database.
    /// </summary>
    ...
    public class PineconeDocumentStore<T> : DocumentStoreBase<T>
    {
        ...
        /// <param name="environment">The Pinecone environment.</param>
        public PineconeDocumentStore(INumericOperations<T> numericOperations, string indexName, string apiKey, string environment) : base(numericOperations)
        {
