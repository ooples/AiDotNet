...
namespace AiDotNet.RetrievalAugmentedGeneration.DocumentStores
{
    ...
    public class PostgresVectorDocumentStore<T> : DocumentStoreBase<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgresVectorDocumentStore{T}"/> class.
        /// </summary>
        /// <param name="numericOperations">The numeric operations for type T.</param>
        /// <param name="connectionString">The PostgreSQL connection string.</param>
        /// <param name="tableName">The table name for storing documents.</param>
        public PostgresVectorDocumentStore(INumericOperations<T> numericOperations, string connectionString, string tableName) : base(numericOperations)
        {
