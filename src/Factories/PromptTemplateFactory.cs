...
public static class PromptTemplateFactory
{
    ...
    /// <param name="exampleSelector">Example selector for FewShot templates (optional).</param>
    ...
    public static IPromptTemplate Create(
        ...
        IFewShotExampleSelector<double>? exampleSelector = null,
        int exampleCount = 3)
    {
        return templateType switch
        {
            PromptTemplateType.Simple => CreateSimpleTemplate(template),
            PromptTemplateType.FewShot => CreateFewShotTemplate(template, exampleSelector, exampleCount),
    ...
    /// </summary>
    private static FewShotPromptTemplate CreateFewShotTemplate(
        string? template,
