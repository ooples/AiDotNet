...
/// <summary>
/// Configuration options for the SwinTransformer detection backbone.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public class SwinTransformerOptions : DetectionBackboneOptions
{
    /// <summary>
    /// Gets or sets which published size of the model to build. Default: <c>SwinVariant.SwinTiny</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public SwinVariant Variant { get; set; } = SwinVariant.SwinTiny;

    /// <summary>
    /// Side length, in patches, of the local window self-attention is computed within. Default: <c>7</c>.
    /// </summary>
    /// <remarks>
    /// <para><b>For Beginners:</b> Swin computes attention inside small windows instead of across the whole image, which is what makes it affordable at high resolution. The paper uses 7.</para>
    /// </remarks>
    ...
    public void Validate()
    {
        ...
        Require(WindowSize, nameof(WindowSize));
    }
}
