...
/// <summary>
/// Configuration options for the EfficientNetBackbone detection backbone.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public class EfficientNetBackboneOptions : DetectionBackboneOptions
{
    /// <summary>
    /// Gets or sets which published size of the model to build. Default: <c>EfficientNetVariant.B0</c>.
    /// </summary>
    /// <remarks>
    /// <para>
