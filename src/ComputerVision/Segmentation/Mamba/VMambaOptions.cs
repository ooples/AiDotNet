...
/// </remarks>
public class VMambaOptions : SegmentationModelOptions
{
    ...
    public VMambaOptions()
    {
        NumClasses = 150;
        DropRate = 0.1;
        ModelSize = VMambaModelSize.Tiny;
    }
    ...
    /// <value>Defaults to <c>6e-5</c>, as specified for VMamba ADE20K training.</value>
    ...
    /// <value>Defaults to <c>0.01</c>, as specified for VMamba ADE20K training.</value>
    ...
    /// Default: <c>VMambaModelSize.Tiny</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public VMambaModelSize ModelSize { get; set; }
