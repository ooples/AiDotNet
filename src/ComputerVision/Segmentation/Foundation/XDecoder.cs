...
/// var model = new XDecoder&lt;double&gt;(architecture, options: new XDecoderOptions { NumClasses = 150 });
///
/// // Or load a pre-trained ONNX model for referring and open-vocabulary segmentation
/// var onnxModel = new XDecoder&lt;double&gt;(architecture, "xdecoder.onnx", options: new XDecoderOptions { NumClasses = 150 });
/// </code>
/// </example>
