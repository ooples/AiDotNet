...
/// </remarks>
public class PointTransformerV3Options : SegmentationModelOptions
{
    ...
    public PointTransformerV3Options()
    {
        NumClasses = 40;
        DropRate = 0.1;
        ModelSize = PointTransformerV3ModelSize.Base;
    }
    ...
    /// Default: <c>PointTransformerV3ModelSize.Base</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PointTransformerV3ModelSize ModelSize { get; set; }
