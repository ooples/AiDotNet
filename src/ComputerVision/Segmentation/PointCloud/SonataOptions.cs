...
/// </remarks>
public class SonataOptions : SegmentationModelOptions
{
    ...
    public SonataOptions()
    {
        NumClasses = 40;
        DropRate = 0.1;
        ModelSize = SonataModelSize.Base;
    }
    ...
    /// Default: <c>SonataModelSize.Base</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public SonataModelSize ModelSize { get; set; }
