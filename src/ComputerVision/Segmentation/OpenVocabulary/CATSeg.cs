...
/// <remarks>
/// <para>
/// <b>For Beginners:</b> Open-vocabulary segmentation via cost aggregation. Novel category recognition.
///
/// Common use cases:
...
/// </para>
/// </remarks>
public class CATSeg<T> : NeuralNetworkBase<T>
{
    ...
    #region Constructors
    /// <summary>
    /// Initializes CATSeg in native (trainable) mode.
    /// </summary>
    ...
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> Creates a trainable CATSeg model.
    /// </para>
    /// </remarks>
    ...
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> Loads a pre-trained CATSeg from ONNX for inference.
    /// </para>
    /// </remarks>
    ...
    protected override void InitializeLayers()
    {
        ...
        {
            var encoderLayers = LayerHelper<T>.CreateCATSegEncoderLayers(_channels, _height, _width, _channelDims, _depths, _dropRate).ToList();
            _encoderLayerEnd = encoderLayers.Count; Layers.AddRange(encoderLayers);
            int fH = _height / 32, fW = _width / 32;
            var decoderLayers = LayerHelper<T>.CreateCATSegDecoderLayers(_channelDims[^1], _decoderDim, _numClasses, fH, fW);
    ...
    protected override IFullModel<T, Tensor<T>, Tensor<T>> CreateNewInstance() => _useNativeMode
        ...
        : new CATSeg<T>(Architecture, _onnxModelPath!, _numClasses, _options);
