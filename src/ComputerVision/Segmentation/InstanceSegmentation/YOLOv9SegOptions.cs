...
/// <summary>
/// Configuration options for YOLOv9-Seg instance segmentation.
/// </summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the YOLOv9Seg model. Default values follow the original paper settings.</para>
/// </remarks>
public class YOLOv9SegOptions : SegmentationModelOptions
{
    /// <summary>Initializes a new instance with default values.</summary>
    public YOLOv9SegOptions()
    {
        NumClasses = 80;
        DropRate = 0.0;
        ModelSize = YOLOv9SegModelSize.C;
    }

    /// <summary>Initializes a new instance by copying from another instance.</summary>
    /// <param name="other">The options instance to copy from.</param>
    /// <exception cref="ArgumentNullException">Thrown when other is null.</exception>
    public YOLOv9SegOptions(YOLOv9SegOptions other)
    {
        if (other == null)
    ...
    /// Default: <c>YOLOv9SegModelSize.C</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public YOLOv9SegModelSize ModelSize { get; set; }
