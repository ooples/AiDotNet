...
/// </remarks>
public class YOLOv12SegOptions : SegmentationModelOptions
{
    ...
    public YOLOv12SegOptions()
    {
        NumClasses = 80;
        DropRate = 0;
        ModelSize = YOLOv12SegModelSize.N;
    }
    ...
    /// Default: <c>YOLOv12SegModelSize.N</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public YOLOv12SegModelSize ModelSize { get; set; }
