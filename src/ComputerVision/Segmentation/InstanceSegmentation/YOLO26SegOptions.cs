...
/// </remarks>
public class YOLO26SegOptions : SegmentationModelOptions
{
    ...
    public YOLO26SegOptions()
    {
        NumClasses = 80;
        DropRate = 0;
        ModelSize = YOLO26SegModelSize.N;
    }
    ...
    /// Default: <c>YOLO26SegModelSize.N</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public YOLO26SegModelSize ModelSize { get; set; }
