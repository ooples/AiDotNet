...
/// </remarks>
public class YOLO11SegOptions : SegmentationModelOptions
{
    ...
    public YOLO11SegOptions()
    {
        NumClasses = 80;
        DropRate = 0;
        ModelSize = YOLO11SegModelSize.N;
    }
    ...
    /// Default: <c>YOLO11SegModelSize.N</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public YOLO11SegModelSize ModelSize { get; set; }
