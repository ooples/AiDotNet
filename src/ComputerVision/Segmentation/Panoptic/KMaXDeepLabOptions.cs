...
/// </remarks>
public class KMaXDeepLabOptions : SegmentationModelOptions
{
    ...
    public KMaXDeepLabOptions()
    {
        NumClasses = 133;
        DropRate = 0.1;
        ModelSize = KMaXDeepLabModelSize.R50;
    }
    ...
    /// Default: <c>KMaXDeepLabModelSize.R50</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public KMaXDeepLabModelSize ModelSize { get; set; }
