...
/// <summary>
/// Configuration options for MobileSAM (distilled lightweight SAM).
/// </summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the MobileSAM model. Default values follow the original paper settings.</para>
/// </remarks>
public class MobileSAMOptions : SegmentationModelOptions
{
    /// <summary>Initializes a new instance with default values.</summary>
    public MobileSAMOptions()
    {
        NumClasses = 1;
        DropRate = 0;
    }
    ...
    public MobileSAMOptions(MobileSAMOptions other)
    {
        if (other == null)
