...
[ModelPaper("DiffCut: Catalyzing Zero-Shot Semantic Segmentation with Diffusion Features and Recursive Normalized Cut", "https://arxiv.org/abs/2407.00555", Year = 2024, Authors = "Couairon et al.")]
public class DiffCutSegmentation<T> : NeuralNetworkBase<T>, ISemanticSegmentation<T>
{
    ...
    #region Constructors
    /// <summary>
    /// Initializes DiffCutSegmentation in native (trainable) mode.
    /// </summary>
    ...
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> Creates a trainable DiffCutSegmentation model.
    /// </para>
    /// </remarks>
    ...
    protected override void InitializeLayers()
    {
        ...
        else
        {
            ...
            var decoderLayers = LayerHelper<T>.CreateDiffCutSegmentationDecoderLayers(_channelDims[^1], _decoderDim, _numClasses, fH, fW);
