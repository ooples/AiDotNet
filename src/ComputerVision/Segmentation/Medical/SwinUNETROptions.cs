...
/// </remarks>
public class SwinUNETROptions : SegmentationModelOptions
{
    ...
    public SwinUNETROptions()
    {
        NumClasses = 14;
        DropRate = 0.1;
        ModelSize = SwinUNETRModelSize.Tiny;
    }
    ...
    /// Default: <c>SwinUNETRModelSize.Tiny</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public SwinUNETRModelSize ModelSize { get; set; }
