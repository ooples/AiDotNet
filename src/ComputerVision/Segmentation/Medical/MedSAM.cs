...
/// <remarks>
/// <para>
/// <b>For Beginners:</b> Universal medical image segmentation. CT, MRI, ultrasound, X-ray, endoscopy segmentation.
///
/// Common use cases:
...
/// </para>
/// </remarks>
public class MedSAM<T> : NeuralNetworkBase<T>
{
    ...
    #region Constructors
    /// <summary>
    /// Initializes MedSAM in native (trainable) mode.
    /// </summary>
    ...
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> Creates a trainable MedSAM model.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Initializes MedSAM in ONNX (inference-only) mode.
    /// </summary>
    /// <param name="architecture">Neural network architecture defining input dimensions.</param>
    ...
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> Loads a pre-trained MedSAM from ONNX for inference.
    /// </para>
    /// </remarks>
    ...
    protected override void InitializeLayers()
    {
        ...
        {
            var encoderLayers = LayerHelper<T>.CreateMedSAMEncoderLayers(_channels, _height, _width, _channelDims, _depths, _dropRate).ToList();
            _encoderLayerEnd = encoderLayers.Count; Layers.AddRange(encoderLayers);
            int fH = _height / 32, fW = _width / 32;
            var decoderLayers = LayerHelper<T>.CreateMedSAMDecoderLayers(_channelDims[^1], _decoderDim, _numClasses, fH, fW);
    ...
    protected override IFullModel<T, Tensor<T>, Tensor<T>> CreateNewInstance() => _useNativeMode
        ...
        : new MedSAM<T>(Architecture, _onnxModelPath!, _numClasses, _modelSize, _options);
