...
public class NnUNet<T> : Common.MedicalSegmentationBase<T>
{
    ...
    #region Fields
    // Only NnUNet's OWN configuration lives here. _height, _width, _channels, _numClasses,
    // _useNativeMode, _onnxModelPath, _onnxSession, _optimizer, _disposed and _encoderLayerEnd all
    // come from MedicalSegmentationBase -> SegmentationModelBase.
    private static readonly string[] ModalitiesSupported = ["CT", "MRI_T1", "MRI_T2", "Xray", "Ultrasound"];
    ...
    // and NnUNet owns no other unmanaged resource.
    #endregion
    ...
    /// <summary>
    /// Segments a 3D volume slice-by-slice and aggregates the per-structure statistics.
    /// </summary>
