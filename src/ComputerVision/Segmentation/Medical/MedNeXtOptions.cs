...
/// </remarks>
public class MedNeXtOptions : SegmentationModelOptions
{
    ...
    public MedNeXtOptions()
    {
        NumClasses = 14;
        DropRate = 0;
        ModelSize = MedNeXtModelSize.Small;
    }
    ...
    /// Default: <c>MedNeXtModelSize.Small</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public MedNeXtModelSize ModelSize { get; set; }
