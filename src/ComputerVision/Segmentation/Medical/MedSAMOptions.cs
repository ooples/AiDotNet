...
/// </remarks>
public class MedSAMOptions : SegmentationModelOptions
{
    ...
    public MedSAMOptions()
    {
        NumClasses = 1;
        DropRate = 0;
        ModelSize = MedSAMModelSize.ViTBase;
    }
    ...
    /// Default: <c>MedSAMModelSize.ViTBase</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public MedSAMModelSize ModelSize { get; set; }
