...
///
/// // Train to estimate conditional quantiles from tree ensemble
/// var result = new AiModelBuilder&lt;double, Matrix&lt;double&gt;, Vector&lt;double&gt;&gt;()
///     .ConfigureModel(new QuantileRegressionForests&lt;double&gt;(options))
///     .Build(features, targets);
///
/// // Predict quantile estimates for a new sample
