...
///     .ConfigureModel(new ExtremelyRandomizedTreesRegression&lt;double&gt;(options))
...
public partial class ExtremelyRandomizedTreesRegression<T> : AsyncDecisionTreeRegressionBase<T>
{
    /// <summary>
