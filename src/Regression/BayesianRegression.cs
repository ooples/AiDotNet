...
public class BayesianRegression<T> : RegressionModelBase<T>
{
    ...
    /// K(x, y) = (γ * x·y + coef0)^degree, where x·y is the dot product between x and y, γ is a scaling parameter,
    ...
    /// K(x, y) = tanh(γ * x·y + coef0), where x·y is the dot product between x and y, γ is a scaling parameter,
