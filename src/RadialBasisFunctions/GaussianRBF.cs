...
/// <summary>
/// Implements a Gaussian Radial Basis Function (RBF) of the form exp(-ε*r²).
/// </summary>
/// <typeparam name="T">The numeric type used for calculations, typically float or double.</typeparam>
/// <remarks>
/// <para>
/// This class provides an implementation of a Radial Basis Function (RBF) that uses a Gaussian form
/// of φ(r) = exp(-ε*r²), where r is the radial distance and ε (epsilon) is a width parameter
...
public class GaussianRBF<T> : IRadialBasisFunction<T>
{
    ...
    /// exp(-ε*r²), which decreases exponentially with the square of the distance. The function equals 1
    ...
    /// The formula for the derivative is -2εr * exp(-ε*r²), which is always negative for positive r and ε,
