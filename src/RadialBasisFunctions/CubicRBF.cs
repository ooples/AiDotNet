...
/// of the form φ(r) = (r/width)³, where r is the radial distance and width is a scaling parameter.
...
public class CubicRBF<T> : IRadialBasisFunction<T>
{
    ...
    /// The formula for this derivative is -3r³/width⁴. The negative sign indicates that increasing
