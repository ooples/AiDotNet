...
/// φ(r) = r² log(r), where r is the radial distance. This is a special case of the polyharmonic spline with k = 2.
...
public class ThinPlateSplineRBF<T> : IRadialBasisFunction<T>
{
    ...
    /// the Thin Plate Spline RBF does not take any parameters as it has the fixed form φ(r) = r² log(r).
    /// </para>
