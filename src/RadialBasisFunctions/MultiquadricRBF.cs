...
/// <summary>
/// Implements a Multiquadric Radial Basis Function (RBF) of the form √(r² + ε²).
/// </summary>
/// <typeparam name="T">The numeric type used for calculations, typically float or double.</typeparam>
/// <remarks>
/// <para>
/// This class provides an implementation of a Radial Basis Function (RBF) that uses a multiquadric form
/// of φ(r) = √(r² + ε²), where r is the radial distance and ε (epsilon) is a shape parameter
...
/// a value of ε at the center point (r = 0) and gradually increasing in all directions.
/// 
/// This RBF has a parameter called epsilon (ε) that controls the shape of the function:
...
public class MultiquadricRBF<T> : IRadialBasisFunction<T>
{
    ...
    /// <returns>The computed function value √(r² + ε²).</returns>
    /// <remarks>
    /// <para>
    /// This method calculates the value of the Multiquadric RBF for a given radius r. The formula used is
    /// √(r² + ε²), which increases with distance. The function reaches its minimum value of ε at r = 0
    ...
    /// - At the center (r = 0), the value is at its minimum of ε (epsilon)
    ...
    /// The formula for the derivative is r/√(r² + ε²), which is always positive for positive r,
    ...
    /// The formula for this derivative is ε/√(r² + ε²). The sign of this derivative is always positive for positive ε,
