...
/// <summary>
/// Implements a Rational Quadratic Radial Basis Function (RBF) of the form 1 - r²/(r² + ε²).
/// </summary>
...
/// of φ(r) = 1 - r²/(r² + ε²), where r is the radial distance and ε (epsilon) is a shape parameter
...
/// 
/// This RBF has a parameter called epsilon (ε) that controls the width of the hill:
...
public class RationalQuadraticRBF<T> : IRadialBasisFunction<T>
{
    ...
    /// <returns>The computed function value 1 - r²/(r² + ε²).</returns>
    /// <remarks>
    /// <para>
    /// This method calculates the value of the Rational Quadratic RBF for a given radius r. The formula used is
    /// 1 - r²/(r² + ε²), which decreases with distance. The function equals 1 at r = 0 and approaches 0
    ...
    /// 3. Adding these squared values (r² + ε²)
    /// 4. Dividing r² by this sum (r²/(r² + ε²))
    /// 5. Subtracting this fraction from 1 (1 - r²/(r² + ε²))
    /// 
    ...
    /// The formula for the derivative is -2rε²/(r² + ε²)², which is always negative for positive r and ε,
    ...
    /// The formula for this derivative is 2εr²/(r² + ε²)². The sign of this derivative is positive for positive ε and r,
