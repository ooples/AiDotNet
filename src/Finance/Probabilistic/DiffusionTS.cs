...
public class DiffusionTS<T> : ForecastingModelBase<T>
{
    ...
    private (Tensor<T> trend, Tensor<T> seasonal, Tensor<T> residual) DecomposeTimeSeries(Tensor<T> timeSeries)
    {
        ...
        return (new Tensor<T>(timeSeries.Shape._dims, new Vector<T>(trendVec)),
                new Tensor<T>(timeSeries.Shape._dims, new Vector<T>(seasonalVec)),
                new Tensor<T>(timeSeries.Shape._dims, new Vector<T>(residualVec)));
    }
    ...
    private Tensor<T> ApplySmoothness(Tensor<T> trend)
    {
        ...
        return new Tensor<T>(trend.Shape._dims, new Vector<T>(smoothed));
    }
