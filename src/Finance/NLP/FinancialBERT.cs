...
public class FinancialBERT<T> : FinancialNLPModelBase<T>
{
    ...
    /// <summary>
    /// Creates a FinancialBERT network using a pretrained ONNX model.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> In the FinancialBERT model, FinancialBERT sets up the architecture and options. This prepares the model for training or inference.
    /// </para>
    /// </remarks>
    public FinancialBERT(
    ...
    /// <summary>
    /// Creates a FinancialBERT network in native mode for training.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> In the FinancialBERT model, FinancialBERT sets up the architecture and options. This prepares the model for training or inference.
    ...
    /// <summary>
    /// Executes InitializeLayers for the FinancialBERT.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> In the FinancialBERT model, InitializeLayers builds and wires up model components. This sets up the FinancialBERT architecture before use.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Executes TrainCore for the FinancialBERT.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> In the FinancialBERT model, TrainCore performs a training step. This updates the FinancialBERT architecture so it learns from data.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Executes Backward for the FinancialBERT.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> In the FinancialBERT model, Backward propagates gradients backward. This teaches the FinancialBERT architecture how to adjust its weights.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Executes UpdateParameters for the FinancialBERT.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> In the FinancialBERT model, UpdateParameters updates internal parameters or state. This keeps the FinancialBERT architecture aligned with the latest values.
    /// </para>
    /// </remarks>
    ...
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> In the FinancialBERT model, ForecastNative produces predictions from input data. This is the main inference step of the FinancialBERT architecture.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Executes ValidateInputShape for the FinancialBERT.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <b>For Beginners:</b> In the FinancialBERT model, ValidateInputShape checks inputs and configuration. This protects the FinancialBERT architecture from mismatches and errors.
    /// </para>
    /// </remarks>
