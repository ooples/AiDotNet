...
/// </para>
/// </remarks>
public class TimesFM<T> : NeuralNetworkBase<T>, IForecastingModel<T>
{
    ...
    /// <summary>
    /// The ONNX inference session for running pretrained TimesFM.
    /// </summary>
    ...
    /// <inheritdoc/>
    public int PatchSize => _patchLength;

    /// <inheritdoc/>
    public int Stride => _patchLength;
