...
public class YingLong<T> : TimeSeriesFoundationModelBase<T>
{
    ...
    private readonly YingLongOptions<T> _options;
    ...
    /// <summary>
    /// Creates a YingLong model using a pretrained ONNX model.
    /// </summary>
    public YingLong(
        NeuralNetworkArchitecture<T> architecture,
        string onnxModelPath,
        YingLongOptions<T>? options = null,
    ...
    /// <summary>
    /// Creates a YingLong model in native mode for training or fine-tuning.
    /// </summary>
    public YingLong(
        NeuralNetworkArchitecture<T> architecture,
        YingLongOptions<T>? options = null,
