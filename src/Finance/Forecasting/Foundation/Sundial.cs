...
[ModelPaper("Sundial: Solar Forecasting with Foundation Models", "https://arxiv.org/abs/2402.02575")]
...
public class Sundial<T> : TimeSeriesFoundationModelBase<T>
{
    ...
    private readonly SundialOptions<T> _options;
    ...
    /// <summary>
    /// Creates a Sundial model using a pretrained ONNX model.
    /// </summary>
    public Sundial(
        NeuralNetworkArchitecture<T> architecture,
        string onnxModelPath,
        SundialOptions<T>? options = null,
    ...
    /// <summary>
    /// Creates a Sundial model in native mode for training or fine-tuning.
    /// </summary>
    public Sundial(
        NeuralNetworkArchitecture<T> architecture,
        SundialOptions<T>? options = null,
