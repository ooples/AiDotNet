...
public class TimeBridge<T> : TimeSeriesFoundationModelBase<T>
{
    ...
    private readonly TimeBridgeOptions<T> _options;
    ...
    private int _bridgeDimension;
    private bool _useStationarityGating;
    ...
    /// <summary>
    /// Creates a TimeBridge model using a pretrained ONNX model.
    /// </summary>
    public TimeBridge(
        NeuralNetworkArchitecture<T> architecture,
        string onnxModelPath,
        TimeBridgeOptions<T>? options = null,
        ...
        : base(architecture, lossFunction ?? new MeanSquaredErrorLoss<T>(), 1.0)
    {
        ...
        options ??= new TimeBridgeOptions<T>();
        _options = options;
        Options = _options;
    ...
    /// <summary>
    /// Creates a TimeBridge model in native mode for training or fine-tuning.
    /// </summary>
    public TimeBridge(
        NeuralNetworkArchitecture<T> architecture,
        TimeBridgeOptions<T>? options = null,
    ...
    private void CopyOptionsToFields(TimeBridgeOptions<T> options)
    {
    ...
    protected override void InitializeLayers()
    {
        ...
        {
            Layers.AddRange(LayerHelper<T>.CreateDefaultTimeBridgeLayers(
    ...
    public override Dictionary<string, T> GetFinancialMetrics()
    {
        ...
        return new Dictionary<string, T>
        {
            ...
            ["BridgeDimension"] = NumOps.FromDouble(_bridgeDimension),
            ["LastLoss"] = lastLoss
        };
    }
    ...
    private Tensor<T> BackwardNative(Tensor<T> gradOutput)
    {
        ...
        if (_bridgeModule is not null)
            current = _bridgeModule.Backward(current);
    ...
    private new int GetParameterCount()
    {
        ...
        // Bridge module
        total += (long)_hiddenDimension * _bridgeDimension + _bridgeDimension;
        total += (long)_bridgeDimension * _hiddenDimension + _hiddenDimension;
