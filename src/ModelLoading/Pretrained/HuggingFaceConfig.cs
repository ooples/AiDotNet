...
public sealed class HuggingFaceConfig
{
    ...
    /// <summary>Attention-logit soft-cap magnitude (Gemma-2 <c>attn_logit_softcapping</c>); null when absent.</summary>
    public double? AttnLogitSoftcapping { get; private init; }
    ...
    public static HuggingFaceConfig Parse(string json)
    {
        ...
        return new HuggingFaceConfig
        {
            ...
            AttnLogitSoftcapping = OptionalDouble(root, "attn_logit_softcapping"),
