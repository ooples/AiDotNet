...
/// </summary>
/// <remarks>
/// <para>MAPE = (100/N) × Σ |y - ŷ| / |y|</para>
/// <para><b>For Beginners:</b> MAPE expresses error as a percentage:
/// <list type="bullet">
/// <item>Intuitive interpretation (e.g., "10% average error")</item>
/// <item>Scale-independent</item>
/// <item>Warning: undefined when actual values are zero</item>
/// <item>Asymmetric: penalizes over-predictions less than under-predictions</item>
/// </list>
/// </para>
/// </remarks>
public class MeanAbsolutePercentageErrorMetric<T> : IRegressionMetric<T>
{
    private static readonly INumericOperations<T> NumOps = MathHelper.GetNumericOperations<T>();
    private readonly double _epsilon;

    public MeanAbsolutePercentageErrorMetric(double epsilon = 1e-10)
    {
        _epsilon = epsilon;
    }

    public string Name => "MAPE_Safe";
    public string Category => "Regression";
    public string Description => "Mean Absolute Percentage Error with safe zero handling.";
    ...
    public T Compute(ReadOnlySpan<T> predictions, ReadOnlySpan<T> actuals)
    {
        ...
        for (int i = 0; i < predictions.Length; i++)
        {
            ...
            double denominator = Math.Max(Math.Abs(actual), _epsilon);
