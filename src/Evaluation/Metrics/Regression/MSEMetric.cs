...
/// </summary>
/// <remarks>
/// <para>MSE = (1/N) * Σ(y_i - ŷ_i)²</para>
/// <para><b>For Beginners:</b> MSE penalizes large errors more heavily than small ones due to squaring.
/// Good for optimizing models (differentiable), but harder to interpret than MAE.</para>
/// </remarks>
public class MSEMetric<T> : IRegressionMetric<T>
{
    private static readonly INumericOperations<T> NumOps = MathHelper.GetNumericOperations<T>();

    public string Name => "MSE";
    public string Category => "Regression";
    public string Description => "Mean Squared Error - penalizes large errors heavily.";
