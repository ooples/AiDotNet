...
/// </summary>
/// <remarks>
/// <para>BER = (FNR + FPR) / 2 = 1 - Balanced Accuracy</para>
/// <para><b>For Beginners:</b> Balanced Error Rate:
/// <list type="bullet">
/// <item>Equal weight to errors in both classes</item>
/// <item>Better for imbalanced datasets than standard error rate</item>
/// <item>Range: 0 to 1, lower is better</item>
/// <item>0 = perfect classifier, 0.5 = random classifier</item>
/// </list>
/// </para>
/// </remarks>
public class BalancedErrorRateMetric<T> : IClassificationMetric<T>
{
    private static readonly INumericOperations<T> NumOps = MathHelper.GetNumericOperations<T>();

    public string Name => "BalancedErrorRate";
    public string Category => "Classification";
    public string Description => "Balanced Error Rate (average of FNR and FPR).";
    ...
    public T Compute(ReadOnlySpan<T> predictions, ReadOnlySpan<T> actuals)
    {
        ...
        if (predictions.Length == 0) return NumOps.FromDouble(0.5);
        ...
        return NumOps.FromDouble((fnr + fpr) / 2);
    }
