...
/// </summary>
/// <remarks>
/// <para>FNR = FN / (FN + TP) = 1 - Recall = 1 - TPR</para>
/// <para><b>For Beginners:</b> FNR answers: "Of all actual positives, how many did we miss?"
/// <list type="bullet">
/// <item>FNR = 0: Perfect - caught all positives</item>
/// <item>FNR = 0.2: Missed 20% of actual positives</item>
/// <item>FNR = 1: Missed all positives</item>
/// </list>
/// Critical in medical diagnostics (low FNR = fewer missed diseases) and fraud detection
/// (low FNR = fewer missed fraudulent transactions).</para>
/// </remarks>
public class FalseNegativeRateMetric<T> : IClassificationMetric<T>
{
    private static readonly INumericOperations<T> NumOps = MathHelper.GetNumericOperations<T>();
    private readonly T _positiveLabel;

    public string Name => "FNR";
    public string Category => "Classification";
    public string Description => "False Negative Rate (1 - Recall).";
    ...
    public FalseNegativeRateMetric()
    {
        _positiveLabel = NumOps.One;
    }

    public FalseNegativeRateMetric(T positiveLabel)
    {
    ...
    public T Compute(ReadOnlySpan<T> predictions, ReadOnlySpan<T> actuals)
    {
        ...
        int denominator = fn + tp;
        return denominator == 0 ? NumOps.Zero : NumOps.FromDouble((double)fn / denominator);
    }
