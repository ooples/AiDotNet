...
/// </summary>
/// <remarks>
/// <para>Zero-One Loss = (1/N) * Σ(prediction ≠ actual)</para>
/// <para><b>For Beginners:</b> Zero-one loss simply counts the proportion of wrong predictions.
/// It's exactly 1 - Accuracy. Unlike other loss functions, it treats all misclassifications equally
/// regardless of how confident the wrong prediction was.</para>
/// </remarks>
public class ZeroOneLossMetric<T> : IClassificationMetric<T>
{
    private static readonly INumericOperations<T> NumOps = MathHelper.GetNumericOperations<T>();

    public string Name => "ZeroOneLoss";
    public string Category => "Classification";
    public string Description => "Fraction of misclassifications (1 - accuracy).";
