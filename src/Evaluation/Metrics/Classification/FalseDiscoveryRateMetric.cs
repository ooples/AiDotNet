...
/// </summary>
/// <remarks>
/// <para>FDR = FP / (FP + TP) = 1 - Precision = 1 - PPV</para>
/// <para><b>For Beginners:</b> FDR answers: "Of all positive predictions, how many were wrong?"
/// <list type="bullet">
/// <item>Range: 0 to 1, lower is better</item>
/// <item>0 = no false positives among positive predictions</item>
/// <item>Important in scientific testing (controlling false discoveries)</item>
/// </list>
/// </para>
/// </remarks>
public class FalseDiscoveryRateMetric<T> : IClassificationMetric<T>
{
    private static readonly INumericOperations<T> NumOps = MathHelper.GetNumericOperations<T>();
    private readonly T _positiveLabel;

    public string Name => "FalseDiscoveryRate";
    public string Category => "Classification";
    public string Description => "False Discovery Rate (1 - Precision).";
    ...
    public T Compute(ReadOnlySpan<T> predictions, ReadOnlySpan<T> actuals)
    {
        ...
        for (int i = 0; i < predictions.Length; i++)
        {
            ...
            {
                if (isActualPositive) tp++;
                else fp++;
            }
        }

        int positives = tp + fp;
        return positives > 0 ? NumOps.FromDouble((double)fp / positives) : NumOps.Zero;
    }
