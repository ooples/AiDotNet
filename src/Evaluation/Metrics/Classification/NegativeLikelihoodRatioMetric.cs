...
/// </summary>
/// <remarks>
/// <para>LR- = (1 - Sensitivity) / Specificity = FNR / TNR</para>
/// <para><b>For Beginners:</b> Negative Likelihood Ratio:
/// <list type="bullet">
/// <item>How much less likely a negative test is in disease vs healthy</item>
/// <item>LR- &lt; 0.1: Strong evidence against disease</item>
/// <item>LR- 0.1-0.2: Moderate evidence</item>
/// <item>LR- 0.2-0.5: Weak evidence</item>
/// <item>LR- = 1: No diagnostic value</item>
/// </list>
/// </para>
/// <para><b>Clinical use:</b> Multiply pre-test odds by LR- to get post-test odds after negative result.</para>
/// </remarks>
public class NegativeLikelihoodRatioMetric<T> : IClassificationMetric<T>
{
    private static readonly INumericOperations<T> NumOps = MathHelper.GetNumericOperations<T>();

    public string Name => "LR-";
    public string Category => "Classification";
    public string Description => "Negative Likelihood Ratio ((1 - Sensitivity) / Specificity).";
