...
/// where n is the sample index, N is the window size, I₀ is the modified Bessel function of the first kind
/// of order zero, and β (beta) is a parameter that controls the trade-off between the main lobe width
...
public class KaiserWindow<T> : IWindowFunction<T>
{
    ...
    /// - β = 2.0: provides about -46 dB side lobe suppression
    /// - β = 4.0: provides about -75 dB side lobe suppression
    /// - β = 6.0: provides about -90 dB side lobe suppression
    /// 
