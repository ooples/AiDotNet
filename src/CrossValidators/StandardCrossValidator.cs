...
/// </para>
/// </remarks>
public class StandardCrossValidator<T> : CrossValidatorBase<T>
{
    /// <summary>
    ...
    /// <summary>
    /// Performs the cross-validation process on the given model using the provided data.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    private IEnumerable<(int[] trainIndices, int[] testIndices)> CreateFolds(Matrix<T> X, Vector<T> y)
    {
