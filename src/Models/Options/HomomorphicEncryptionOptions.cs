...
public class HomomorphicEncryptionOptions
{
    ...
    /// <summary>
    /// Gets or sets the HE scheme name.
    /// </summary>
    /// <remarks>
    /// Supported built-ins:
    /// - "CKKS" (approximate real numbers)
    /// - "BFV" (exact integers via fixed-point encoding)
    /// </remarks>
    public string Scheme { get; set; } = "CKKS";
    ...
    /// </remarks>
    public string Mode { get; set; } = "HEOnly";

    /// <summary>
    /// Gets or sets which parameter ranges are encrypted when <see cref="Mode"/> is "Hybrid".
    /// </summary>
