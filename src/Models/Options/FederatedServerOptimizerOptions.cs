...
/// If <see cref="Optimizer"/> is "None", the server uses the aggregated parameters directly (FedAvg-style).
/// </remarks>
public class FederatedServerOptimizerOptions
{
    /// <summary>
    /// Gets or sets the optimizer name.
    /// </summary>
    /// <remarks>
    ...
    /// - "FedYogi"
    /// </remarks>
    public string Optimizer { get; set; } = "None";
