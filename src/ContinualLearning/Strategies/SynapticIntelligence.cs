...
public class SynapticIntelligence<T, TInput, TOutput> : ContinualLearningStrategyBase<T, TInput, TOutput>
{
    ...
    {
        var paramCount = ((IParameterizable<T, TInput, TOutput>)model).ParameterCount;
        ...
        _taskStartParameters = CloneVector(((IParameterizable<T, TInput, TOutput>)model).GetParameters());
