...
public class VARLiNGAMAlgorithm<T> : FunctionalBase<T>
{
    ...
    protected override Matrix<T> DiscoverStructureCore(Matrix<T> data)
    {
        ...
        // Step 1: Fit VAR model to get residuals
        var residuals = FitVARAndGetResiduals(X, n, d, _maxLag);
        ...
        return B0Graph.AdjacencyMatrix;
    }

    private double[,] FitVARAndGetResiduals(double[,] X, int n, int d, int maxLag)
    {
