...
/// <summary>
/// FuseFormer fusing fine-grained information for video inpainting with transformers.
/// </summary>
...
/// </list></para>
/// <para>
/// FuseFormer fuses fine-grained multi-scale information within the transformer architecture for detailed and coherent video inpainting.
/// </para>
/// </remarks>
public class FuseFormer<T> : VideoInpaintingBase<T>
{
    ...
    /// <summary>
    /// Creates a new FuseFormer model for native training and inference.
    /// </summary>
    ...
    {
        return new FuseFormer<T>(Architecture, _numFeatures, _numLayers);
    }
}
