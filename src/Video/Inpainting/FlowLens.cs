...
/// <summary>
/// FlowLens flow-guided video inpainting with optical flow completion.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "FlowLens: Seeing Beyond the FoV with Synthetically Trained Flow Completion" (Xu et al., ECCV 2022)</item>
/// </list></para>
/// <para>
/// FlowLens uses optical flow completion as a guide for video inpainting, first completing the flow field then using it to propagate content.
/// </para>
/// </remarks>
public class FlowLens<T> : VideoInpaintingBase<T>
{
    ...
    /// <summary>
    /// Creates a new FlowLens model for native training and inference.
    /// </summary>
    ...
    {
        return new FlowLens<T>(Architecture, _numFeatures, _numLayers);
    }
}
