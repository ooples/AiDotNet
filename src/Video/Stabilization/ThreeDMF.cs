...
/// <summary>
/// 3DMF 3D multi-frame fusion for video stabilization.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "3DMF: 3D Multi-Frame Fusion for Video Stabilization" (SIGGRAPH 2025)</item>
/// </list></para>
/// <para>
/// 3DMF fuses information across multiple frames using 3D geometry-aware processing for robust video stabilization.
/// </para>
/// </remarks>
public class ThreeDMF<T> : VideoStabilizationBase<T>
{
    ...
    /// <summary>
    /// Creates a new ThreeDMF model for native training and inference.
    /// </summary>
    ...
    {
        return new ThreeDMF<T>(Architecture, _numFeatures, _numLayers);
    }
}
