...
/// <summary>
/// StabStitch joint online video stitching and stabilization in an unsupervised framework.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "StabStitch: Joint Online Video Stitching and Stabilization" (2024)</item>
/// </list></para>
/// <para>
/// StabStitch jointly performs video stitching and stabilization in a single unsupervised end-to-end framework for panoramic video applications.
/// </para>
/// </remarks>
public class StabStitch<T> : VideoStabilizationBase<T>
{
    ...
    /// <summary>
    /// Creates a new StabStitch model for native training and inference.
    /// </summary>
    ...
    {
        return new StabStitch<T>(Architecture, _numFeatures, _numLayers);
    }
}
