...
/// <summary>
/// DUT deep unsupervised video stabilization learned from watching unstable videos.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "DUT: Deep Unsupervised Video Stabilization" (Cheng et al., 2022)</item>
/// </list></para>
/// <para>
/// DUT learns video stabilization in a fully unsupervised manner by simply watching unstable video footage without any paired stable ground truth.
/// </para>
/// </remarks>
public class DUT<T> : VideoStabilizationBase<T>
{
    ...
    /// <summary>
    /// Creates a new DUT model for native training and inference.
    /// </summary>
    ...
    {
        return new DUT<T>(Architecture, _numFeatures, _numLayers);
    }
}
