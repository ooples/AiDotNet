...
public class FlashVSROptions : NeuralNetworkOptions
{
    ...
    public FlashVSROptions(FlashVSROptions other)
    {
        if (other == null)
        ...
        NumLCSABlocks = other.NumLCSABlocks;
        WindowSize = other.WindowSize;
        NumHeads = other.NumHeads;
        ScaleFactor = other.ScaleFactor;
        NumInputFrames = other.NumInputFrames;
        NumDecoderBlocks = other.NumDecoderBlocks;
        FeedForwardExpansion = other.FeedForwardExpansion;
        ModelPath = other.ModelPath;
        OnnxOptions = other.OnnxOptions;
        LearningRate = other.LearningRate;
        DropoutRate = other.DropoutRate;
        WarmupSteps = other.WarmupSteps;
        DistillationWeight = other.DistillationWeight;
    }
