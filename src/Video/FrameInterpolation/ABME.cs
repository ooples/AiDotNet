...
/// <summary>
/// ABME asymmetric bilateral motion estimation for frame interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "Asymmetric Bilateral Motion Estimation for Video Frame Interpolation" (Park et al., ICCV 2021)</item>
/// </list></para>
/// <para>
/// ABME uses asymmetric bilateral motion estimation that models motion from both temporal directions with different confidence levels.
/// </para>
/// </remarks>
public class ABME<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new ABME model for native training and inference.
    /// </summary>
    ...
    {
        return new ABME<T>(Architecture, _numFeatures, _numLayers);
    }
}
