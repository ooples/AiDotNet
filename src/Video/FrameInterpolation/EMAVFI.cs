...
/// <summary>
/// EMA-VFI swin-based cross-attention for motion dynamics in frame interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "EMA-VFI: Extracting Motion and Appearance via Inter-Frame Attention for Video Frame Interpolation" (Zhang et al., 2023)</item>
/// </list></para>
/// <para>
/// EMA-VFI uses swin-based cross-attention to extract both motion dynamics and local appearance information for high-quality frame interpolation.
/// </para>
/// </remarks>
public class EMAVFI<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new EMAVFI model for native training and inference.
    /// </summary>
    ...
    {
        return new EMAVFI<T>(Architecture, _numFeatures, _numLayers);
    }
}
