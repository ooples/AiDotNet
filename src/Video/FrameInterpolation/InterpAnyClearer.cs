...
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "Clearer Frames, Anytime: Resolving Velocity Ambiguity in VFI" (Zheng et al., ECCV 2024 Oral)</item>
/// </list></para>
/// <para>
/// InterpAnyClearer is a plug-in module that resolves velocity ambiguity in existing VFI models for clearer interpolation at any timestep.
/// </para>
/// </remarks>
public class InterpAnyClearer<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new InterpAnyClearer model for native training and inference.
    /// </summary>
    ...
    public InterpAnyClearer(
        NeuralNetworkArchitecture<T> architecture,
        int numFeatures = 64,
        int numLayers = 8,
        InterpAnyClearerOptions? options = null)
    ...
    {
        return new InterpAnyClearer<T>(Architecture, _numFeatures, _numLayers);
    }
}
