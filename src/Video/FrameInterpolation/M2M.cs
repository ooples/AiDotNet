...
/// <summary>
/// M2M many-to-many splatting with multiple bidirectional flows.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "Many-to-many Splatting for Efficient Video Frame Interpolation" (Hu et al., CVPR 2022)</item>
/// </list></para>
/// <para>
/// M2M uses many-to-many splatting with multiple bidirectional optical flows for efficient multi-frame interpolation.
/// </para>
/// </remarks>
public class M2M<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new M2M model for native training and inference.
    /// </summary>
    ...
    {
        return new M2M<T>(Architecture, _numFeatures, _numLayers);
    }
}
