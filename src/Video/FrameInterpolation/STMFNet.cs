...
/// <summary>
/// STMFNet spatio-temporal multi-flow network with multiple intermediate flow fields.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "STMFNet: Spatio-Temporal Multi-Flow Network for Frame Interpolation" (Danier et al., CVPR 2022)</item>
/// </list></para>
/// <para>
/// STMFNet estimates multiple intermediate flow fields at different spatial-temporal locations for more accurate frame interpolation.
/// </para>
/// </remarks>
public class STMFNet<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new STMFNet model for native training and inference.
    /// </summary>
    ...
    {
        return new STMFNet<T>(Architecture, _numFeatures, _numLayers);
    }
}
