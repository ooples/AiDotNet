...
/// <summary>
/// AMT all-pairs multi-field transforms for frame interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "AMT: All-Pairs Multi-Field Transforms for Efficient Frame Interpolation" (Li et al., CVPR 2023)</item>
/// </list></para>
/// <para>
/// AMT uses correlation-based all-pairs motion prediction with multi-field transforms to efficiently estimate intermediate frame content.
/// </para>
/// </remarks>
public class AMT<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new AMT model for native training and inference.
    /// </summary>
    ...
    {
        return new AMT<T>(Architecture, _numFeatures, _numLayers);
    }
}
