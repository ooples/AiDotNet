...
/// <summary>
/// DRVI disentangled representations for video interpolation with content-motion separation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "DRVI: Disentangled Representations for Video Interpolation" (2024)</item>
/// </list></para>
/// <para>
/// DRVI disentangles content and motion representations, processing them separately for more accurate frame interpolation.
/// </para>
/// </remarks>
public class DRVI<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new DRVI model for native training and inference.
    /// </summary>
    ...
    {
        return new DRVI<T>(Architecture, _numFeatures, _numLayers);
    }
}
