...
/// <summary>
/// TDPNet temporal-distance-aware pyramid network for multi-frame interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "TDPNet: Temporal-Distance-Aware Pyramid Network for Multi-Frame Interpolation" (2023)</item>
/// </list></para>
/// <para>
/// TDPNet uses temporal-distance-aware processing in a pyramid architecture to generate multiple intermediate frames with consistent quality.
/// </para>
/// </remarks>
public class TDPNet<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new TDPNet model for native training and inference.
    /// </summary>
    ...
    {
        return new TDPNet<T>(Architecture, _numFeatures, _numLayers);
    }
}
