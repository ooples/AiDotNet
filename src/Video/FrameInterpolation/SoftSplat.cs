...
/// <summary>
/// SoftSplat softmax splatting with differentiable forward warping.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "Softmax Splatting for Video Frame Interpolation" (Niklaus and Liu, CVPR 2020)</item>
/// </list></para>
/// <para>
/// SoftSplat introduces softmax splatting for differentiable forward warping with importance-weighted aggregation, solving the overlap problem in frame synthesis.
/// </para>
/// </remarks>
public class SoftSplat<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new SoftSplat model for native training and inference.
    /// </summary>
    ...
    {
        return new SoftSplat<T>(Architecture, _numFeatures, _numLayers);
    }
}
