...
/// <summary>
/// XVFI complementary flow reversal for extreme frame interpolation at 4K 60fps.
/// </summary>
...
/// </list></para>
/// <para>
/// XVFI handles extreme frame interpolation (4K, 60fps) through complementary flow reversal and multi-scale architecture.
/// </para>
/// </remarks>
public class XVFI<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new XVFI model for native training and inference.
    /// </summary>
    ...
    {
        return new XVFI<T>(Architecture, _numFeatures, _numLayers);
    }
}
