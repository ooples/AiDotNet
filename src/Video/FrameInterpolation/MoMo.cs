...
/// <summary>
/// MoMo first diffusion model for bi-directional optical flow in frame interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "MoMo: Momentum Diffusion Model for Bi-Directional Flow" (2024)</item>
/// </list></para>
/// <para>
/// MoMo is the first diffusion model specifically designed for bi-directional optical flow estimation in the context of frame interpolation.
/// </para>
/// </remarks>
public class MoMo<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new MoMo model for native training and inference.
    /// </summary>
    ...
    {
        return new MoMo<T>(Architecture, _numFeatures, _numLayers);
    }
}
