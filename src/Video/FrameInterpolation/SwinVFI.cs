...
/// <summary>
/// SwinVFI swin transformer with shifted window attention for frame interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "SwinVFI: Swin Transformer for Video Frame Interpolation" (2022)</item>
/// </list></para>
/// <para>
/// SwinVFI adapts the Swin Transformer architecture with shifted window attention for efficient spatial-temporal feature extraction in frame interpolation.
/// </para>
/// </remarks>
public class SwinVFI<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new SwinVFI model for native training and inference.
    /// </summary>
    ...
    {
        return new SwinVFI<T>(Architecture, _numFeatures, _numLayers);
    }
}
