...
/// <summary>
/// IFRNet coarse-to-fine flow refinement with intermediate feature refinement.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "IFRNet: Intermediate Feature Refine Network for Efficient Frame Interpolation" (Kong et al., CVPR 2022)</item>
/// </list></para>
/// <para>
/// IFRNet uses a coarse-to-fine flow refinement strategy with intermediate feature refinement for efficient and accurate frame interpolation.
/// </para>
/// </remarks>
public class IFRNet<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new IFRNet model for native training and inference.
    /// </summary>
    ...
    {
        return new IFRNet<T>(Architecture, _numFeatures, _numLayers);
    }
}
