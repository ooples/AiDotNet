...
/// <summary>
/// GIMM-VFI generalizable implicit motion modeling with continuous-time representation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "GIMM-VFI: Generalizable Implicit Motion Modeling for Video Frame Interpolation" (NeurIPS 2024)</item>
/// </list></para>
/// <para>
/// GIMM-VFI uses implicit neural representations for continuous-time motion modeling, enabling arbitrary timestep interpolation without retraining.
/// </para>
/// </remarks>
public class GIMMVFI<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new GIMMVFI model for native training and inference.
    /// </summary>
    ...
    {
        return new GIMMVFI<T>(Architecture, _numFeatures, _numLayers);
    }
}
