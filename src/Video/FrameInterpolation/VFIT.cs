...
/// <summary>
/// VFIT video frame interpolation transformer with spatial-temporal tokens.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "VFIT: Video Frame Interpolation Transformer" (Shi et al., CVPR 2022)</item>
/// </list></para>
/// <para>
/// VFIT uses spatial-temporal token processing in a transformer architecture for direct frame synthesis without explicit flow estimation.
/// </para>
/// </remarks>
public class VFIT<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new VFIT model for native training and inference.
    /// </summary>
    ...
    {
        return new VFIT<T>(Architecture, _numFeatures, _numLayers);
    }
}
