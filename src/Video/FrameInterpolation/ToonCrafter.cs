...
/// <summary>
/// ToonCrafter cartoon and animation interpolation for large non-linear motion.
/// </summary>
...
/// </list></para>
/// <para>
/// ToonCrafter specializes in cartoon and animation frame interpolation where motions are large, non-linear, and don't follow physical constraints.
/// </para>
/// </remarks>
public class ToonCrafter<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new ToonCrafter model for native training and inference.
    /// </summary>
    ...
    {
        return new ToonCrafter<T>(Architecture, _numFeatures, _numLayers);
    }
}
