...
/// <summary>
/// PerVFI perception-oriented asymmetric blending for frame interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "PerVFI: Perception-Oriented Video Frame Interpolation via Asymmetric Blending" (CVPR 2024)</item>
/// </list></para>
/// <para>
/// PerVFI focuses on perceptual quality through asymmetric blending that preserves visual sharpness and structural integrity.
/// </para>
/// </remarks>
public class PerVFI<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new PerVFI model for native training and inference.
    /// </summary>
    ...
    {
        return new PerVFI<T>(Architecture, _numFeatures, _numLayers);
    }
}
