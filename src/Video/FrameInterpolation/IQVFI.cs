...
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "IQ-VFI: Image Quality-Aware Video Frame Interpolation" (2024)</item>
/// </list></para>
/// <para>
/// IQ-VFI adapts its interpolation strategy based on input image quality, handling degraded inputs more robustly than quality-agnostic methods.
/// </para>
/// </remarks>
public class IQVFI<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new IQVFI model for native training and inference.
    /// </summary>
    ...
    {
        return new IQVFI<T>(Architecture, _numFeatures, _numLayers);
    }
}
