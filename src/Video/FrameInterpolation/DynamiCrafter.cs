...
/// <summary>
/// DynamiCrafter first and last frame conditioned video diffusion for interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "DynamiCrafter: Animating Open-domain Images with Video Diffusion Priors" (2024)</item>
/// </list></para>
/// <para>
/// DynamiCrafter uses video diffusion priors conditioned on first and last frames to generate temporally coherent intermediate frames.
/// </para>
/// </remarks>
public class DynamiCrafter<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new DynamiCrafter model for native training and inference.
    /// </summary>
    ...
    public DynamiCrafter(
        NeuralNetworkArchitecture<T> architecture,
        int numFeatures = 64,
        int numLayers = 8,
        DynamiCrafterOptions? options = null)
    ...
    {
        return new DynamiCrafter<T>(Architecture, _numFeatures, _numLayers);
    }
}
