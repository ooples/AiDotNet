...
public class BiMVFI<T> : FrameInterpolationBase<T>
{
    ...
    protected override void SerializeNetworkSpecificData(BinaryWriter w)
    {
        ...
        w.Write(_options.OcclusionAwareBlending);
        w.Write(_options.ConfidenceThreshold);
    ...
    protected override void DeserializeNetworkSpecificData(BinaryReader r)
    {
        ...
        _options.OcclusionAwareBlending = r.ReadBoolean();
        _options.ConfidenceThreshold = r.ReadDouble();
