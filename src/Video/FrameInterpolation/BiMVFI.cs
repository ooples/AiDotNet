...
/// <summary>
/// BiMVFI bidirectional motion for non-uniform motion and large displacements.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "BiMVFI: Bidirectional Motion Field-Based Video Frame Interpolation" (Seo et al., CVPR 2025)</item>
/// </list></para>
/// <para>
/// BiMVFI handles non-uniform motion and large displacements through bidirectional motion estimation with adaptive blending.
/// </para>
/// </remarks>
public class BiMVFI<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new BiMVFI model for native training and inference.
    /// </summary>
    ...
    {
        return new BiMVFI<T>(Architecture, _numFeatures, _numLayers);
    }
}
