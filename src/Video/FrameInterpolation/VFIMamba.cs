...
/// <summary>
/// VFIMamba first Mamba-based architecture for video frame interpolation.
/// </summary>
...
/// </list></para>
/// <para>
/// VFIMamba is the first to apply Mamba (structured state space models) to frame interpolation, using a Mixed-SSM block for lower memory than transformers.
/// </para>
/// </remarks>
public class VFIMamba<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new VFIMamba model for native training and inference.
    /// </summary>
    ...
    {
        return new VFIMamba<T>(Architecture, _numFeatures, _numLayers);
    }
}
