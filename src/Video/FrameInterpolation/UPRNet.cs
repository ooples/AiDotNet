...
/// <summary>
/// UPRNet unified pyramid recurrent network for lightweight frame interpolation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "A Unified Pyramid Recurrent Network for Video Frame Interpolation" (Samsung Research, 2022)</item>
/// </list></para>
/// <para>
/// UPRNet uses a unified pyramid recurrent architecture for lightweight yet accurate frame interpolation across multiple scales.
/// </para>
/// </remarks>
public class UPRNet<T> : FrameInterpolationBase<T>
{
    ...
    /// <summary>
    /// Creates a new UPRNet model for native training and inference.
    /// </summary>
    ...
    {
        return new UPRNet<T>(Architecture, _numFeatures, _numLayers);
    }
}
