...
/// <summary>
/// VideoGigaGAN first large-scale GAN for video super-resolution with temporal consistency.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "VideoGigaGAN: Towards Detail-rich Video Super-Resolution" (Xu et al., CVPR 2025)</item>
/// </list></para>
/// <para>
/// VideoGigaGAN is the first large-scale GAN for video SR, using feature propagation with anti-aliasing and a high-frequency shuttle mechanism for detail-rich 8x upscaling.
/// </para>
/// </remarks>
public class VideoGigaGAN<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new VideoGigaGAN model for native training and inference.
    /// </summary>
    ...
    public VideoGigaGAN(
        ...
        int numFeatures = 64,
        int numLayers = 8,
        VideoGigaGANOptions? options = null)
    ...
    {
        return new VideoGigaGAN<T>(Architecture, _numFeatures, _numLayers);
    }
}
