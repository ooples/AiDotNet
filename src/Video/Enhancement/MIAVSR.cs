...
/// <summary>
/// MIA-VSR masked inter and intra-frame attention for efficient video SR.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "MIA-VSR: Masked Inter and Intra-Frame Attention for Video Super-Resolution" (Zhou et al., CVPR 2024)</item>
/// </list></para>
/// <para>
/// MIA-VSR uses masked attention patterns to efficiently model both inter-frame (temporal) and intra-frame (spatial) dependencies for video SR.
/// </para>
/// </remarks>
public class MIAVSR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new MIAVSR model for native training and inference.
    /// </summary>
    ...
    {
        return new MIAVSR<T>(Architecture, _numFeatures, _numLayers);
    }
}
