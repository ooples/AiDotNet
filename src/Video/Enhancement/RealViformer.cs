...
/// <summary>
/// RealViformer video informer architecture for real-world video super-resolution.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "RealViformer: Investigating Attention for Real-World Video Super-Resolution" (Zhang and Yao, ECCV 2024)</item>
/// </list></para>
/// <para>
/// RealViformer adapts the informer architecture with channel attention specifically designed for real-world degradations in video SR.
/// </para>
/// </remarks>
public class RealViformer<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new RealViformer model for native training and inference.
    /// </summary>
    ...
    public RealViformer(
        ...
        int numFeatures = 64,
        int numLayers = 8,
        RealViformerOptions? options = null)
    ...
    {
        return new RealViformer<T>(Architecture, _numFeatures, _numLayers);
    }
}
