...
/// <summary>
/// RealBasicVSR-Sharp enhanced variant with improved texture recovery.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "RealBasicVSR: Investigating Tradeoffs in Real-World Video Super-Resolution" (Chan et al., 2022)</item>
/// </list></para>
/// <para>
/// RealBasicVSR-Sharp is a sharpened variant that uses additional texture recovery modules for enhanced detail in real-world video SR.
/// </para>
/// </remarks>
public class RealBasicVSRSharp<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new RealBasicVSRSharp model for native training and inference.
    /// </summary>
    ...
    public RealBasicVSRSharp(
        NeuralNetworkArchitecture<T> architecture,
        int numFeatures = 64,
        int numLayers = 8,
        RealBasicVSRSharpOptions? options = null)
    ...
    {
        return new RealBasicVSRSharp<T>(Architecture, _numFeatures, _numLayers);
    }
}
