...
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "Stream-DiffVSR: Low-Latency Streamable Diffusion-based Video Super-Resolution" (Li et al., 2025)</item>
/// </list></para>
/// <para>
/// Stream-DiffVSR uses auto-regressive temporal guidance and a 4-step distilled denoiser for low-latency online video SR with temporal consistency.
/// </para>
/// </remarks>
public class StreamDiffVSR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new StreamDiffVSR model for native training and inference.
    /// </summary>
    ...
    public StreamDiffVSR(
        NeuralNetworkArchitecture<T> architecture,
        int numFeatures = 64,
        int numLayers = 8,
        StreamDiffVSROptions? options = null)
    ...
    {
        return new StreamDiffVSR<T>(Architecture, _numFeatures, _numLayers);
    }
}
