...
/// <summary>
/// SeedVR generic video restoration using seeding infinity in diffusion transformers.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "SeedVR: Seeding Infinity in Diffusion Transformer Towards Generic Video Restoration" (Wang et al., 2025)</item>
/// </list></para>
/// <para>
/// SeedVR leverages text-to-video diffusion priors through a diffusion transformer architecture for versatile video restoration including SR, denoising, and deblurring.
/// </para>
/// </remarks>
public class SeedVR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new SeedVR model for native training and inference.
    /// </summary>
    ...
    {
        return new SeedVR<T>(Architecture, _numFeatures, _numLayers);
    }
}
