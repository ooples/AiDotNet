...
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "RVRT: Recurrent Video Restoration Transformer" (Liang et al., NeurIPS 2022)</item>
/// </list></para>
/// <para>
/// RVRT combines recurrent processing with video restoration transformers, using guided deformable attention for efficient long-range temporal modeling.
/// </para>
/// </remarks>
public class RVRT<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new RVRT model for native training and inference.
    /// </summary>
    ...
    {
        return new RVRT<T>(Architecture, _numFeatures, _numLayers);
    }
}
