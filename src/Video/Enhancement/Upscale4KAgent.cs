...
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "Upscale4KAgent: Agentic Multi-Model Pipeline for 4K Video Upscaling" (2025)</item>
/// </list></para>
/// <para>
/// Upscale4KAgent orchestrates multiple specialized models in an agentic pipeline to upscale video of arbitrary resolution to 4K quality.
/// </para>
/// </remarks>
public class Upscale4KAgent<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new Upscale4KAgent model for native training and inference.
    /// </summary>
    ...
    public Upscale4KAgent(
        NeuralNetworkArchitecture<T> architecture,
        int numFeatures = 64,
        int numLayers = 8,
        Upscale4KAgentOptions? options = null)
    ...
    {
        return new Upscale4KAgent<T>(Architecture, _numFeatures, _numLayers);
    }
}
