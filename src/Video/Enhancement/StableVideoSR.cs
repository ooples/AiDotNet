...
/// <summary>
/// Stable Diffusion backbone with temporal conditioning for video super-resolution.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "StableVideoSR: Video Super-Resolution via Stable Diffusion with Temporal Conditioning" (2024)</item>
/// </list></para>
/// <para>
/// StableVideoSR adapts the Stable Diffusion architecture for video SR by adding temporal conditioning modules that maintain frame-to-frame consistency.
/// </para>
/// </remarks>
public class StableVideoSR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new StableVideoSR model for native training and inference.
    /// </summary>
    ...
    public StableVideoSR(
        NeuralNetworkArchitecture<T> architecture,
        int numFeatures = 64,
        int numLayers = 8,
        StableVideoSROptions? options = null)
    ...
    {
        return new StableVideoSR<T>(Architecture, _numFeatures, _numLayers);
    }
}
