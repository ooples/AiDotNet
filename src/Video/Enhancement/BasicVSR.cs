...
/// </list></para>
/// <para>
/// BasicVSR establishes the essential components for video SR: bidirectional recurrent propagation with optical flow alignment. This serves as the foundation for BasicVSR++ and IconVSR.
/// </para>
/// </remarks>
public class BasicVSR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new BasicVSR model for native training and inference.
    /// </summary>
    ...
    {
        return new BasicVSR<T>(Architecture, _numFeatures, _numLayers);
    }
}
