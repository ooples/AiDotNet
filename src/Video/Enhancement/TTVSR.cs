...
/// <summary>
/// TTVSR trajectory-aware transformer for long-range temporal modeling in video SR.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "TTVSR: Learning Trajectory-Aware Transformer for Video Super-Resolution" (Liu et al., ECCV 2022)</item>
/// </list></para>
/// <para>
/// TTVSR learns trajectory-aware features that follow object motion paths across frames, enabling effective long-range temporal modeling for video SR.
/// </para>
/// </remarks>
public class TTVSR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new TTVSR model for native training and inference.
    /// </summary>
    ...
    {
        return new TTVSR<T>(Architecture, _numFeatures, _numLayers);
    }
}
