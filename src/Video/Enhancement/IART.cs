...
/// <summary>
/// IART implicit resampling-based alignment transformer for video SR.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "IART: Implicit Resampling-based Alignment Transformer for Video Super-Resolution" (Kai et al., CVPR 2024 Highlight)</item>
/// </list></para>
/// <para>
/// IART uses implicit neural resampling for sub-pixel accurate alignment of features across frames, preserving high-frequency details in video SR.
/// </para>
/// </remarks>
public class IART<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new IART model for native training and inference.
    /// </summary>
    ...
    {
        return new IART<T>(Architecture, _numFeatures, _numLayers);
    }
}
