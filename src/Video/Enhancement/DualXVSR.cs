...
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "DualX-VSR: Dual Axial Spatial-Temporal Transformer for Video Super-Resolution" (2025)</item>
/// </list></para>
/// <para>
/// DualX-VSR eliminates the need for explicit motion compensation by using dual axial attention that jointly models spatial and temporal dimensions.
/// </para>
/// </remarks>
public class DualXVSR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new DualXVSR model for native training and inference.
    /// </summary>
    ...
    {
        return new DualXVSR<T>(Architecture, _numFeatures, _numLayers);
    }
}
