...
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "RealisVSR: Detail-Enhanced Diffusion for Real-World 4K Video Super-Resolution" (2025)</item>
/// </list></para>
/// <para>
/// RealisVSR uses the Wan 2.1 backbone with detail-enhancement modules for coherent motion and realistic 4K upscaling of real-world video.
/// </para>
/// </remarks>
public class RealisVSR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new RealisVSR model for native training and inference.
    /// </summary>
    ...
    {
        return new RealisVSR<T>(Architecture, _numFeatures, _numLayers);
    }
}
