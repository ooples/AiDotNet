...
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "FlashVSR: Efficient Real-Time Video Super-Resolution via One-Step Diffusion" (Zhuang et al., 2025)</item>
/// </list></para>
/// <para>
/// FlashVSR achieves ~17 FPS streaming VSR through one-step diffusion with locality-constrained sparse attention and a tiny conditional decoder, enabling real-time 4x upscaling.
/// </para>
/// </remarks>
public class FlashVSR<T> : VideoSuperResolutionBase<T>
{
    ...
    /// <summary>
    /// Creates a new FlashVSR model for native training and inference.
    /// </summary>
    ...
    {
        return new FlashVSR<T>(Architecture, _numFeatures, _numLayers);
    }
}
