...
/// <summary>
/// ShiftNet shift-based temporal alignment without optical flow for efficient denoising.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "ShiftNet: Shift-Based Temporal Alignment for Video Denoising" (2023)</item>
/// </list></para>
/// <para>
/// ShiftNet replaces expensive optical flow computation with simple channel-wise shift operations for efficient temporal alignment in video denoising.
/// </para>
/// </remarks>
public class ShiftNet<T> : VideoDenoisingBase<T>
{
    ...
    /// <summary>
    /// Creates a new ShiftNet model for native training and inference.
    /// </summary>
    ...
    {
        return new ShiftNet<T>(Architecture, _numFeatures, _numLayers);
    }
}
