...
/// <summary>
/// FloRNN flow-guided recurrent network for long-range temporal video denoising.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet">
/// <item>Paper: "FloRNN: Flow-Guided Recurrent Network for Video Denoising" (2022)</item>
/// </list></para>
/// <para>
/// FloRNN uses optical flow guidance in a recurrent network to leverage long-range temporal information for effective video denoising.
/// </para>
/// </remarks>
public class FloRNN<T> : VideoDenoisingBase<T>
{
    ...
    /// <summary>
    /// Creates a new FloRNN model for native training and inference.
    /// </summary>
    ...
    {
        return new FloRNN<T>(Architecture, _numFeatures, _numLayers);
    }
}
