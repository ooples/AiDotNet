...
/// </list></para>
/// <para>
/// BSVD enables real-time video denoising through bidirectional streaming with efficient buffer management for temporal information.
/// </para>
/// </remarks>
public class BSVD<T> : VideoDenoisingBase<T>
{
    ...
    /// <summary>
    /// Creates a new BSVD model for native training and inference.
    /// </summary>
    ...
    {
        return new BSVD<T>(Architecture, _numFeatures, _numLayers);
    }
}
