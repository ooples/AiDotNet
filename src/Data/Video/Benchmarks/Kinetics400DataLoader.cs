...
public class Kinetics400DataLoader<T> : InputOutputDataLoaderBase<T, Tensor<T>, Tensor<T>>
{
    ...
    protected override (Tensor<T> Features, Tensor<T> Labels) ExtractBatch(int[] indices)
    {
        ...
        var newFeatShape = (int[])features.Shape._dims.Clone(); newFeatShape[0] = indices.Length;
        var newLabelShape = (int[])labels.Shape._dims.Clone(); newLabelShape[0] = indices.Length;
