...
public class ComplexOperations<T> : INumericOperations<Complex<T>>
{
    ...
    /// - The square root has magnitude √4 = 2 and angle -90/2 = -45 degrees
    /// - Converting back gives 2 × (cos(-45°) + i × sin(-45°)) = √2 - √2i
    /// 
    ...
    /// 
    /// For example:
    /// - The magnitude of 3 + 4i is √(3² + 4²) = √25 = 5
    /// - The magnitude of 1 + 2i is √(1² + 2²) = √5 ≈ 2.24
    ...
    /// 
    /// For example:
    /// - 1 + i has magnitude √2 ≈ 1.41
    /// - 2 + 2i has magnitude √8 ≈ 2.83
    ...
    /// 
    /// For example:
    /// - The absolute value of 3 + 4i is √(3² + 4²) = √25 = 5
    ...
    /// 
    /// For example:
    /// - e^(0 + πi) = e^0 × (cos(π) + i × sin(π)) = 1 × (-1 + 0i) = -1
    /// - This shows the famous equation: e^(πi) = -1
    /// 
    ...
    ///   - Real part = ln(√2) ≈ 0.347
    ///   - Imaginary part = π/4 ≈ 0.785
    ///   - So ln(1 + i) ≈ 0.347 + 0.785i
    /// 
    /// One interesting result: ln(-1) = πi
    /// 
    ...
    /// - 1 + 1i has magnitude √2 ≈ 1.414, which rounds to 1
    /// 
