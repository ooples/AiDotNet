...
public class ShortOperations : INumericOperations<short>
{
    ...
    /// </summary>
    public short FromFloat(float value) => (short)Math.Clamp((int)Math.Round(value), short.MinValue, short.MaxValue);
    ...
    /// </summary>
    public short FromHalf(Half value) => (short)Math.Clamp((int)Math.Round((float)value), short.MinValue, short.MaxValue);
#endif
