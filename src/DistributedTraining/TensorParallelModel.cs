...
public class TensorParallelModel<T, TInput, TOutput> : ShardedModelBase<T, TInput, TOutput>
{
    ...
    public override void Train(TInput input, TOutput expectedOutput)
    {
        ...
        ((IParameterizable<T, TInput, TOutput>)WrappedModel).SetParameters(originalParams);
        ...
        var gradVec = ((IGradientComputable<T, TInput, TOutput>)WrappedModel).ComputeGradients(input, expectedOutput);
        ...
        ((IGradientComputable<T, TInput, TOutput>)WrappedModel).ApplyGradients(gradVec, Config.LearningRate);
