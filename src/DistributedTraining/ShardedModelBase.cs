    ...
    IModelShape
{
    ...
    {
        // Read the wrapped source directly to avoid recursing through tensor-parallel
        // authoritative sources. Lazy materialization invalidates the earlier shard layout.
