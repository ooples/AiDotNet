...
/// <remarks>
/// <para>
/// For Beginners: Normalization is like converting different measurements to a common scale. 
...
public enum NormalizationMethod
{
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: This option means "don't change my data at all." Use this when your data 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: MinMax scaling takes your data and squeezes it to fit between 0 and 1. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Z-Score (also called standardization) centers your data around 0, with most values 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Decimal scaling moves the decimal point in your numbers until all values are between 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Log transformation is useful when your data has a few very large values that would 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Binning is like grouping people by age ranges (0-10, 11-20, 21-30, etc.) instead of 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Global Contrast Normalization is like adjusting the contrast on a photo to make 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: This is a two-step process: first, a log transformation compresses very large values 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Lp Norm scaling is like making sure the total "energy" of your data equals 1. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Mean-Variance normalization is similar to Z-Score but gives you more control. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Robust Scaling is designed to handle data with outliers (extreme values that don't 
