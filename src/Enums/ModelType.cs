...
/// <remarks>
/// <para>
/// For Beginners: This enum lists all the different AI models you can use in this library.
...
public enum ModelType
{
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Simple Regression is like drawing a straight line through your data points.
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Multiple Regression is like Simple Regression but with more factors.
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Multivariate Regression predicts several things at once. For example,
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Polynomial Regression uses curved lines instead of straight ones.
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Weighted Regression gives some data points more importance than others.
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Random Forest combines many decision trees (simple flowchart-like models)
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Decision Tree works like a flowchart of yes/no questions. For example,
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Gradient Boosting builds a series of models, where each new model focuses on
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: AdaBoost-R2 is a specialized version of boosting for predicting numeric values.
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Extremely Randomized Trees is similar to Random Forest but adds even more
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Quantile Regression Forests don't just predict a single value (like "this house
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Conditional Inference Tree is a type of decision tree that uses statistics to
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: M5 Model Tree combines decision trees with linear regression. Instead of making
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Non-Linear Regression captures complex relationships that can't be represented
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Support Vector Regression finds patterns by transforming your data into a different
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Kernel Ridge Regression is like Support Vector Regression but with a different
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Gaussian Process Regression doesn't just predict a value - it gives you a range
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Isotonic Regression finds a non-decreasing (always flat or going up) or non-increasing
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Quantile Regression predicts different percentiles of your data. Instead of just
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Radial Basis Function Regression uses special functions that respond strongly 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Locally Weighted Regression makes predictions by focusing more on data points 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Spline Regression connects data points with smooth curves rather than straight lines. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: K-Nearest Neighbors makes predictions by looking at the most similar examples 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Symbolic Regression tries to find an actual mathematical formula that explains 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Bayesian Regression starts with an initial guess about relationships in your data, 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Expression Tree represents mathematical formulas as tree structures that can be 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Vector models represent your data as points in space with multiple dimensions. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Genetic Algorithm Regression mimics evolution to find the best model. It starts 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Orthogonal Regression accounts for measurement errors in both your input and output 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Robust Regression is designed to handle outliers - unusual data points that don't 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Time Series Regression is specialized for data collected over time, like daily 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Generalized Additive Model Regression builds complex relationships by adding together 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Partial Least Squares Regression works well when your input variables are related 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Principal Component Regression first simplifies your data by identifying the most 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Stepwise Regression automatically chooses which input variables to include in your 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Poisson Regression is designed for predicting counts - like the number of customer 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Multinomial Logistic Regression predicts which category something belongs to when 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Logistic Regression predicts the probability of something being in a particular category. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Negative Binomial Regression is designed for counting events (like number of customer 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Neural Network Regression uses interconnected "neurons" organized in layers to learn 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Multilayer Perceptron Regression is a specific type of neural network with at least 
