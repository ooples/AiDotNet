...
/// <remarks>
/// <para>
/// For Beginners: This enum represents different ways to change the structure of an AI model.
...
public enum ModificationType
{
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: This operation adds a new processing unit (node) to your AI model.
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: This operation removes a processing unit from your AI model.
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: This operation changes what a node does without adding or removing it.
