...
/// <remarks>
/// <para>
/// For Beginners: Neural networks can solve many different types of problems. This enum lists 
...
public enum NeuralNetworkTaskType
{
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Binary classification is about deciding between two options - yes/no, 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Multi-class classification sorts items into one of several categories. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Multi-label classification allows assigning multiple categories to a single 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Regression predicts a number value rather than a category. While classification 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Sequence-to-sequence tasks convert one sequence of items into another sequence. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: This task analyzes a sequence of data (like words in a sentence or time-ordered 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Time series forecasting predicts future values based on past observations that 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Image classification identifies what's in an image by assigning it to one or more 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Object detection not only identifies what objects are in an image but also locates 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Image segmentation goes beyond object detection by identifying exactly which pixels 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Natural Language Processing (NLP) helps computers understand, interpret, and generate 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Text generation creates new text content that resembles human writing. The neural 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Reinforcement learning is about teaching an AI to make sequences of decisions by 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Anomaly detection identifies unusual patterns that don't conform to expected behavior. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Recommendation systems suggest items to users based on their preferences or behavior. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Clustering groups similar items together without being told in advance what the groups 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Generative tasks create new data that resembles existing data. The neural network learns 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Speech recognition converts spoken language into written text. The neural network learns 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Audio processing analyzes or modifies sound data beyond just recognizing speech. This 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: Language translation converts text from one language to another while preserving the meaning. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: The Custom option allows you to define your own specialized task that doesn't fit neatly 
