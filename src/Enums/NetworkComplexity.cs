...
/// <remarks>
/// <para>
/// For Beginners: Neural networks are AI models inspired by the human brain. They consist of 
...
public enum NetworkComplexity
{
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: A Simple network typically has just 1-2 hidden layers with few neurons. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: A Medium complexity network usually has 3-5 hidden layers with more neurons. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: A Deep network has many layers (typically 6-10) with numerous neurons. 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: A VeryDeep network has a large number of layers (10+ layers) with many neurons 
    ...
    /// <remarks>
    /// <para>
    /// For Beginners: The Custom option allows you to define your own network structure rather than 
