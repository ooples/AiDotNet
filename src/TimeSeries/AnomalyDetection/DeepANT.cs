...
public class DeepANT<T> : TimeSeriesModelBase<T>
{
    ...
    protected override void SerializeCore(BinaryWriter writer)
    {
        ...
        foreach (int dim in _fcWeights.Shape._dims)
            writer.Write(dim);
        ...
        foreach (int dim in _fcBias.Shape._dims)
            writer.Write(dim);
...
internal class ConvLayerTensor<T> : NeuralNetworks.Layers.LayerBase<T>
{
    ...
    public override Tensor<T> Backward(Tensor<T> outputGradient)
    {
        ...
        _kernelGradients = new Tensor<T>(_kernels.Shape._dims);
        _biasGradients = new Tensor<T>(_biases.Shape._dims);
    ...
    public override void Serialize(BinaryWriter writer)
    {
        ...
        foreach (int dim in _kernels.Shape._dims) writer.Write(dim);
        ...
        foreach (int dim in _biases.Shape._dims) writer.Write(dim);
