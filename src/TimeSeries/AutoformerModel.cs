...
public class AutoformerModel<T> : TimeSeriesModelBase<T>
{
    ...
    private Dictionary<string, Tensor<T>> ComputeGradientsMultiStep(Vector<T> input, Vector<T> targets)
    {
        ...
        loss.Gradient = new Tensor<T>(loss.Value.Shape._dims);
        ...
        node.BackwardFunction = (gradient) =>
        {
            if (input.RequiresGradient)
            {
                if (input.Gradient == null)
                    input.Gradient = new Tensor<T>(input.Value.Shape._dims);
...
internal class AutoformerEncoderLayer<T> : NeuralNetworks.Layers.LayerBase<T>
{
    ...
    public override Tensor<T> Forward(Tensor<T> input)
    {
        ...
        var seasonal = new Tensor<T>(input.Shape._dims);
    ...
    public void InitializeGradientAccumulators(Dictionary<string, Tensor<T>> accumulators, int layerIndex)
    {
        ...
        accumulators[$"{prefix}queryProj"] = new Tensor<T>(_queryProj.Shape._dims);
        accumulators[$"{prefix}keyProj"] = new Tensor<T>(_keyProj.Shape._dims);
        accumulators[$"{prefix}valueProj"] = new Tensor<T>(_valueProj.Shape._dims);
        accumulators[$"{prefix}outputProj"] = new Tensor<T>(_outputProj.Shape._dims);
        accumulators[$"{prefix}ff1Weight"] = new Tensor<T>(_ff1Weight.Shape._dims);
        accumulators[$"{prefix}ff1Bias"] = new Tensor<T>(_ff1Bias.Shape._dims);
        accumulators[$"{prefix}ff2Weight"] = new Tensor<T>(_ff2Weight.Shape._dims);
        accumulators[$"{prefix}ff2Bias"] = new Tensor<T>(_ff2Bias.Shape._dims);
        accumulators[$"{prefix}ln1Gamma"] = new Tensor<T>(_layerNorm1Gamma.Shape._dims);
        accumulators[$"{prefix}ln1Beta"] = new Tensor<T>(_layerNorm1Beta.Shape._dims);
        accumulators[$"{prefix}ln2Gamma"] = new Tensor<T>(_layerNorm2Gamma.Shape._dims);
        accumulators[$"{prefix}ln2Beta"] = new Tensor<T>(_layerNorm2Beta.Shape._dims);
    }
...
internal class AutoformerDecoderLayer<T> : NeuralNetworks.Layers.LayerBase<T>
{
    ...
    public override Tensor<T> Forward(Tensor<T> input)
    {
        ...
        var encSeasonal = new Tensor<T>(input.Shape._dims);
    ...
    private Tensor<T> AddTensors(Tensor<T> a, Tensor<T> b)
    {
        ...
        if (a.Shape.Length == b.Shape.Length && a.Shape.Length == 2)
        {
            if (a.Shape[0] != b.Shape[0] && a.Shape[1] == b.Shape[1])
            {
                ...
                {
                    var expanded = new Tensor<T>(larger.Shape._dims);
    ...
    public void InitializeGradientAccumulators(Dictionary<string, Tensor<T>> accumulators, int layerIndex)
    {
        ...
        accumulators[$"{prefix}selfQueryProj"] = new Tensor<T>(_selfQueryProj.Shape._dims);
        accumulators[$"{prefix}selfKeyProj"] = new Tensor<T>(_selfKeyProj.Shape._dims);
        accumulators[$"{prefix}selfValueProj"] = new Tensor<T>(_selfValueProj.Shape._dims);
        accumulators[$"{prefix}selfOutputProj"] = new Tensor<T>(_selfOutputProj.Shape._dims);
        accumulators[$"{prefix}crossQueryProj"] = new Tensor<T>(_crossQueryProj.Shape._dims);
        accumulators[$"{prefix}crossKeyProj"] = new Tensor<T>(_crossKeyProj.Shape._dims);
        accumulators[$"{prefix}crossValueProj"] = new Tensor<T>(_crossValueProj.Shape._dims);
        accumulators[$"{prefix}crossOutputProj"] = new Tensor<T>(_crossOutputProj.Shape._dims);
        accumulators[$"{prefix}ff1Weight"] = new Tensor<T>(_ff1Weight.Shape._dims);
        accumulators[$"{prefix}ff1Bias"] = new Tensor<T>(_ff1Bias.Shape._dims);
        accumulators[$"{prefix}ff2Weight"] = new Tensor<T>(_ff2Weight.Shape._dims);
        accumulators[$"{prefix}ff2Bias"] = new Tensor<T>(_ff2Bias.Shape._dims);
        ...
        accumulators[$"{prefix}ln2Gamma"] = new Tensor<T>(_layerNorm2Gamma.Shape._dims);
        accumulators[$"{prefix}ln2Beta"] = new Tensor<T>(_layerNorm2Beta.Shape._dims);
        accumulators[$"{prefix}ln3Gamma"] = new Tensor<T>(_layerNorm3Gamma.Shape._dims);
        accumulators[$"{prefix}ln3Beta"] = new Tensor<T>(_layerNorm3Beta.Shape._dims);
    }
