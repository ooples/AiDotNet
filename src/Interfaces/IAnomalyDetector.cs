...
/// <remarks>
/// <para>
/// <b>For Beginners:</b> This interface provides a machine learning-style approach to anomaly detection.
...
/// 2. Call <see cref="Fit"/> to train the detector on your data
/// 3. Call <see cref="Predict"/> to identify anomalies in new data
/// 4. Optionally use <see cref="ScoreAnomalies"/> to get anomaly scores for ranking
/// </para>
/// <para>
/// <b>Anomaly Detection vs Outlier Removal:</b>
/// - <b>Anomaly Detection</b>: The primary task - identifying unusual patterns in data
/// - <b>Outlier Removal</b>: A preprocessing step that uses anomaly detection to clean data
///
...
public interface IAnomalyDetector<T>
{
    ...
    /// For novelty detection, this should contain only "normal" (non-anomalous) samples.
    /// For outlier detection, this can contain a mix of normal and anomalous samples.
    /// </param>
    /// <remarks>
    /// <para>
    ...
    /// are more likely to be anomalies. This is useful when you want to:
    ...
    /// </para>
    /// </remarks>
    Vector<T> ScoreAnomalies(Matrix<T> X);
    ...
    /// <remarks>
    /// <para>
    /// Samples with anomaly scores above this threshold are classified as anomalies.
    /// The threshold is automatically set based on the contamination parameter during <see cref="Fit"/>.
    /// </para>
    /// <para>
    /// <b>Industry Standard:</b> The default contamination of 0.1 (10%) means the threshold
    /// is set so that approximately 10% of training samples are classified as anomalies.
    /// </para>
    /// </remarks>
    T Threshold { get; }
