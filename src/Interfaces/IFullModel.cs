...
/// and even distribute training across multiple machines for faster learning on large datasets.
///
...
public interface IFullModel<T, TInput, TOutput> : IModel<TInput, TOutput, ModelMetadata<T>>,
    IModelSerializer, IParameterizable<T, TInput, TOutput>, IFeatureAware, IFeatureImportance<T>,
