...
public class Vocos<T> : TtsModelBase<T>, IVocoder<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Vocos-Native" : "Vocos-ONNX", Description = "Vocos: ConvNeXt Fourier-Based Neural Vocoder (Siuzdak, 2023)", FeatureCount = _options.MelChannels }; }
