...
public class ParallelWaveGAN<T> : TtsModelBase<T>, IVocoder<T>
{
    ...
    protected override void InitializeLayers() { if (!_useNativeMode) return; if (Architecture.Layers is not null && Architecture.Layers.Count > 0) Layers.AddRange(Architecture.Layers); else Layers.AddRange(LayerHelper<T>.CreateDefaultWaveNetVocoderLayers(_options.MelChannels, _options.ResChannels, _options.NumResBlocks, dilationCycle: 10, outputDim: 1)); }
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "ParallelWaveGAN-Native" : "ParallelWaveGAN-ONNX", Description = "Parallel WaveGAN (Yamamoto et al., 2020)", FeatureCount = _options.MelChannels, Complexity = _options.NumResBlocks }; m.AdditionalInfo["Architecture"] = "ParallelWaveGAN"; return m; }
