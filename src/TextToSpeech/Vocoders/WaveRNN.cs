...
public class WaveRNN<T> : TtsModelBase<T>, IVocoder<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "WaveRNN-Native" : "WaveRNN-ONNX", Description = "WaveRNN: Efficient Neural Audio Synthesis (Kalchbrenner et al., 2018)", FeatureCount = _options.MelChannels, Complexity = _options.RnnDim }; m.AdditionalInfo["Architecture"] = "WaveRNN"; return m; }
