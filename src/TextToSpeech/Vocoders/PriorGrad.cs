...
public class PriorGrad<T> : TtsModelBase<T>, IVocoder<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "PriorGrad-Native" : "PriorGrad-ONNX", Description = "PriorGrad: Data-Dependent Adaptive Prior Diffusion (Lee et al., 2022)", FeatureCount = _options.MelChannels, AdditionalInfo = new Dictionary<string, object> { ["MelChannels"] = _options.MelChannels, ["Mode"] = _useNativeMode ? "Native" : "ONNX" } }; }
