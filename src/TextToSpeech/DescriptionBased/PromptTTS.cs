...
public class PromptTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "PromptTTS-Native" : "PromptTTS-ONNX", Description = "PromptTTS: Description-Controlled TTS (Guo et al., 2023)", FeatureCount = _options.HiddenDim }; }
