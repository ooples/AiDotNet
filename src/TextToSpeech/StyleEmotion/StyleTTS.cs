...
public class StyleTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "StyleTTS-Native" : "StyleTTS-ONNX", Description = "StyleTTS: Style-Based Generative TTS (Li et al., 2022)", FeatureCount = _options.HiddenDim }; m.AdditionalInfo["Architecture"] = "StyleTTS"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
