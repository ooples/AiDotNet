...
public class StyleTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "StyleTTS-Native" : "StyleTTS-ONNX", Description = "StyleTTS: Style-Based Generative TTS (Li et al., 2022)", FeatureCount = _options.HiddenDim }; }
