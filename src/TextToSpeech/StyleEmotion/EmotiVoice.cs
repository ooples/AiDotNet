...
public class EmotiVoice<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "EmotiVoice-Native" : "EmotiVoice-ONNX", Description = "EmotiVoice: Multi-Voice Prompt-Controlled TTS (NetEase, 2023)", FeatureCount = _options.HiddenDim, AdditionalInfo = new Dictionary<string, object> { ["NativeMode"] = _useNativeMode, ["SampleRate"] = _options.SampleRate, ["MelChannels"] = _options.MelChannels, ["HiddenDim"] = _options.HiddenDim, ["EmotionDim"] = _options.EmotionDim, ["NumEncoderLayers"] = _options.NumEncoderLayers, ["NumEmotionLayers"] = _options.NumEmotionLayers, ["NumDecoderLayers"] = _options.NumDecoderLayers, ["NumHeads"] = _options.NumHeads, ["MaxTextLength"] = _options.MaxTextLength, ["ParameterCount"] = ParameterCount }, ModelData = SerializeForMetadata() }; }
