...
/// <remarks><para><b>References:</b><list type="bullet"><item>Paper: "OpenVoice V2: Improved Instant Voice Cloning" (Qin et al., 2024)</item></list></para></remarks>
public class OpenVoiceV2<T> : TtsModelBase<T>, IEndToEndTts<T>, IVoiceCloner<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "OpenVoiceV2-Native" : "OpenVoiceV2-ONNX", Description = "OpenVoiceV2 TTS", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.HiddenDim }; }
