...
public class OpenVoiceV2<T> : TtsModelBase<T>, IEndToEndTts<T>, IVoiceCloner<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "OpenVoiceV2-Native" : "OpenVoiceV2-ONNX", Description = "OpenVoiceV2 TTS", FeatureCount = _options.HiddenDim }; }
