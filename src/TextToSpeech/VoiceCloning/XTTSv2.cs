...
public class XTTSv2<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "XTTSv2-Native" : "XTTSv2-ONNX", Description = "XTTS v2: Multilingual Zero-Shot TTS (Coqui AI, 2023)", FeatureCount = _options.LLMDim }; }
