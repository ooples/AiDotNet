...
public class XTTSv2<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "XTTSv2-Native" : "XTTSv2-ONNX", Description = "XTTS v2: Multilingual Zero-Shot TTS (Coqui AI, 2023)", FeatureCount = _options.LLMDim }; m.AdditionalInfo["Architecture"] = "XTTSv2"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
