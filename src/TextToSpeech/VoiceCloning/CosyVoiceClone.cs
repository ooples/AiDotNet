...
public class CosyVoiceClone<T> : TtsModelBase<T>, ICodecTts<T>, IVoiceCloner<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "CosyVoice-Clone-Native" : "CosyVoice-Clone-ONNX", Description = "CosyVoice: Zero-Shot Voice Cloning (Du et al., 2024)", FeatureCount = _options.LLMDim }; m.AdditionalInfo["Architecture"] = "CosyVoiceClone"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
