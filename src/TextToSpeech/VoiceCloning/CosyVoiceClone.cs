...
public class CosyVoiceClone<T> : TtsModelBase<T>, ICodecTts<T>, IVoiceCloner<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "CosyVoice-Clone-Native" : "CosyVoice-Clone-ONNX", Description = "CosyVoice: Zero-Shot Voice Cloning (Du et al., 2024)", FeatureCount = _options.LLMDim }; }
