...
public class SeedTTSClone<T> : TtsModelBase<T>, ICodecTts<T>, IVoiceCloner<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "SeedTTS-Clone-Native" : "SeedTTS-Clone-ONNX", Description = "Seed-TTS: Zero-Shot Voice Cloning (Anastassiou et al., 2024)", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.LLMDim }; }
