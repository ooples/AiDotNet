...
public class XTTSv2Clone<T> : TtsModelBase<T>, ICodecTts<T>, IVoiceCloner<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "XTTSv2-Clone-Native" : "XTTSv2-Clone-ONNX", Description = "XTTS v2: Multilingual Voice Cloning (Coqui AI, 2023)", FeatureCount = _options.LLMDim }; m.AdditionalInfo["Architecture"] = "XTTSv2Clone"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
