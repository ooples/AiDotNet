...
public class XTTSv2Clone<T> : TtsModelBase<T>, ICodecTts<T>, IVoiceCloner<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "XTTSv2-Clone-Native" : "XTTSv2-Clone-ONNX", Description = "XTTS v2: Multilingual Voice Cloning (Coqui AI, 2023)", FeatureCount = _options.LLMDim }; }
