...
public class Zonos<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Zonos-Native" : "Zonos-ONNX", Description = "Zonos: zero-shot TTS with conditioning for speaker, emotion, and quality.", FeatureCount = _options.LLMDim }; }
