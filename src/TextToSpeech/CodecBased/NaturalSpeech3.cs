...
public class NaturalSpeech3<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "NaturalSpeech3-Native" : "NaturalSpeech3-ONNX", Description = "NaturalSpeech 3: Factorized Codec + Diffusion TTS (Ju et al., 2024)", FeatureCount = _options.HiddenDim }; }
