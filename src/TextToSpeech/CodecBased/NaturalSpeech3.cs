...
[ResearchPaper(
    "NaturalSpeech 3: Zero-Shot Speech Synthesis with a Factorized Codec and Diffusion Models",
...
public class NaturalSpeech3<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public NaturalSpeech3(
        NeuralNetworkArchitecture<T> architecture,
        string modelPath,
        NaturalSpeech3Options? options = null
    )
        : base(architecture)
    {
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "NaturalSpeech3-Native" : "NaturalSpeech3-ONNX",
            Description = "NaturalSpeech 3: Factorized Codec + Diffusion TTS (Ju et al., 2024)",
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(NaturalSpeech3<T>));
    }
