...
public class NaturalSpeech3<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "NaturalSpeech3-Native" : "NaturalSpeech3-ONNX", Description = "NaturalSpeech 3: Factorized Codec + Diffusion TTS (Ju et al., 2024)", FeatureCount = _options.HiddenDim }; m.AdditionalInfo["Architecture"] = "NaturalSpeech3"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
