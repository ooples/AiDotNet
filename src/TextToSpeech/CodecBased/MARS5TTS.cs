...
public class MARS5TTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "MARS5TTS-Native" : "MARS5TTS-ONNX", Description = "MARS5-TTS: two-stage TTS with shallow AR for coarse prosody then deep NAR for fine acoustics.", FeatureCount = _options.LLMDim }; }
