...
public class ChatTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "ChatTTS-Native" : "ChatTTS-ONNX", Description = "ChatTTS: conversational TTS with prosody control tokens for natural dialogue synthesis.", FeatureCount = _options.LLMDim }; }
