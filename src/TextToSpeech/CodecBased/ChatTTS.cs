...
/// <remarks><para><b>References:</b><list type="bullet"><item>Project: "ChatTTS: A generative speech model for daily dialogue" (2noise, 2024)</item></list></para></remarks>
public class ChatTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "ChatTTS-Native" : "ChatTTS-ONNX", Description = "ChatTTS: conversational TTS with prosody control tokens for natural dialogue synthesis.", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.LLMDim }; }
