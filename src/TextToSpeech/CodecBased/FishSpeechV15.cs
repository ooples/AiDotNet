...
public class FishSpeechV15<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "FishSpeechV15-Native" : "FishSpeechV15-ONNX", Description = "FishSpeechV15 TTS", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.LLMDim }; }
