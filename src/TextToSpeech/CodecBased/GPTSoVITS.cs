...
[ModelPaper("GPT-SoVITS: Zero-Shot Text-to-Speech", "https://github.com/RVC-Boss/GPT-SoVITS")]
public class GPTSoVITS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "GPTSoVITS-Native" : "GPTSoVITS-ONNX", Description = "GPT-SoVITS: few-shot TTS combining GPT-style autoregressive with SoVITS decoder.", FeatureCount = _options.LLMDim }; }
