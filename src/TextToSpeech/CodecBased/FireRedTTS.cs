...
public class FireRedTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "FireRedTTS-Native" : "FireRedTTS-ONNX", Description = "FireRedTTS: foundation TTS model with large-scale training and multi-codebook generation.", FeatureCount = _options.LLMDim }; }
