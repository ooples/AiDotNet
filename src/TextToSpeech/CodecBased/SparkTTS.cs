...
public class SparkTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "SparkTTS-Native" : "SparkTTS-ONNX", Description = "Spark-TTS: LLM-based zero-shot TTS with BiCodec for controllable synthesis.", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.LLMDim }; }
