...
public class VoiceCraft<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "VoiceCraft-Native" : "VoiceCraft-ONNX", Description = "VoiceCraft TTS", FeatureCount = _options.LLMDim }; }
