...
public class IndexTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "IndexTTS-Native" : "IndexTTS-ONNX", Description = "IndexTTS: LLM-based zero-shot TTS with reference audio indexing for voice cloning.", FeatureCount = _options.LLMDim }; }
