...
public class OrpheusTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "OrpheusTTS-Native" : "OrpheusTTS-ONNX", Description = "Orpheus: real-time emotion-controllable TTS with SNAC codec and LLaMA backbone.", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.LLMDim }; }
