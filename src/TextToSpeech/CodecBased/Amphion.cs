...
public class Amphion<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Amphion-Native" : "Amphion-ONNX", Description = "Amphion: open-source audio toolkit supporting multiple TTS architectures.", FeatureCount = _options.LLMDim }; }
