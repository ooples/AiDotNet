...
public class FishSpeech<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "FishSpeech-Native" : "FishSpeech-ONNX", Description = "Fish Speech: dual-AR codec language model with grouped-finite-scalar-quantization for fast TTS.", FeatureCount = _options.LLMDim }; }
