...
public class Dia<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Dia-Native" : "Dia-ONNX", Description = "Dia: dialogue-oriented TTS generating multi-speaker conversations with expressive prosody.", FeatureCount = _options.LLMDim }; }
