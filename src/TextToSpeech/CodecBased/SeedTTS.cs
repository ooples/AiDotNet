...
/// <remarks><para><b>References:</b><list type="bullet"><item>Paper: "Seed-TTS: High-Quality Versatile Speech Generation Models" (Anastassiou et al., 2024)</item></list></para></remarks>
public class SeedTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "SeedTTS-Native" : "SeedTTS-ONNX", Description = "Seed-TTS: large-scale autoregressive TTS with self-distillation for in-context learning.", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.LLMDim }; }
