...
public class SeedTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "SeedTTS-Native" : "SeedTTS-ONNX", Description = "Seed-TTS: large-scale autoregressive TTS with self-distillation for in-context learning.", FeatureCount = _options.LLMDim }; }
