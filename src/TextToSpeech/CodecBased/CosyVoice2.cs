...
public class CosyVoice2<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "CosyVoice2-Native" : "CosyVoice2-ONNX", Description = "CosyVoice 2: improved streaming TTS with chunk-aware causal flow matching and FSQ.", FeatureCount = _options.LLMDim }; }
