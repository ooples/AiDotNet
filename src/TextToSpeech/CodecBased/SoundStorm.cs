...
public class SoundStorm<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "SoundStorm-Native" : "SoundStorm-ONNX", Description = "SoundStorm: Parallel Audio Generation via MaskGIT (Borsos et al., 2023)", FeatureCount = _options.LLMDim }; m.AdditionalInfo["Architecture"] = "SoundStorm"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
