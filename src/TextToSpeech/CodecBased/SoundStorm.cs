...
public class SoundStorm<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "SoundStorm-Native" : "SoundStorm-ONNX", Description = "SoundStorm: Parallel Audio Generation via MaskGIT (Borsos et al., 2023)", FeatureCount = _options.LLMDim }; }
