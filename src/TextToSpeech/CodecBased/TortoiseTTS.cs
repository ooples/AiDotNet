...
public class TortoiseTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "TortoiseTTS-Native" : "TortoiseTTS-ONNX", Description = "TortoiseTTS TTS", FeatureCount = _options.LLMDim }; }
