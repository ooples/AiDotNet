...
public class UniAudio<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "UniAudio-Native" : "UniAudio-ONNX", Description = "UniAudio TTS", FeatureCount = _options.LLMDim }; }
