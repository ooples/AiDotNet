...
[ModelPaper("Kani TTS 2", "https://github.com/KaniTTS/KaniTTS")]
public class KaniTTS2<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "KaniTTS2-Native" : "KaniTTS2-ONNX", Description = "KaniTTS2 TTS", FeatureCount = _options.LLMDim }; }
