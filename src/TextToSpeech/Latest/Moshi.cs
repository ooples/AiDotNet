...
/// <remarks><para><b>References:</b><list type="bullet"><item>Paper: "Moshi: A Speech-Text Foundation Model for Real-Time Dialogue" (Defossez et al., 2024)</item></list></para></remarks>
public class Moshi<T> : TtsModelBase<T>, ICodecTts<T>, IStreamingTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Moshi-Native" : "Moshi-ONNX", Description = "Moshi TTS", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.LLMDim }; }
