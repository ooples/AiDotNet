...
public class IndexTTS2<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "IndexTTS2-Native" : "IndexTTS2-ONNX", Description = "IndexTTS2 TTS", FeatureCount = _options.LLMDim }; }
