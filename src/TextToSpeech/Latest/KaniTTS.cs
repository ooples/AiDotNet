...
/// <remarks><para><b>References:</b><list type="bullet"><item>Paper: "Kani-TTS: Efficient Codec-Based TTS" (-, 2025)</item></list></para></remarks>
public class KaniTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "KaniTTS-Native" : "KaniTTS-ONNX", Description = "KaniTTS TTS", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.LLMDim }; }
