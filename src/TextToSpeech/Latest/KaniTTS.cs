...
public class KaniTTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "KaniTTS-Native" : "KaniTTS-ONNX", Description = "KaniTTS TTS", FeatureCount = _options.LLMDim }; }
