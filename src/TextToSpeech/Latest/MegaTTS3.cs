...
public class MegaTTS3<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "MegaTTS3-Native" : "MegaTTS3-ONNX", Description = "MegaTTS 3: sparse diffusion transformer TTS using DiT backbone for efficient generation.", FeatureCount = _options.LLMDim }; m.AdditionalInfo["Architecture"] = "MegaTTS3"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
