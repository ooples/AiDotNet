...
public class MegaTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "MegaTTS-Native" : "MegaTTS-ONNX", Description = "MegaTTS TTS", FeatureCount = _options.HiddenDim }; }
