...
[ResearchPaper("Mega-TTS: Zero-Shot Text-to-Speech at Scale with Intrinsic Inductive Bias", "https://arxiv.org/abs/2306.03509", Year = 2023, Authors = "Jiang et al.")]
public class MegaTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "MegaTTS-Native" : "MegaTTS-ONNX", Description = "MegaTTS TTS", FeatureCount = _options.HiddenDim }; m.AdditionalInfo["Architecture"] = "MegaTTS"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
