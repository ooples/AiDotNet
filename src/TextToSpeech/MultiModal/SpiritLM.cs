...
public class SpiritLM<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "SpiritLM-Native" : "SpiritLM-ONNX", Description = "SpiritLM TTS", FeatureCount = _options.LLMDim }; }
