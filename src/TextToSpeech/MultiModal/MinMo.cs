...
public class MinMo<T> : TtsModelBase<T>, ICodecTts<T>, IStreamingTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "MinMo-Native" : "MinMo-ONNX", Description = "MinMo TTS", FeatureCount = _options.LLMDim }; }
