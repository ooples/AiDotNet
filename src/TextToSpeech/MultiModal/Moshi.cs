...
public class Moshi<T> : TtsModelBase<T>, ICodecTts<T>, IStreamingTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Moshi-Native" : "Moshi-ONNX", Description = "Moshi TTS", FeatureCount = _options.LLMDim }; }
