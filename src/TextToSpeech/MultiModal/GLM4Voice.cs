...
public class GLM4Voice<T> : TtsModelBase<T>, ICodecTts<T>, IStreamingTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "GLM4Voice-Native" : "GLM4Voice-ONNX", Description = "GLM4Voice TTS", FeatureCount = _options.LLMDim }; }
