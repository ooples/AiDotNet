...
public class AudioPaLM<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "AudioPaLM-Native" : "AudioPaLM-ONNX", Description = "AudioPaLM TTS", FeatureCount = _options.HiddenDim }; }
