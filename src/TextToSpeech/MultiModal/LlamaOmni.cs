...
public class LlamaOmni<T> : TtsModelBase<T>, ICodecTts<T>, IStreamingTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "LlamaOmni-Native" : "LlamaOmni-ONNX", Description = "LlamaOmni TTS", FeatureCount = _options.LLMDim }; }
