...
public class YourTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "YourTTS-Native" : "YourTTS-ONNX", Description = "YourTTS: Zero-Shot Multi-Speaker Multilingual TTS (Casanova et al., 2022)", FeatureCount = _options.HiddenDim }; }
