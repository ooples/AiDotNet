...
[ResearchPaper("Piper: A Fast Local Neural Text-to-Speech System", "https://github.com/rhasspy/piper")]
public class Piper<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Piper-Native" : "Piper-ONNX", Description = "Piper: Fast Local Neural TTS (Rhasspy, 2023)", FeatureCount = _options.HiddenDim, AdditionalInfo = new Dictionary<string, object> { ["HiddenDim"] = _options.HiddenDim, ["Mode"] = _useNativeMode ? "Native" : "ONNX" } }; }
