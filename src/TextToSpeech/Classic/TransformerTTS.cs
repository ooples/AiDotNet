...
public class TransformerTTS<T> : TtsModelBase<T>, IAcousticModel<T>
{
    ...
    private void ComputeEncoderDecoderBoundary() { _encoderLayerEnd = 1 + _options.NumEncoderLayers; } // 1 embedding + N residual TransformerEncoderBlocks (one layer per block)
