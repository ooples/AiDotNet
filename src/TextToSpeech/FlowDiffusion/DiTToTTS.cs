...
[ResearchPaper("DiTTo-TTS: Efficient and Scalable Zero-Shot Text-to-Speech with Diffusion Transformer", "https://arxiv.org/abs/2406.11427", Year = 2024, Authors = "Lee et al.")]
public class DiTToTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "DiTToTTS-Native" : "DiTToTTS-ONNX", Description = "DiTToTTS TTS", FeatureCount = _options.HiddenDim }; m.AdditionalInfo["Architecture"] = "DiTToTTS"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
