...
public class MaskGCT<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "MaskGCT-Native" : "MaskGCT-ONNX", Description = "MaskGCT: non-autoregressive masked generative codec transformer for zero-shot TTS.", FeatureCount = _options.LLMDim }; m.AdditionalInfo["Architecture"] = "MaskGCT"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = base.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
