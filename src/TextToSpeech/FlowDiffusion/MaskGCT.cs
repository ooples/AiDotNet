...
public class MaskGCT<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "MaskGCT-Native" : "MaskGCT-ONNX", Description = "MaskGCT: non-autoregressive masked generative codec transformer for zero-shot TTS.", FeatureCount = _options.LLMDim }; }
