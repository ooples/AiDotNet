...
public class MatchaTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Matcha-TTS-Native" : "Matcha-TTS-ONNX", Description = "Matcha-TTS: OT-CFM Fast TTS (Mehta et al., 2024)", FeatureCount = _options.HiddenDim }; }
