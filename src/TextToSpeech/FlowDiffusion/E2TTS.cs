...
public class E2TTS<T> : TtsModelBase<T>, ICodecTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "E2TTS-Native" : "E2TTS-ONNX", Description = "E2 TTS: fully non-autoregressive flow-matching TTS with character-level text input.", FeatureCount = _options.LLMDim }; }
