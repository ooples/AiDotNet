...
public class CoMoSpeech<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "CoMoSpeech-Native" : "CoMoSpeech-ONNX", Description = "CoMoSpeech TTS", FeatureCount = _options.HiddenDim }; }
