...
public class Murf<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Murf-Native" : "Murf-ONNX", Description = "Murf AI Studio TTS", FeatureCount = _options.HiddenDim }; }
