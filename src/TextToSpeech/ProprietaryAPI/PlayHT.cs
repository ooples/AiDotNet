...
public class PlayHT<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "PlayHT-Native" : "PlayHT-ONNX", Description = "PlayHT 2.0 Turbo TTS", FeatureCount = _options.HiddenDim }; }
