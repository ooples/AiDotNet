...
public class GoogleCloudTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "GoogleCloudTTS-Native" : "GoogleCloudTTS-ONNX", Description = "Google Cloud Neural TTS", FeatureCount = _options.HiddenDim }; }
