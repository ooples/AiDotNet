...
public class GoogleCloudTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "GoogleCloudTTS-Native" : "GoogleCloudTTS-ONNX", Description = "Google Cloud Neural TTS", FeatureCount = _options.HiddenDim }; m.AdditionalInfo["Architecture"] = "GoogleCloudTTS"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = _options.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
