...
public class NVIDIARivaTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "NVIDIARivaTTS-Native" : "NVIDIARivaTTS-ONNX", Description = "NVIDIARivaTTS TTS", FeatureCount = _options.HiddenDim }; m.AdditionalInfo["Architecture"] = "NVIDIARivaTTS"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = _options.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
