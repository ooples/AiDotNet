...
[ModelPaper("NVIDIA Riva", "https://developer.nvidia.com/riva")]
public class NVIDIARivaTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "NVIDIARivaTTS-Native" : "NVIDIARivaTTS-ONNX", Description = "NVIDIARivaTTS TTS", FeatureCount = _options.HiddenDim }; }
