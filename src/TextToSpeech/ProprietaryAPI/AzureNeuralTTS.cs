...
[ResearchPaper("Microsoft Azure Neural Text-to-Speech", "https://azure.microsoft.com/en-us/products/ai-services/text-to-speech")]
public class AzureNeuralTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "AzureNeuralTTS-Native" : "AzureNeuralTTS-ONNX", Description = "Microsoft Azure Cognitive Services Neural TTS", FeatureCount = _options.HiddenDim }; m.AdditionalInfo["Architecture"] = "AzureNeuralTTS"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = _options.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
