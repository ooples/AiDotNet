...
public class AzureNeuralTTS<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "AzureNeuralTTS-Native" : "AzureNeuralTTS-ONNX", Description = "Microsoft Azure Cognitive Services Neural TTS", FeatureCount = _options.HiddenDim }; }
