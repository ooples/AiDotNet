...
[ResearchPaper("Pheme: AI Voice Synthesis", "https://www.pheme.ai")]
public class Pheme<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { var m = new ModelMetadata<T> { Name = _useNativeMode ? "Pheme-Native" : "Pheme-ONNX", Description = "Pheme TTS", FeatureCount = _options.HiddenDim }; m.AdditionalInfo["Architecture"] = "Pheme"; m.AdditionalInfo["Mode"] = _useNativeMode ? "Native" : "ONNX"; m.AdditionalInfo["HiddenDim"] = _options.HiddenDim; m.AdditionalInfo["SampleRate"] = base.SampleRate; m.AdditionalInfo["MelChannels"] = base.MelChannels; m.AdditionalInfo["HopSize"] = base.HopSize; return m; }
