...
public class Pheme<T> : TtsModelBase<T>, IEndToEndTts<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() { return new ModelMetadata<T> { Name = _useNativeMode ? "Pheme-Native" : "Pheme-ONNX", Description = "Pheme TTS", FeatureCount = _options.HiddenDim }; }
