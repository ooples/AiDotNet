...
public class AudioLDMModel<T> : AudioDiffusionModelBase<T>
{
        ...
        int? seed = null)
    {
        ...
        var noise = SampleNoiseTensor(latent.Shape._dims, rng);
        ...
        int? seed = null)
    {
        ...
        for (int i = 0; i < numVariations; i++)
        {
            ...
            var noise = SampleNoiseTensor(baseLatent.Shape._dims, rng);
            var noisyLatent = new Tensor<T>(baseLatent.Shape._dims);
