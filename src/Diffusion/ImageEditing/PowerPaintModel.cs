...
/// <summary>
/// PowerPaint model for versatile task-aware image inpainting with learnable task prompts.
/// </summary>
...
public class PowerPaintModel<T> : LatentDiffusionModelBase<T>
{
    ...
    {
        var m = new ModelMetadata<T> { Name = "PowerPaint", Version = "2.0", ModelType = ModelType.NeuralNetwork,
            Description = "Versatile task-aware inpainting with learnable task prompts",
            FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "task-prompt-inpainting");
