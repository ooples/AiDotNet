...
public class Pix2PixZeroModel<T> : LatentDiffusionModelBase<T>
{
    ...
    {
        var m = new ModelMetadata<T> { Name = "Pix2Pix-Zero", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "Zero-shot image-to-image translation via text embedding directions",
            FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "ddim-inversion-direction-editing");
