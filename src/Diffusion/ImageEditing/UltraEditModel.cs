...
/// parsing to prevent unwanted modifications to uninstructed regions.
/// </para>
/// <para>
/// <b>For Beginners:</b> UltraEdit is a more precise version of text-based image editing.
...
public class UltraEditModel<T> : LatentDiffusionModelBase<T>
{
    ...
    {
        var m = new ModelMetadata<T> { Name = "UltraEdit", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "Fine-grained region-aware instruction-based image editing",
            FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "region-aware-instruction-editing");
