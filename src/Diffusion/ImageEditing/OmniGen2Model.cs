...
public class OmniGen2Model<T> : LatentDiffusionModelBase<T>
{
    ...
    {
        var m = new ModelMetadata<T> { Name = "OmniGen-2", Version = "2.0", ModelType = ModelType.NeuralNetwork,
            Description = "Unified multi-task generation and editing with interleaved text-image input",
            FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "unified-sit-multitask");
