...
public class SeedEdit3Model<T> : LatentDiffusionModelBase<T>
{
    ...
    {
        var m = new ModelMetadata<T> { Name = "SeedEdit 3", Version = "3.0", ModelType = ModelType.NeuralNetwork,
            Description = "Structure-preserving instruction-based editing with layout awareness",
            FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "structure-aware-sit-editing");
