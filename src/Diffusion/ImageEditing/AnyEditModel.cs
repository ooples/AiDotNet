...
/// trained on diverse editing instruction-image pairs.
/// </para>
/// <para>
/// <b>For Beginners:</b> AnyEdit is versatile — it can handle almost any type of image
...
public class AnyEditModel<T> : LatentDiffusionModelBase<T>
{
    ...
    {
        var clone = new AnyEditModel<T>(conditioner: _conditioner, seed: RandomGenerator.Next());
    ...
    {
        var m = new ModelMetadata<T> { Name = "AnyEdit", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "Unified instruction-based editing for diverse edit types",
            FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "unified-instruction-editing");
