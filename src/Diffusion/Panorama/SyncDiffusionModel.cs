...
/// </para>
/// <para>
/// <b>For Beginners:</b> SyncDiffusion creates panoramas that look more consistent
...
///     .ConfigureModel(new SyncDiffusionModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
