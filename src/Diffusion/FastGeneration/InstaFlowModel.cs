...
/// </para>
/// <para>
/// <b>For Beginners:</b> Diffusion models follow curved paths from noise to images.
...
///     .ConfigureModel(new InstaFlowModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class InstaFlowModel<T> : LatentDiffusionModelBase<T>
{
    ...
    /// <summary>
    /// Initializes a new InstaFlow model.
    /// </summary>
    public InstaFlowModel(
