...
///     .ConfigureModel(new OSDSModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class OSDSModel<T> : LatentDiffusionModelBase<T>
{
    /// <inheritdoc />
    ...
    {
        var m = new ModelMetadata<T> { Name = "OSDS", Version = "1.0",
