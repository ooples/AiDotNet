...
/// </para>
/// <para>
/// <b>For Beginners:</b> SiD uses a clever mathematical identity to train a fast model.
...
///     .ConfigureModel(new SiDModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class SiDModel<T> : LatentDiffusionModelBase<T>
{
    /// <inheritdoc />
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        m.SetProperty("architecture", "score-identity-unet");
