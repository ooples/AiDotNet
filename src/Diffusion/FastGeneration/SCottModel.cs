...
/// <example>
/// <code>
/// var options = new DiffusionModelOptions&lt;float&gt; { LatentChannels = 4, DefaultInferenceSteps = 2 };
/// var noise = Tensor&lt;float&gt;.CreateRandom(new[] { 1, 4, 64, 64 });
/// var trainX = Tensor&lt;float&gt;.CreateRandom(4, 8);
/// var trainY = Tensor&lt;float&gt;.CreateRandom(4, 2);
/// var result = new AiModelBuilder&lt;float, Tensor&lt;float&gt;, Tensor&lt;float&gt;&gt;()
///     .ConfigureModel(new SCottModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class SCottModel<T> : LatentDiffusionModelBase<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        m.SetProperty("distillation_method", "score-OT-consistency");
