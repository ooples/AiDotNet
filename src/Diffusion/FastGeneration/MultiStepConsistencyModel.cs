...
/// <example>
/// <code>
/// var options = new DiffusionModelOptions&lt;float&gt; { LatentChannels = 4, DefaultInferenceSteps = 3 };
/// var noise = Tensor&lt;float&gt;.CreateRandom(new[] { 1, 4, 64, 64 });
/// var trainX = Tensor&lt;float&gt;.CreateRandom(4, 8);
/// var trainY = Tensor&lt;float&gt;.CreateRandom(4, 2);
/// var result = new AiModelBuilder&lt;float, Tensor&lt;float&gt;, Tensor&lt;float&gt;&gt;()
///     .ConfigureModel(new MultiStepConsistencyModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class MultiStepConsistencyModel<T> : LatentDiffusionModelBase<T>
{
    /// <inheritdoc />
