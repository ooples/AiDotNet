...
/// </para>
/// <para>
/// <b>For Beginners:</b> AR-Diffusion generates images like reading a book — left to
...
/// var options = new DiffusionModelOptions&lt;float&gt; { LatentChannels = 8, DefaultInferenceSteps = 20 };
/// var noise = Tensor&lt;float&gt;.CreateRandom(new[] { 1, 8, 32, 32 });
/// var trainX = Tensor&lt;float&gt;.CreateRandom(4, 8);
/// var trainY = Tensor&lt;float&gt;.CreateRandom(4, 2);
/// var result = new AiModelBuilder&lt;float, Tensor&lt;float&gt;, Tensor&lt;float&gt;&gt;()
///     .ConfigureModel(new ARDiffusionModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class ARDiffusionModel<T> : LatentDiffusionModelBase<T>
{
    /// <inheritdoc />
