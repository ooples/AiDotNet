...
/// <example>
/// <code>
/// var options = new DiffusionModelOptions&lt;float&gt; { LatentChannels = 12, DefaultInferenceSteps = 64 };
/// var noise = Tensor&lt;float&gt;.CreateRandom(new[] { 1, 12, 163, 60, 106 });
/// var trainX = Tensor&lt;float&gt;.CreateRandom(4, 8);
/// var trainY = Tensor&lt;float&gt;.CreateRandom(4, 2);
/// var result = new AiModelBuilder&lt;float, Tensor&lt;float&gt;, Tensor&lt;float&gt;&gt;()
///     .ConfigureModel(new Mochi1PreviewModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class Mochi1PreviewModel<T> : VideoDiffusionModelBase<T>
{
    /// <inheritdoc />
    ...
    private const int DEFAULT_NUM_FRAMES = 163;
