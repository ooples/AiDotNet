...
/// <example>
/// <code>
/// var options = new LatentDiffusionOptions&lt;float&gt; { LatentChannels = 16, Height = 2160, Width = 3840, NumInferenceSteps = 50 };
/// var model = new Veo3Model&lt;float&gt;(options);
/// var noise = Tensor&lt;float&gt;.Random(new[] { 1, 16, 240, 270, 480 });
...
[ModelInput(typeof(Tensor<>), typeof(Tensor<>))]
    [ResearchPaper("Veo 3", "https://deepmind.google/technologies/veo/")]
public partial class Veo3Model<T> : VideoDiffusionModelBase<T>
{
    /// <inheritdoc />
    ...
    /// <summary>
    /// Initializes a new instance of Veo3Model with full customization support.
    /// </summary>
    public Veo3Model(
