...
/// var model = new LumaRay2Model&lt;float&gt;(options);
...
[ModelMetadataExempt]
public partial class LumaRay2Model<T> : VideoDiffusionModelBase<T>
{
    /// <inheritdoc />
    ...
    /// <summary>
    /// Initializes a new instance of LumaRay2Model with full customization support.
    /// </summary>
    public LumaRay2Model(
