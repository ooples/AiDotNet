...
/// var noise = Tensor&lt;float&gt;.CreateRandom(new[] { 1, 16, 128, 64, 64 });
/// var trainX = Tensor&lt;float&gt;.CreateRandom(4, 8);
/// var trainY = Tensor&lt;float&gt;.CreateRandom(4, 2);
/// var result = new AiModelBuilder&lt;float, Tensor&lt;float&gt;, Tensor&lt;float&gt;&gt;()
///     .ConfigureModel(new VideoPoetModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class VideoPoetModel<T> : VideoDiffusionModelBase<T>
{
    ...
    private const int DEFAULT_NUM_FRAMES = 128;
    ...
    /// <summary>
    /// Initializes a new instance of VideoPoetModel with full customization support.
    /// </summary>
    public VideoPoetModel(
