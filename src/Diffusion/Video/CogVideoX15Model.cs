...
/// var noise = Tensor&lt;float&gt;.CreateRandom(new[] { 1, 16, 80, 60, 90 });
/// var trainX = Tensor&lt;float&gt;.CreateRandom(4, 8);
/// var trainY = Tensor&lt;float&gt;.CreateRandom(4, 2);
/// var result = new AiModelBuilder&lt;float, Tensor&lt;float&gt;, Tensor&lt;float&gt;&gt;()
///     .ConfigureModel(new CogVideoX15Model&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class CogVideoX15Model<T> : VideoDiffusionModelBase<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of CogVideoX15Model with full customization support.
    /// </summary>
    public CogVideoX15Model(
