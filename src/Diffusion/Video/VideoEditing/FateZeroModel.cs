...
///     .ConfigureModel(new FateZeroModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class FateZeroModel<T> : VideoDiffusionModelBase<T>
{
    ...
    /// <inheritdoc />
    /// <remarks>Order is the serialization order, matching what the previous hand-written
    /// GetParameters concatenated: predictor, then temporal VAE.</remarks>
