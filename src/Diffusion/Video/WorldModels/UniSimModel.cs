...
///     .ConfigureModel(new UniSimModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
/// var simulated = result.Predict(actionInput);
/// </code>
/// </example>
...
public partial class UniSimModel<T> : VideoDiffusionModelBase<T>
{
    ...
    private const int DEFAULT_NUM_FRAMES = 30;
    ...
    /// <summary>
    /// Initializes a new instance of UniSimModel with full customization support.
    /// </summary>
    public UniSimModel(
