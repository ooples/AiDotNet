...
/// <remarks>
/// <para><b>References:</b>
/// <list type="bullet"><item>Reference: Oasis: AI-Generated Playable Minecraft (2024)</item></list></para>
/// <para><b>For Beginners:</b> Oasis is an AI-powered Minecraft engine that generates the next video frame based on player actions. It creates a fully playable Minecraft-like experience through real-time next-frame prediction.</para>
/// <para>
...
[ModelInput(typeof(Tensor<>), typeof(Tensor<>))]
    [ModelPaper("Oasis: A Universe in a Transformer", "https://oasis-model.github.io")]
public class OasisModel<T> : VideoDiffusionModelBase<T>
{
    private const int LATENT_CHANNELS = 16;
    private const int CONTEXT_DIM = 4096;
    private const int DEFAULT_NUM_FRAMES = 1;
