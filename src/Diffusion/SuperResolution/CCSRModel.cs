...
/// </para>
/// <para>
/// <b>For Beginners:</b> Diffusion SR models sometimes "imagine" details that weren't
...
/// <example>
/// <code>
/// var options = new DiffusionModelOptions&lt;float&gt; { LatentChannels = 4, DefaultInferenceSteps = 15 };
/// var lowRes = Tensor&lt;float&gt;.CreateRandom(new[] { 1, 4, 32, 32 });
/// var trainX = Tensor&lt;float&gt;.CreateRandom(4, 8);
/// var trainY = Tensor&lt;float&gt;.CreateRandom(4, 2);
/// var result = new AiModelBuilder&lt;float, Tensor&lt;float&gt;, Tensor&lt;float&gt;&gt;()
///     .ConfigureModel(new CCSRModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
/// var highRes = result.Predict(lowRes);
/// </code>
/// </example>
...
public partial class CCSRModel<T> : LatentDiffusionModelBase<T>
{
    /// <inheritdoc />
