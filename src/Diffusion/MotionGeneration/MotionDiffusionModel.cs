...
/// </para>
/// <para>
/// <b>For Beginners:</b> MDM generates 3D human body animations from text. Describe a
...
/// var model = new MotionDiffusionModel&lt;float&gt;(options: options);
...
public partial class MotionDiffusionModel<T> : LatentDiffusionModelBase<T>
{
    /// <inheritdoc />
