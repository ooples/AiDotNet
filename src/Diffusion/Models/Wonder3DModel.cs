...
/// <summary>
/// Wonder3D model — multi-view cross-domain diffusion for 3D reconstruction.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// Wonder3D generates multi-view color images and normal maps simultaneously
/// using cross-domain attention between RGB and normal map branches.
/// </para>
/// <para>
/// <b>For Beginners:</b> Wonder3D creates both views and normal maps for 3D:
///
/// Key characteristics:
/// - Dual-branch: RGB images + normal maps simultaneously
/// - Cross-domain attention for consistency
/// - 6 views (front, back, left, right, top, bottom)
/// - Direct mesh extraction via NeuS
///
...
public class Wonder3DModel<T> : ThreeDDiffusionModelBase<T>
{
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        return new Wonder3DModel<T>(unet: cu,
    ...
    {
        var m = new ModelMetadata<T> { Name = "Wonder3D", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "Wonder3D cross-domain multi-view 3D generation", FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "cross-domain-multiview-unet");
        m.SetProperty("num_views", NUM_VIEWS);
        m.SetProperty("generates_normals", true);
        return m;
    }
}
