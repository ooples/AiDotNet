...
/// <summary>
/// Kling model — 3D spatiotemporal attention video generation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// Kling (Kuaishou) uses a 3D VAE with spatiotemporal attention for high-quality
/// video generation with strong motion consistency and physics understanding.
/// </para>
/// <para>
/// <b>For Beginners:</b> Kling generates long, high-quality videos:
///
/// Key characteristics:
/// - 3D VAE for spatiotemporal compression
/// - Full 3D attention (not factorized) for motion quality
/// - Up to 2 minutes at 1080p
...
public class KlingModel<T> : VideoDiffusionModelBase<T>
{
    ...
    public KlingModel(
        ...
        int defaultNumFrames = 150, int defaultFPS = 30)
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        return new KlingModel<T>(dit: cd,
    ...
    {
        var m = new ModelMetadata<T> { Name = "Kling", Version = "1.5", ModelType = ModelType.NeuralNetwork,
            Description = "Kling 3D spatiotemporal video generation", FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "3d-dit-full-attention");
        m.SetProperty("max_duration_seconds", 120);
        return m;
    }
}
