...
/// <summary>
/// Stable Diffusion x4 Upscaler — latent super-resolution model for 4x upscaling.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// The SD x4 Upscaler takes a low-resolution image and upscales it 4x using
/// a latent diffusion process conditioned on the low-res input.
/// </para>
/// <para>
/// <b>For Beginners:</b> This model increases image resolution by 4x:
///
/// Key characteristics:
/// - 4x upscaling (128→512, 256→1024, etc.)
/// - Text-guided: can add detail via prompts
/// - Conditioned on low-res input (concatenated in latent space)
/// - 7 input channels: 4 latent + 3 low-res conditioning
///
/// Reference: Rombach et al., Stable Diffusion x4 Upscaler, 2022
/// </para>
/// </remarks>
public class SDUpscalerModel<T> : LatentDiffusionModelBase<T>
{
    ...
    /// <summary>Gets the upscale factor.</summary>
    ...
    public override Tensor<T> GenerateFromText(string prompt, string? negativePrompt = null,
        int width = DefaultWidth, int height = DefaultHeight, int numInferenceSteps = 75,
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        return new SDUpscalerModel<T>(unet: cu, vae: cv, conditioner: _conditioner);
    }

    /// <inheritdoc />
    public override ModelMetadata<T> GetModelMetadata()
    {
        var m = new ModelMetadata<T> { Name = "SD-Upscaler-x4", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "Stable Diffusion x4 Upscaler for latent super-resolution", FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "sd-upscaler");
        m.SetProperty("upscale_factor", UPSCALE_FACTOR);
