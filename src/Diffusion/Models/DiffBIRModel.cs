...
/// <summary>
/// DiffBIR model — blind image restoration with generative diffusion prior.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// DiffBIR uses a two-stage pipeline: first a regression module removes degradation,
/// then a diffusion-based refinement stage adds realistic details using SD prior.
/// </para>
/// <para>
/// <b>For Beginners:</b> DiffBIR restores degraded images (blur, noise, JPEG):
///
/// Key characteristics:
/// - Two-stage: degradation removal + diffusion refinement
/// - Handles blind (unknown) degradation types
/// - SD-based detail generation for photo-realistic results
/// - Works for face restoration, general images, and old photos
///
...
public class DiffBIRModel<T> : LatentDiffusionModelBase<T>
{
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        return new DiffBIRModel<T>(unet: cu, vae: cv, conditioner: _conditioner);
    }

    /// <inheritdoc />
    public override ModelMetadata<T> GetModelMetadata()
    {
        var m = new ModelMetadata<T> { Name = "DiffBIR", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "DiffBIR blind image restoration with generative diffusion prior", FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "two-stage-diffusion-restoration");
        m.SetProperty("tasks", "blind-restoration,face-restoration,old-photo");
        return m;
    }
}
