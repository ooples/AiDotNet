...
/// <summary>
/// Prompt-to-Prompt model — attention-based image editing by manipulating cross-attention maps.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// Prompt-to-Prompt enables image editing by manipulating the cross-attention maps during
/// the diffusion process. By controlling which attention maps are replaced, refined, or
/// reweighted, users can make localized edits to generated or real images.
/// </para>
/// <para>
/// <b>For Beginners:</b> Edit images by changing the prompt and controlling attention:
///
/// Editing modes:
/// - Word swap: "a cat sitting" -> "a dog sitting" (replaces cat with dog)
/// - Attention reweight: increase/decrease attention to specific words
/// - Refinement: add detail to specific regions
/// - No mask needed: attention maps determine edit regions
///
...
public class PromptToPromptModel<T> : LatentDiffusionModelBase<T>
{
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        return new PromptToPromptModel<T>(unet: cu, vae: cv, conditioner: _conditioner);
    }

    /// <inheritdoc />
    public override ModelMetadata<T> GetModelMetadata()
    {
        var m = new ModelMetadata<T> { Name = "Prompt-to-Prompt", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "Prompt-to-Prompt attention-based image editing", FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "sd15-attention-control");
        m.SetProperty("editing_modes", "word-swap,attention-reweight,refinement");
