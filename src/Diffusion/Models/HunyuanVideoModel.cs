...
/// <summary>
/// HunyuanVideo model — dual-stream DiT with unified image-video generation.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// HunyuanVideo uses a "Dual-stream to Single-stream" DiT architecture with 3D causal VAE
/// for high-resolution video generation with strong text-video alignment.
/// </para>
/// <para>
/// <b>For Beginners:</b> HunyuanVideo is Tencent's video generation model:
///
/// Key characteristics:
/// - Dual-stream to single-stream DiT (DS-DiT)
/// - 3D causal VAE with 4x4x4 compression
/// - MLLM-based text encoder for rich understanding
/// - 720p video, 5+ seconds, open-source weights
///
...
public class HunyuanVideoModel<T> : VideoDiffusionModelBase<T>
{
    ...
    public HunyuanVideoModel(
        ...
        int defaultNumFrames = 129, int defaultFPS = 24)
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        return new HunyuanVideoModel<T>(dit: cd,
    ...
    {
        var m = new ModelMetadata<T> { Name = "HunyuanVideo", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "HunyuanVideo dual-stream DiT video generation", FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "ds-dit-3d-causal-vae");
        m.SetProperty("parameters_billions", 13);
