...
/// <summary>
/// Open-Sora model — open-source Sora-like video generation with STDiT architecture.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// Open-Sora is an open-source reproduction of Sora-like capabilities using
/// the Spatial-Temporal DiT (STDiT) architecture with efficient attention.
/// </para>
/// <para>
/// <b>For Beginners:</b> Open-Sora is an open-source alternative to Sora:
///
/// Key characteristics:
/// - STDiT: Spatial-Temporal Diffusion Transformer
/// - Rectified flow for training efficiency
/// - Multi-resolution training with masking strategy
/// - T5-XXL text encoder, 3D causal VAE
///
...
public class OpenSoraModel<T> : VideoDiffusionModelBase<T>
{
    ...
    public OpenSoraModel(
        ...
        int defaultNumFrames = 51, int defaultFPS = 24)
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        return new OpenSoraModel<T>(dit: cd,
    ...
    {
        var m = new ModelMetadata<T> { Name = "Open-Sora", Version = "1.2", ModelType = ModelType.NeuralNetwork,
            Description = "Open-Sora STDiT video generation model", FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "stdit");
        m.SetProperty("training_objective", "rectified-flow");
