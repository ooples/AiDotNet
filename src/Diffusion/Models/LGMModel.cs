...
/// <summary>
/// LGM (Large Gaussian Model) — feed-forward 3D Gaussian generation from multi-view images.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// LGM uses a large U-Net-based backbone to predict 3D Gaussians from multi-view images
/// in a single forward pass, enabling real-time 3D generation.
/// </para>
/// <para>
/// <b>For Beginners:</b> LGM creates 3D Gaussian splats instantly from images:
///
/// Key characteristics:
/// - Feed-forward: single pass, no optimization
/// - Multi-view images → 3D Gaussians in ~5 seconds
/// - Asymmetric U-Net for Gaussian parameter prediction
...
public class LGMModel<T> : ThreeDDiffusionModelBase<T>
{
    ...
    public LGMModel(
        ...
        IConditioningModule<T>? conditioner = null, int defaultPointCount = 50000)
               ...
               defaultPointCount)
    {
        ...
        _unet = unet ?? new UNetNoisePredictor<T>(
            inputChannels: LATENT_CHANNELS * 4, outputChannels: 14,
            baseChannels: 64, channelMultipliers: [1, 2, 4, 8],
            numResBlocks: 2, attentionResolutions: [8, 4],
    ...
    {
        var m = new ModelMetadata<T> { Name = "LGM", Version = "1.0", ModelType = ModelType.NeuralNetwork,
            Description = "LGM feed-forward 3D Gaussian generation", FeatureCount = ParameterCount, Complexity = ParameterCount };
        m.SetProperty("architecture", "asymmetric-unet-gaussian-predictor");
