...
/// </para>
/// <para>
/// <b>For Beginners:</b> StableVITON uses Stable Diffusion (a powerful image generator)
...
///     .ConfigureModel(new StableVITONModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
