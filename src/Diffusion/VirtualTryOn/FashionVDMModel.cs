...
/// </para>
/// <para>
/// <b>For Beginners:</b> FashionVDM shows how clothes look in motion — not just a single
...
/// var model = new FashionVDMModel&lt;float&gt;(options);
/// var input = Tensor&lt;float&gt;.Random(new[] { 1, 4, 64, 48 });
/// var tryOnVideo = model.Predict(input);
/// </code>
/// </example>
...
public class FashionVDMModel<T> : LatentDiffusionModelBase<T>
{
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        var clone = new FashionVDMModel<T>(
