...
/// <summary>
/// StyleStudio model for text-driven style generation and transfer with disentangled control.
/// </summary>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
/// <remarks>
/// <para>
/// StyleStudio disentangles style from content in the text conditioning space, allowing
/// independent control over style intensity, color palette, and texture properties.
/// Supports both text-described styles and reference-image styles.
/// </para>
/// <para>
/// <b>For Beginners:</b> StyleStudio lets you control style in detail — you can separately
/// adjust how much of the style's colors, textures, and patterns to apply. You can describe
/// the style in words or provide a reference image.
/// </para>
/// </remarks>
/// <example>
/// <code>
...
///     .ConfigureModel(new StyleStudioModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
...
public partial class StyleStudioModel<T> : LatentDiffusionModelBase<T>
{
    ...
    {
        var m = new ModelMetadata<T> { Name = "StyleStudio", Version = "1.0",
            Description = "Text-driven style transfer with disentangled style control",
            FeatureCount = (int)System.Math.Min((long)int.MaxValue, ParameterCount), Complexity = ParameterCount };
        m.SetProperty("architecture", "disentangled-style-unet");
