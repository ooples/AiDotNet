...
/// </para>
/// <para>
/// <b>For Beginners:</b> RB-Modulation is a "plug and play" style transfer — no training
...
///     .ConfigureModel(new RBModulationModel&lt;float&gt;(options: options))
///     .Build(trainX, trainY);
/// var personalized = result.Predict(input);
/// </code>
/// </example>
