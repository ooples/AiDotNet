...
[ResearchPaper("InstantStyle: Free Lunch towards Style-Preserving in Text-to-Image Generation", "https://arxiv.org/abs/2404.02733", Year = 2024, Authors = "Wang et al.")]
public class InstantStyleModel<T> : LatentDiffusionModelBase<T>
{
    ...
    public override IDiffusionModel<T> Clone()
    {
        ...
        var clone = new InstantStyleModel<T>(conditioner: _conditioner, seed: null);
        ...
        return new InstantStyleModel<T>(
