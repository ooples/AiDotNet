...
/// <summary>
/// Configuration options for the SigLIPTextConditioner text conditioner.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public class SigLIPTextConditionerOptions : ModelHyperparameterOptions
{
    /// <summary>
    /// Gets or sets which published size of the model to build. Default: <c>SigLIPVariant.Base</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public SigLIPVariant Variant { get; set; } = SigLIPVariant.Base;
