...
/// <summary>
/// Configuration options for the DistilledT5TextConditioner text conditioner.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public class DistilledT5TextConditionerOptions : ModelHyperparameterOptions
{
    /// <summary>
    /// Gets or sets which published size of the model to build. Default: <c>DistilledT5Variant.Base</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public DistilledT5Variant Variant { get; set; } = DistilledT5Variant.Base;
