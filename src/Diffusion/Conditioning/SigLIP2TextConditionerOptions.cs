...
/// <summary>
/// Configuration options for the SigLIP2TextConditioner text conditioner.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public class SigLIP2TextConditionerOptions : ModelHyperparameterOptions
{
    /// <summary>
    /// Gets or sets which published size of the model to build. Default: <c>SigLIP2Variant.Base</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public SigLIP2Variant Variant { get; set; } = SigLIP2Variant.Base;
