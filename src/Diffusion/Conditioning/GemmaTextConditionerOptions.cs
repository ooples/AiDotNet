...
/// <summary>
/// Configuration options for the GemmaTextConditioner text conditioner.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public class GemmaTextConditionerOptions : ModelHyperparameterOptions
{
    /// <summary>
    /// Gets or sets which published size of the model to build. Default: <c>GemmaVariant.TwoB</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GemmaVariant Variant { get; set; } = GemmaVariant.TwoB;
