...
public class ReasoningConfig
{
    ...
    /// <summary>
    /// Creates a default configuration suitable for most reasoning tasks.
    /// </summary>
    /// <returns>A ReasoningConfig with balanced default settings.</returns>
    /// <remarks>
    /// <para><b>For Beginners:</b> This creates a config with sensible defaults that work well for
    /// most problems. It's like using "recommended settings" in a video game.
    /// </para>
    /// </remarks>
    public static ReasoningConfig Default() => new();

    /// <summary>
    /// Creates a configuration optimized for quick, lightweight reasoning.
    /// </summary>
    /// <returns>A ReasoningConfig with minimal compute requirements.</returns>
    /// <remarks>
    /// <para><b>For Beginners:</b> Use this for simple problems where you need fast answers and don't
    /// need deep exploration or verification. Think "quick draft" mode.
    /// </para>
    /// </remarks>
    public static ReasoningConfig Fast() => new()
    {
        MaxSteps = 5,
        ExplorationDepth = 1,
        NumSamples = 1,
    ...
    /// <summary>
    /// Creates a configuration optimized for thorough, high-quality reasoning.
    /// </summary>
    /// <returns>A ReasoningConfig with extensive verification and exploration.</returns>
    /// <remarks>
    /// <para><b>For Beginners:</b> Use this for complex, important problems where accuracy matters more
    /// than speed. Think "final exam" mode where you double-check everything.
    /// </para>
    /// </remarks>
    public static ReasoningConfig Thorough() => new()
    {
        MaxSteps = 20,
        ExplorationDepth = 5,
        BranchingFactor = 5,
