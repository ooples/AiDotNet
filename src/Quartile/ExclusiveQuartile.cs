...
public class ExclusiveQuartile : IQuartile
{
    /// <summary>
    /// Performs a simple Quartile statistical calculation using the Exclusive calculation method.
    /// Exclusive method ignores the Median.
    ...
    internal override (double q1Value, double q2Value, double q3Value) FindQuartiles(double[] inputs)
    {
        ...
        //Exclusive Method (Does not Count Median)
        var nQ1 = (int)((nSize + 1)/ 4.0);
        var nQ2 = (int)((nSize + 1)/ 2.0);
        var nQ3 = (int)((3 * nSize + 3)/ 4.0);
