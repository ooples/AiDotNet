...
public class TelemetryConfig
{
    ...
    /// </summary>
    /// <returns>A minimal telemetry configuration.</returns>
    /// <remarks>
    /// <para><b>For Beginners:</b> Use this for maximum performance with minimal monitoring.
    /// Only tracks errors, samples 10% of requests. Good for resource-constrained environments.
    /// </para>
    /// </remarks>
    ...
    /// </summary>
    /// <returns>A comprehensive telemetry configuration.</returns>
    /// <remarks>
    /// <para><b>For Beginners:</b> Use this for maximum visibility into your system.
    /// Tracks everything with full sampling. Best for production systems where you need detailed monitoring.
    /// </para>
    /// </remarks>
    ...
    /// </summary>
    /// <returns>A configuration with telemetry disabled.</returns>
    /// <remarks>
    /// <para><b>For Beginners:</b> Use this to disable telemetry entirely.
    /// No performance metrics collected. Only use for development or testing.
    /// </para>
    /// </remarks>
