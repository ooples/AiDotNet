...
public partial class MomentumOptimizer<T, TInput, TOutput> : GradientBasedOptimizerBase<T, TInput, TOutput>, Fused.IFusedOptimizerSpec
{
    ...
    /// <summary>
    /// Creates a momentum optimizer for minimizing a plain function, with no model attached.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    public static MomentumOptimizer<T, TInput, TOutput> CreateForFunction(
        MomentumOptimizerOptions<T, TInput, TOutput>? options = null)
        => new(options);
    ...
    /// <summary>
    /// Resets the legacy vector, per-parameter tape, and device-resident velocity state.
    /// </summary>
    /// <remarks>
