namespace AiDotNet.ReinforcementLearning.ReplayBuffers
{
    ...
    /// This version maintains compatibility with legacy interfaces.
    /// </summary>
    /// <typeparam name="TState">The type of the state representation.</typeparam>
    /// <typeparam name="T">The numeric type used for calculations.</typeparam>
    public class ReplayBatch<TState, T>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the weights for prioritized experience replay.
        /// </summary>
        public T[] Weights { get; }

        /// <summary>
        /// Initializes a new instance of the <see cref="ReplayBatch{TState, T}"/> class.
        /// </summary>
        ...
        /// <param name="weights">The weights for prioritized experience replay.</param>
        public ReplayBatch(TState[] states, int[] actions, T[] rewards, TState[] nextStates, bool[] dones, int[]? indices = null, T[]? weights = null)
        {
            States = states;
            Actions = actions;
            Rewards = rewards;
