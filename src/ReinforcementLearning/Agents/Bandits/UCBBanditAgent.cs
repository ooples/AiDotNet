...
public class UCBBanditAgent<T> : ReinforcementLearningAgentBase<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new ModelMetadata<T> { ModelType = "UCBBandit", InputSize = 1, OutputSize = _options.NumArms, ParameterCount = ParameterCount };
