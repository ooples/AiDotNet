...
public class LinearSARSAAgent<T> : ReinforcementLearningAgentBase<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new ModelMetadata<T> { ModelType = "LinearSARSA", InputSize = _options.FeatureSize, OutputSize = _options.ActionSize, ParameterCount = ParameterCount };
