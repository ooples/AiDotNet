...
public class LinearQLearningAgent<T> : ReinforcementLearningAgentBase<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new ModelMetadata<T> { ModelType = "LinearQLearning", InputSize = _options.FeatureSize, OutputSize = _options.ActionSize, ParameterCount = ParameterCount };
