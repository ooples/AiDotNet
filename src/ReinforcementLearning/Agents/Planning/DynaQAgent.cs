...
public class DynaQAgent<T> : ReinforcementLearningAgentBase<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new ModelMetadata<T> { ModelType = "DynaQ", InputSize = _options.StateSize, OutputSize = _options.ActionSize, ParameterCount = ParameterCount };
