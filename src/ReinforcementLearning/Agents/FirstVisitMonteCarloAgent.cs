...
/// <example>
/// <code>
/// // Create a First-Visit Monte Carlo agent for episodic tasks
/// var options = new MonteCarloOptions&lt;double&gt; { StateSize = 4, ActionSize = 2 };
/// var agent = new FirstVisitMonteCarloAgent&lt;double&gt;(options);
///
...
public partial class FirstVisitMonteCarloAgent<T> : ReinforcementLearningAgentBase<T>, IGradientComputable<T, Vector<T>, Vector<T>>
{
    ...
    public Vector<T> ComputeGradients(Vector<T> input, Vector<T> target, ILossFunction<T>? lossFunction = null)
    {
        ...
        throw new NotSupportedException(
            "FirstVisitMonteCarloAgent is a tabular agent whose update is a value backup rather than a "
    ...
    public void ApplyGradients(Vector<T> gradients, T learningRate)
    {
        ...
        throw new NotSupportedException(
            "FirstVisitMonteCarloAgent is a tabular agent and does not apply gradient updates. "
            + "Call Train() instead.");
    }
