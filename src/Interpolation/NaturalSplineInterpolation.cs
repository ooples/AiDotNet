...
public class NaturalSplineInterpolation<T> : IInterpolation<T>
{
    ...
    /// </summary>
    /// <remarks>
    /// For Beginners: The degree determines how "flexible" the curve can be. A higher degree allows
    ...
    /// </summary>
    /// <remarks>
    /// For Beginners: These are the values that define the shape of the curve between each pair
    ...
    /// 
    /// For Beginners: When you create a Natural Spline interpolator, you provide:
    ...
    /// 
    /// For Beginners: Before we can calculate an interpolated value, we need to know which segment
    ...
    /// 
    /// For Beginners: This method calculates what happens when you multiply a number by itself
