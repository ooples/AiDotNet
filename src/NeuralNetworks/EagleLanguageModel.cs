...
/// </para>
/// <para><b>For Beginners:</b> Eagle (RWKV-5) is a language model that processes text like a
...
public partial class EagleLanguageModel<T> : TokenLanguageModelLayoutBase<T>
{
