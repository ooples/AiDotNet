...
/// </para>
/// <para>
/// <b>For Beginners:</b> Use SAINT for classification when:
...
/// };
/// var classifier = new SAINTClassifier&lt;double&gt;(numFeatures: 10, numClasses: 3, options);
///
/// var predictions = classifier.Predict(features, categoricalIndices);
/// </code>
/// </para>
/// </remarks>
/// <typeparam name="T">The numeric type used for calculations.</typeparam>
public class SAINTClassifier<T> : SAINTBase<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the SAINTClassifier class.
    /// </summary>
