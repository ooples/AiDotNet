...
/// </para>
/// <para>
/// <b>For Beginners:</b> Use Mambular for regression when:
...
///     NumLayers = 4
/// };
/// var regressor = new MambularRegression&lt;double&gt;(numFeatures: 50, outputDim: 1, options);
///
...
public class MambularRegression<T> : MambularBase<T>
{
