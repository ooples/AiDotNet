...
/// </para>
/// <para>
/// <b>For Beginners:</b> Use Mambular for classification when:
...
///     NumLayers = 4
/// };
/// var classifier = new MambularClassifier&lt;double&gt;(numFeatures: 50, numClasses: 3, options);
///
...
public class MambularClassifier<T> : MambularBase<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the MambularClassifier class.
    /// </summary>
    public MambularClassifier(
