...
[LayerProperty(IsTrainable = true, ChangesShape = true, ExpectedInputRank = 3, Cost = ComputeCost.Medium, TestInputShape = "1, 8, 8", TestConstructorArgs = "new[] { 1, 8, 8 }, 2, 3, (AiDotNet.Interfaces.IActivationFunction<double>?)null")]
