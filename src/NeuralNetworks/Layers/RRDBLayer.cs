...
public class RRDBLayer<T> : LayerBase<T>, IChainableComputationGraph<T>
{
    ...
    public override IGpuTensor<T> BackwardGpu(IGpuTensor<T> outputGradient)
    {
        ...
        var rdb3Grad = new GpuTensor<T>(backend, rdb3GradBuffer, outputGradient.Shape._dims, GpuTensorRole.Gradient, ownsBuffer: true);
        ...
        return new GpuTensor<T>(backend, resultBuffer, outputGradient.Shape._dims, GpuTensorRole.Gradient, ownsBuffer: true);
    }
    ...
    private static ComputationNode<T> ScaleNode(ComputationNode<T> node, double scale, string name)
    {
        ...
        var scaleTensor = new Tensor<T>(node.Value.Shape._dims);
