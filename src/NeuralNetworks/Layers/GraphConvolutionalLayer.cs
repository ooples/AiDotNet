...
public class GraphConvolutionalLayer<T> : LayerBase<T>, IAuxiliaryLossLayer<T>, IGraphConvolutionLayer<T>, ITrainableLayer<T>
{
    /// <summary>
    ...
    /// <inheritdoc />
    public void ZeroGrad() { _weightsGradient = null; _biasGradient = null; }
}
