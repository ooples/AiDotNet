...
[AutoParameters]
public partial class MultiLatentAttentionLayer<T> : LayerBase<T>, IShapeContract
{
    ...
    {
        if (_compressWeightsGradient == null) return new Vector<T>(ParameterCountHelper.ToFlatVectorSize(ParameterCount));
