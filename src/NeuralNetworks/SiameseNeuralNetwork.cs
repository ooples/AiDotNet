    ...
    public class SiameseNeuralNetwork<T> : NeuralNetworkBase<T>, IEmbeddingModel<T>
    {
        ...
        public override void Train(Tensor<T> input, Tensor<T> expectedOutput)
        {
            ...
            if (_lossFunction is ContrastiveLoss<T> contrastiveLoss)
            {
                ...
                Backpropagate(new Tensor<T>(prediction1.Shape._dims, grad1));
                Backpropagate(new Tensor<T>(prediction2.Shape._dims, grad2));
            }
            else
            {
                ...
                Backpropagate(new Tensor<T>(prediction.Shape._dims, outputGradient));
            }
