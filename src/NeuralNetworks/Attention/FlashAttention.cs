...
internal static class FlashAttention<T>
{
        ...
        Tensor<T>? attentionBias)
    {
        ...
        var output = new Tensor<T>(query.Shape._dims);
        ...
        Tensor<T>? attentionBias)
    {
        ...
        var gradQuery = new Tensor<T>(query.Shape._dims);
        var gradKey = new Tensor<T>(key.Shape._dims);
        var gradValue = new Tensor<T>(value.Shape._dims);
