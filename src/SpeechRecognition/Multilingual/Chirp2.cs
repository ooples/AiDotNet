...
public class Chirp2<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "Chirp2-Native" : "Chirp2-ONNX", Description = "Chirp 2: enhanced Google Cloud multilingual ASR (2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
