...
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the USM model. Default values follow the original paper's recommended settings for optimal speech recognition accuracy.</para>
/// </remarks>
public class USMOptions : ModelOptions
{
    ...
    public USMOptions(USMOptions other)
    {
        if (other == null)
