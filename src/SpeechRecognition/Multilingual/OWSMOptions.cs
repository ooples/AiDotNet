...
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the OWSM model. Default values follow the original paper's recommended settings for optimal speech recognition accuracy.</para>
/// </remarks>
public class OWSMOptions : ModelOptions
{
    ...
    public OWSMOptions(OWSMOptions other)
    {
        if (other == null)
