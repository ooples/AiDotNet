...
public class ParaformerLarge<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "ParaformerLarge-Native" : "ParaformerLarge-ONNX", Description = "Paraformer-Large: 220M CIF parallel ASR (Alibaba, 2023)", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
