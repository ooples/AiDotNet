...
public class SeACo<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SeACo-Native" : "SeACo-ONNX", Description = "SeACo-Paraformer: hot-word biased CIF ASR (Alibaba, 2023)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
