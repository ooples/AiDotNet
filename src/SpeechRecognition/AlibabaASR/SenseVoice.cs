...
public class SenseVoice<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SenseVoice-Native" : "SenseVoice-ONNX", Description = "SenseVoice: multi-task speech understanding (Alibaba, 2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
