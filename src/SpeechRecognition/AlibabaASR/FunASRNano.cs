...
public class FunASRNano<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "FunASRNano-Native" : "FunASRNano-ONNX", Description = "FunASR-Nano: ultra-lightweight on-device ASR (Alibaba, 2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
