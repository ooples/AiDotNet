...
public partial class WhisperLargeV3Turbo<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    /// <inheritdoc />
    /// <remarks>
    ...
    /// <c>new DenseLayer&lt;T&gt;(vocabSize, identity)</c>. Turbo cuts <c>NumDecoderLayers</c>, not the
    /// vocabulary, so this axis matches large-v3. <c>PostprocessOutput</c> is the identity.
    /// </remarks>
