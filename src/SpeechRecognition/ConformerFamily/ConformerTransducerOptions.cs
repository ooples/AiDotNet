...
/// <summary>Options for Conformer-Transducer variant (Conformer encoder + RNN-T/TDT decoder).</summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the ConformerTransducer model. Default values follow the original paper's recommended settings for optimal speech recognition accuracy.</para>
/// </remarks>
public class ConformerTransducerOptions : ModelOptions
{
    /// <summary>Initializes a new instance with default values.</summary>
    public ConformerTransducerOptions() { }

    /// <summary>Initializes a new instance by copying from another instance.</summary>
    /// <param name="other">The options instance to copy from.</param>
    /// <exception cref="ArgumentNullException">Thrown when other is null.</exception>
    public ConformerTransducerOptions(ConformerTransducerOptions other)
    {
        if (other == null)
