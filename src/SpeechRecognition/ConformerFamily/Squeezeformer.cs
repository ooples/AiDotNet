...
public class Squeezeformer<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "Squeezeformer-Native" : "Squeezeformer-ONNX", Description = "Squeezeformer: Efficient Transformer for ASR (Kim et al., 2022)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
