...
public class ConformerCTC<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "ConformerCTC-Native" : "ConformerCTC-ONNX", Description = "Conformer-CTC: CTC-only variant (Gulati et al., 2020)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
