...
public class EfficientConformer<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "EfficientConformer-Native" : "EfficientConformer-ONNX", Description = "Efficient Conformer: Progressive Downsampling (Burchi & Vielzeuf, 2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
