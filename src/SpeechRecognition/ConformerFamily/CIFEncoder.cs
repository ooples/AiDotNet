...
public partial class CIFEncoder<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    /// <summary>Creates a CIF encoder in ONNX inference mode.</summary>
    public CIFEncoder(
        NeuralNetworkArchitecture<T> architecture,
        string modelPath,
        CIFEncoderOptions? options = null)
        : base(architecture)
    {
        _options = options ?? new CIFEncoderOptions();
    ...
    /// <summary>Creates a CIF encoder in native training mode.</summary>
    public CIFEncoder(
        NeuralNetworkArchitecture<T> architecture,
        CIFEncoderOptions? options = null,
    ...
    protected override void SerializeNetworkSpecificData(BinaryWriter w)
    {
        ...
        w.Write(_options.FeedForwardDim);
        w.Write(_options.CifThreshold);
    ...
    protected override void DeserializeNetworkSpecificData(BinaryReader r)
    {
        ...
        _options.FeedForwardDim = r.ReadInt32();
        _options.CifThreshold = r.ReadDouble();
