...
public partial class NoiseRobustASR<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    /// <inheritdoc />
    /// <remarks>
    ...
    {
        var options = new NoiseRobustASROptions(_options);
        if (!_useNativeMode && _options.ModelPath is { } mp && !string.IsNullOrEmpty(mp))
            return new NoiseRobustASR<T>(Architecture, mp, options);
        return new NoiseRobustASR<T>(Architecture, options);
    }
