...
public class SpeechBrain<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SpeechBrain-Native" : "SpeechBrain-ONNX", Description = "SpeechBrain: open-source Conformer + CTC (2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
