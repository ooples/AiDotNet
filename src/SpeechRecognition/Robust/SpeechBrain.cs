...
/// <example>
/// <code>
/// // Create a SpeechBrain model for toolkit-based ASR
/// var architecture = new NeuralNetworkArchitecture&lt;double&gt;(
///     inputType: InputType.OneDimensional,
///     taskType: NeuralNetworkTaskType.Classification,
///     inputHeight: 16000, inputWidth: 1, inputDepth: 1, outputSize: 5000);
/// var model = new SpeechBrain&lt;double&gt;(architecture);
///
/// // Or load a pre-trained ONNX model for SpeechBrain ASR inference
/// var onnxModel = new SpeechBrain&lt;double&gt;(architecture, "speechbrain.onnx");
/// </code>
/// </example>
...
public class SpeechBrain<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SpeechBrain-Native" : "SpeechBrain-ONNX", Description = "SpeechBrain: open-source Conformer + CTC (2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers, AdditionalInfo = BaseAudioMetadataInfo() };
