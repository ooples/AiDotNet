...
public class Moonshine<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "Moonshine-Native" : "Moonshine-ONNX", Description = "Moonshine: efficient real-time ASR (Useful Sensors, 2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
