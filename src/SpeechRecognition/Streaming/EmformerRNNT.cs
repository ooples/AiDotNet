...
public class EmformerRNNT<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    protected override IFullModel<T, Tensor<T>, Tensor<T>> CreateNewInstance()
    {
        if (!_useNativeMode && _options.ModelPath is { } mp && !string.IsNullOrEmpty(mp))
            return new EmformerRNNT<T>(Architecture, mp, new EmformerRNNTOptions(_options));
        ...
        var cloneOptimizer = _optimizer?.GetOptions() is AdamWOptimizerOptions<T, Tensor<T>, Tensor<T>> options
            ...
            : null;
        return new EmformerRNNT<T>(Architecture, new EmformerRNNTOptions(_options), cloneOptimizer);
    }
