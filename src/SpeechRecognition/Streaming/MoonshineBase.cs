...
public class MoonshineBase<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "MoonshineBase-Native" : "MoonshineBase-ONNX", Description = "Moonshine Base: tiny 27M edge ASR (Useful Sensors, 2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
