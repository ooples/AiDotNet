...
public partial class MoonshineBase<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    {
        Name = _useNativeMode ? "MoonshineBase-Native" : "MoonshineBase-ONNX",
        Description = "Moonshine Base: tiny 27M edge ASR (Useful Sensors, 2024)",
