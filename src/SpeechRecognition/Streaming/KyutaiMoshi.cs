...
public class KyutaiMoshi<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "KyutaiMoshi-Native" : "KyutaiMoshi-ONNX", Description = "Moshi: full-duplex speech-text dialogue (Kyutai, 2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
