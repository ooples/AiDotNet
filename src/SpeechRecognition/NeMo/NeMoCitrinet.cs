...
public class NeMoCitrinet<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "NeMoCitrinet-Native" : "NeMoCitrinet-ONNX", Description = "Citrinet: 1D time-channel separable conv CTC with SE (NVIDIA, 2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
