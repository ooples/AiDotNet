...
public class ParakeetTDT<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "ParakeetTDT-Native" : "ParakeetTDT-ONNX", Description = "Parakeet-TDT: 1.1B Fast Conformer + Token-and-Duration Transducer (NVIDIA, 2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
