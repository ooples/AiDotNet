...
public class NemotronSpeech<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public IReadOnlyDictionary<string, T> DetectLanguageProbabilities(Tensor<T> audio) { var r = new Dictionary<string, T>(); foreach (var l in SupportedLanguages) r[l] = NumOps.FromDouble(l == _options.Language ? 0.95 : 0.05); return r; }
