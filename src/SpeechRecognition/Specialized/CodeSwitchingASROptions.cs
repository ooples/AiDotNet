...
/// <summary>Options for Code-Switching ASR: multilingual code-mixed speech recognition.</summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the CodeSwitchingASR model. Default values follow the original paper's recommended settings for optimal speech recognition accuracy.</para>
/// </remarks>
public class CodeSwitchingASROptions : ModelOptions
{
    ...
    public int VocabSize { get; set; } = 15000;
