...
public class CodeSwitchingASR<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "CodeSwitchingASR-Native" : "CodeSwitchingASR-ONNX", Description = "Code-Switching ASR: multilingual mixed-speech (2023)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
