...
public class WhisperCPP<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "WhisperCPP-Native" : "WhisperCPP-ONNX", Description = "Whisper.cpp: optimized C++ Whisper inference (2022-2025)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
