...
public class AssemblyAIUniversal2<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    {
        var cloneOptions = new AssemblyAIUniversal2Options(_options);
        if (!_useNativeMode && _options.ModelPath is { } mp && !string.IsNullOrEmpty(mp))
            return new AssemblyAIUniversal2<T>(Architecture, mp, cloneOptions);
        return new AssemblyAIUniversal2<T>(Architecture, cloneOptions);
    }
