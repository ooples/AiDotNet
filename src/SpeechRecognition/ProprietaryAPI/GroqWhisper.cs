...
public partial class GroqWhisper<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public GroqWhisper(NeuralNetworkArchitecture<T> architecture, GroqWhisperOptions? options = null, IGradientBasedOptimizer<T, Tensor<T>, Tensor<T>>? optimizer = null) : base(architecture) { _options = options ?? new GroqWhisperOptions(); _useNativeMode = true; _optimizer = optimizer
