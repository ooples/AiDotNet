...
/// <example>
/// <code>
/// // Create a Sarvam ASR model for Indian language speech recognition
/// var architecture = new NeuralNetworkArchitecture&lt;double&gt;(
///     inputType: InputType.OneDimensional,
///     taskType: NeuralNetworkTaskType.Classification,
///     inputHeight: 16000, inputWidth: 1, inputDepth: 1, outputSize: 5000);
/// var model = new SarvamASR&lt;double&gt;(architecture);
///
/// // Or load a pre-trained ONNX model for Indian language ASR
/// var onnxModel = new SarvamASR&lt;double&gt;(architecture, "sarvamasr.onnx");
/// </code>
/// </example>
...
[ResearchPaper("Sarvam AI ASR", "https://sarvam.ai")]
public partial class SarvamASR<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SarvamASR-Native" : "SarvamASR-ONNX", Description = "Sarvam AI: Indian language ASR (2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers, AdditionalInfo = BaseAudioMetadataInfo() };
