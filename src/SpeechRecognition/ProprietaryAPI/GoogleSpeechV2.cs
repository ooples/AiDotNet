...
public class GoogleSpeechV2<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "GoogleSpeechV2-Native" : "GoogleSpeechV2-ONNX", Description = "Google Cloud STT V2: Chirp-based production API (2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
