...
[ModelPaper("Self-Conditioned CTC: CTC Alignment Conditioning on Intermediate Predictions", "https://arxiv.org/abs/2104.02724", Year = 2021, Authors = "Nozaki and Komatsu")]
public class SelfConditionedCTC<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SelfConditionedCTC-Native" : "SelfConditionedCTC-ONNX", Description = "Self-Conditioned CTC: iterative CTC refinement (2021)", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
