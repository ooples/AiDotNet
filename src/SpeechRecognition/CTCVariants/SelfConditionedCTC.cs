...
public class SelfConditionedCTC<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SelfConditionedCTC-Native" : "SelfConditionedCTC-ONNX", Description = "Self-Conditioned CTC: iterative CTC refinement (2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
