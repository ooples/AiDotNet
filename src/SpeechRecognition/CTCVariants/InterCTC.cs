...
///
/// // Or load a pre-trained ONNX model for intermediate-loss CTC inference
/// var onnxModel = new InterCTC&lt;double&gt;(architecture, "interctc.onnx");
/// </code>
/// </example>
...
public class InterCTC<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "InterCTC-Native" : "InterCTC-ONNX", Description = "InterCTC: intermediate CTC losses (2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers, AdditionalInfo = BaseAudioMetadataInfo() };
