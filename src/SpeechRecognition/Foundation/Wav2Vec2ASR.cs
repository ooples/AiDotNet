...
/// <example>
/// <code>
/// // Create a Wav2Vec 2.0 model for self-supervised contrastive speech learning
/// var architecture = new NeuralNetworkArchitecture&lt;double&gt;(
///     inputType: InputType.OneDimensional,
///     taskType: NeuralNetworkTaskType.Classification,
///     inputHeight: 16000, inputWidth: 1, inputDepth: 1, outputSize: 5000);
/// var model = new Wav2Vec2ASR&lt;double&gt;(architecture);
///
/// // Or load a pre-trained ONNX model for fine-tuned CTC ASR
/// var onnxModel = new Wav2Vec2ASR&lt;double&gt;(architecture, "wav2vec2asr.onnx");
/// </code>
/// </example>
...
public class Wav2Vec2ASR<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "Wav2Vec2ASR-Native" : "Wav2Vec2ASR-ONNX", Description = "Wav2Vec 2.0: SSL speech representations + CTC (Meta, 2020)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
