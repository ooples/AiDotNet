...
public class UniSpeech<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "UniSpeech-Native" : "UniSpeech-ONNX", Description = "UniSpeech: unified SSL + supervised + CTC (Microsoft, 2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
