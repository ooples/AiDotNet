...
public class HuBERTASR<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "HuBERTASR-Native" : "HuBERTASR-ONNX", Description = "HuBERT: hidden-unit BERT SSL + CTC (Meta, 2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
