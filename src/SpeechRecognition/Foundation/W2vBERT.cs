...
public class W2vBERT<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "W2vBERT-Native" : "W2vBERT-ONNX", Description = "w2v-BERT: contrastive + MLM SSL + CTC (Google, 2021)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
