...
public class SPIRAL<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SPIRAL-Native" : "SPIRAL-ONNX", Description = "SPIRAL: perturbation-invariant SSL + CTC (2022)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
