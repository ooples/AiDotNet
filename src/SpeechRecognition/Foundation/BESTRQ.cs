...
public class BESTRQ<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "BESTRQ-Native" : "BESTRQ-ONNX", Description = "BEST-RQ: random-projection quantizer SSL + CTC (Google, 2022)", ModelType = ModelType.NeuralNetwork, FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
