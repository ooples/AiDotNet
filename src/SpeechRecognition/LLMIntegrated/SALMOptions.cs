...
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the SALM model. Default values follow the original paper's recommended settings for optimal speech recognition accuracy.</para>
/// </remarks>
public class SALMOptions : ModelOptions
{
    ...
    public SALMOptions(SALMOptions other)
    {
        if (other == null)
