...
public class SambaASR<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SambaASR-Native" : "SambaASR-ONNX", Description = "Samba-ASR: Mamba SSM encoder + CTC (2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
