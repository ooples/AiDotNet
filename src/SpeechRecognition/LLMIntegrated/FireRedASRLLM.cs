...
public class FireRedASRLLM<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "FireRedASRLLM-Native" : "FireRedASRLLM-ONNX", Description = "FireRedASR-LLM: Conformer + Qwen2 decoder (2025)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
