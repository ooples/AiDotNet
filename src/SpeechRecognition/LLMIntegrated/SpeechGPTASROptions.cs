...
/// <summary>Options for SpeechGPT: speech-language model for multi-modal conversation.</summary>
/// <remarks>
...
public class SpeechGPTASROptions : ModelOptions
{
    ...
    public SpeechGPTASROptions() { }

    /// <summary>Initializes a new instance by copying from another instance.</summary>
    /// <param name="other">The options instance to copy from.</param>
    /// <exception cref="ArgumentNullException">Thrown when other is null.</exception>
    public SpeechGPTASROptions(SpeechGPTASROptions other)
    {
        if (other == null)
