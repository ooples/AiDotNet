...
public class SeedASR<T> : AudioNeuralNetworkBase<T>, ISpeechRecognizer<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() => new() { Name = _useNativeMode ? "SeedASR-Native" : "SeedASR-ONNX", Description = "Seed-ASR: Conformer + LLM decoder (ByteDance, 2024)", FeatureCount = _options.NumMels, Complexity = _options.NumEncoderLayers };
