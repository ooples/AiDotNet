...
/// <summary>
/// Flow-based distillation using information flow between layers.
/// </summary>
public class FlowBasedDistillationStrategy<T> : DistillationStrategyBase<Vector<T>, T>
{
    public FlowBasedDistillationStrategy(double temperature = 3.0, double alpha = 0.3)
