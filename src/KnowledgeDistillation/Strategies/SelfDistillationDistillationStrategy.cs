...
/// <summary>
/// SelfDistillation distillation strategy.
/// </summary>
public class SelfDistillationDistillationStrategy<T> : DistillationStrategyBase<Vector<T>, T>
{
    public SelfDistillationDistillationStrategy(double temperature = 3.0, double alpha = 0.3)
