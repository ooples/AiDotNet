...
public class WorkspaceCodeGenerator
{
    ...
    {
        var method = typeof(IEngine).GetMethod("Conv2DInto")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "Conv2DInto");
    ...
    {
        var method = typeof(IEngine).GetMethod("GroupNormInto")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "GroupNormInto");
    ...
    {
        var method = typeof(IEngine).GetMethod("GroupNormSwishInto")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "GroupNormSwishInto");
        ...
        ParameterExpression dest, Expression[] inputs, FusedConv2DBiasActivationOp fcba)
    {
        ...
        var method = typeof(IEngine).GetMethod("FusedConv2D")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "FusedConv2D");
        ...
        ParameterExpression dest, Expression[] inputs, FusedGroupNormActivationConv2DOp fgnac)
    {
        ...
        var gnSwishMethod = typeof(IEngine).GetMethod("GroupNormSwishInto")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "GroupNormSwishInto");
        var conv2dIntoMethod = typeof(IEngine).GetMethod("Conv2DInto")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "Conv2DInto");
    ...
    {
        var agnMethod = typeof(IEngine).GetMethod("AddGroupNormInto")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "AddGroupNormInto");
    ...
    {
        // Simple 2D transpose
        var method = typeof(IEngine).GetMethod("TransposeInto")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "TransposeInto");
        return Expression.Call(engine, method, dest, input,
    ...
    {
        var method = typeof(IEngine).GetMethod("ConcatInto")?.MakeGenericMethod(typeof(T)) ?? throw new MissingMethodException(nameof(IEngine), "ConcatInto");
