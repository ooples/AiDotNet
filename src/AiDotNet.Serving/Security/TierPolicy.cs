...
{
    public TierPolicy(SubscriptionTier tier, ModelArtifactAccessMode artifactAccessMode, bool requireAttestationForKeyRelease)
    {
        Tier = tier;
    ...
    /// </summary>
    public bool ArtifactIsEncrypted => ArtifactAccessMode == ModelArtifactAccessMode.EncryptedWithAttestedKeyRelease;

    /// <summary>
    /// Gets whether key release is allowed.
    /// </summary>
    public bool AllowKeyRelease => ArtifactAccessMode == ModelArtifactAccessMode.EncryptedWithAttestedKeyRelease;
}
