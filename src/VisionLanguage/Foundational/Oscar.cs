...
public class Oscar<T> : VisionLanguageModelBase<T>, IVisionLanguageFusionModel<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "Oscar-Native" : "Oscar-ONNX",
            Description =
        ...
        m.AdditionalInfo["Architecture"] = "Oscar";
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(Oscar<T>));
    }
