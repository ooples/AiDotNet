...
public class MPLUGDocOwl15<T> : VisionLanguageModelBase<T>, IDocumentUnderstandingModel<T>
{
    ...
    public MPLUGDocOwl15(
        NeuralNetworkArchitecture<T> architecture,
        string modelPath,
        MPLUGDocOwl15Options? options = null
    )
        : base(architecture)
    {
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "mPLUG-DocOwl-1.5-Native" : "mPLUG-DocOwl-1.5-ONNX",
            Description =
                "mPLUG-DocOwl 1.5: unified structure learning achieving SOTA on 10 document benchmarks.",
        ...
        m.AdditionalInfo["UnifiedStructureLearning"] =
            _options.EnableUnifiedStructureLearning.ToString();
        return m;
    }
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(MPLUGDocOwl15<T>));
    }
