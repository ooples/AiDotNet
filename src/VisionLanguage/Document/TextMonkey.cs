...
public class TextMonkey<T> : VisionLanguageModelBase<T>, IDocumentUnderstandingModel<T>
{
    ...
    public TextMonkey(
        ...
        string modelPath,
        TextMonkeyOptions? options = null
    )
        : base(architecture)
    {
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "TextMonkey-Native" : "TextMonkey-ONNX",
        ...
        m.AdditionalInfo["ShiftedWindowAttention"] =
            _options.EnableShiftedWindowAttention.ToString();
        return m;
    }
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(TextMonkey<T>));
    }
