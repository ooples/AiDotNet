...
public class MPLUGDocOwl<T> : VisionLanguageModelBase<T>, IDocumentUnderstandingModel<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata() {
        var m = new ModelMetadata<T> { Name = _useNativeMode ? "mPLUG-DocOwl-Native" : "mPLUG-DocOwl-ONNX", Description = "mPLUG-DocOwl: modular MLLM for document understanding with visual abstractor.", FeatureCount = _options.DecoderDim, Complexity = _options.NumVisionLayers + _options.NumDecoderLayers };
