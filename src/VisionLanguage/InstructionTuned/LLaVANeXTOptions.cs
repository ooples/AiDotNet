...
public class LLaVANeXTOptions : InstructionTunedVLMOptions
{
    ...
    public LLaVANeXTOptions(LLaVANeXTOptions other)
    {
        if (other == null)
        ...
        EnableAnyRes = other.EnableAnyRes;
        MaxImageTiles = other.MaxImageTiles;
    }

    public LLaVANeXTOptions()
    {
