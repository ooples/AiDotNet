...
public class DeepSeekVL2<T> : VisionLanguageModelBase<T>, IInstructionTunedVLM<T>
{
    ...
    public DeepSeekVL2(
        ...
        string modelPath,
        DeepSeekVL2Options? options = null
    )
        : base(architecture)
    {
    ...
    protected override void InitializeLayers()
    {
        ...
        else
        {
            ...
            Layers.AddRange(
                LayerHelper<T>.CreateDefaultTokenReductionVLMLayers(
                    _options.VisionDim,
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "DeepSeek-VL2-Native" : "DeepSeek-VL2-ONNX",
            Description =
                "DeepSeek-VL2: Mixture-of-Experts Vision-Language Models for Advanced Multimodal Understanding (Wu et al., 2024)",
            FeatureCount = _options.DecoderDim,
            Complexity = _options.NumVisionLayers + _options.NumDecoderLayers,
        };
        m.AdditionalInfo["Architecture"] = "DeepSeek-VL2";
    ...
    protected override void SerializeNetworkSpecificData(BinaryWriter writer)
    {
        ...
        writer.Write(_options.EnableDynamicTiling);
    ...
    protected override void DeserializeNetworkSpecificData(BinaryReader reader)
    {
        ...
        _options.EnableDynamicTiling = reader.ReadBoolean();
    ...
    protected override IFullModel<T, Tensor<T>, Tensor<T>> CreateNewInstance()
    {
        if (!_useNativeMode && _options.ModelPath is { } mp && !string.IsNullOrEmpty(mp))
            return new DeepSeekVL2<T>(Architecture, mp, _options);
        return new DeepSeekVL2<T>(Architecture, _options);
    }

    private void ThrowIfDisposed()
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(DeepSeekVL2<T>));
    }
