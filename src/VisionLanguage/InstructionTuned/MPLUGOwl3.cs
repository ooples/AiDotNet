...
public partial class MPLUGOwl3<T> : VisionLanguageModelBase<T>, IInstructionTunedVLM<T>
{
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(MPLUGOwl3<T>));
    }
