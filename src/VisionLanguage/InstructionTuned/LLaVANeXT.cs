...
{
    private readonly LLaVANeXTOptions _options;
    ...
    public LLaVANeXT(
        ...
        string modelPath,
        LLaVANeXTOptions? options = null
    )
        : base(architecture)
    {
        _options = options ?? new LLaVANeXTOptions();
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "LLaVA-NeXT-Native" : "LLaVA-NeXT-ONNX",
            Description =
        ...
        m.AdditionalInfo["Architecture"] = "LLaVA-NeXT";
        m.AdditionalInfo["InstructionType"] = _options.InstructionArchitectureType.ToString();
        m.AdditionalInfo["LanguageModel"] = _options.LanguageModelName;
        m.AdditionalInfo["AnyRes"] = _options.EnableAnyRes.ToString();
        return m;
    }
    ...
    protected override void SerializeNetworkSpecificData(BinaryWriter writer)
    {
        ...
        writer.Write(_options.EnableAnyRes);
        writer.Write(_options.MaxImageTiles);
    }
    ...
    protected override void DeserializeNetworkSpecificData(BinaryReader reader)
    {
        ...
        _options.EnableAnyRes = reader.ReadBoolean();
        _options.MaxImageTiles = reader.ReadInt32();
    ...
    protected override IFullModel<T, Tensor<T>, Tensor<T>> CreateNewInstance()
    {
        if (!_useNativeMode && _options.ModelPath is { } mp && !string.IsNullOrEmpty(mp))
            return new LLaVANeXT<T>(Architecture, mp, _options);
        return new LLaVANeXT<T>(Architecture, _options);
    }

    private void ThrowIfDisposed()
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(LLaVANeXT<T>));
    }
