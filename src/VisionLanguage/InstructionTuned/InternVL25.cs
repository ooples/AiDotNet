...
{
    private readonly InternVL25Options _options;
    ...
    public InternVL25(
        ...
        string modelPath,
        InternVL25Options? options = null
    )
        : base(architecture)
    {
        _options = options ?? new InternVL25Options();
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "InternVL2.5-Native" : "InternVL2.5-ONNX",
            Description =
        ...
        m.AdditionalInfo["Architecture"] = "InternVL2.5";
        m.AdditionalInfo["InstructionType"] = _options.InstructionArchitectureType.ToString();
        m.AdditionalInfo["LanguageModel"] = _options.LanguageModelName;
        m.AdditionalInfo["DynamicResolution"] = _options.EnableDynamicResolution.ToString();
        return m;
    }
    ...
    protected override IFullModel<T, Tensor<T>, Tensor<T>> CreateNewInstance()
    {
        if (!_useNativeMode && _options.ModelPath is { } mp && !string.IsNullOrEmpty(mp))
            return new InternVL25<T>(Architecture, mp, _options);
        return new InternVL25<T>(Architecture, _options);
    }

    private void ThrowIfDisposed()
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(InternVL25<T>));
    }
