...
public class InternVL3<T> : VisionLanguageModelBase<T>, IInstructionTunedVLM<T>
{
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "InternVL3-Native" : "InternVL3-ONNX",
            Description =
        ...
        m.AdditionalInfo["Architecture"] = "InternVL3";
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(InternVL3<T>));
    }
