...
public class DeepSeekVL<T> : VisionLanguageModelBase<T>, IInstructionTunedVLM<T>
{
    ...
    public DeepSeekVL(
        ...
        string modelPath,
        DeepSeekVLOptions? options = null
    )
        : base(architecture)
    {
    ...
    public override ModelMetadata<T> GetModelMetadata()
    {
        ...
        {
            Name = _useNativeMode ? "DeepSeek-VL-Native" : "DeepSeek-VL-ONNX",
            Description =
        ...
        m.AdditionalInfo["Architecture"] = "DeepSeek-VL";
        m.AdditionalInfo["InstructionType"] = _options.InstructionArchitectureType.ToString();
        m.AdditionalInfo["LanguageModel"] = _options.LanguageModelName;
        m.AdditionalInfo["HybridEncoder"] = _options.UseHybridEncoder.ToString();
        return m;
    }
    ...
    protected override void SerializeNetworkSpecificData(BinaryWriter writer)
    {
        ...
        writer.Write(_options.UseHybridEncoder);
    }
    ...
    protected override void DeserializeNetworkSpecificData(BinaryReader reader)
    {
        ...
        _options.UseHybridEncoder = reader.ReadBoolean();
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(DeepSeekVL<T>));
    }
