...
public partial class Qwen2VL<T> : VisionLanguageModelBase<T>, IInstructionTunedVLM<T>
{
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(GetType().FullName ?? nameof(Qwen2VL<T>));
    }
