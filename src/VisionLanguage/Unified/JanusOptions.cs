...
/// </summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the Janus model. Default values follow the original paper settings.</para>
/// </remarks>
public class JanusOptions : UnifiedVisionOptions
{
    ...
    public JanusOptions(JanusOptions other)
    {
        if (other == null)
