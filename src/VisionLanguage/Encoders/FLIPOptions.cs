...
public class FLIPOptions : ContrastiveEncoderOptions
{
    ...
    public FLIPOptions(FLIPOptions other)
    {
        if (other == null)
        ...
        MaskingRatio = other.MaskingRatio;
        UseUnmaskedTuning = other.UseUnmaskedTuning;
        UnmaskedTuningEpochs = other.UnmaskedTuningEpochs;
    }
