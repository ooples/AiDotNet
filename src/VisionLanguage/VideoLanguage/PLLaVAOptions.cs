...
/// </summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the PLLaVA model. Default values follow the original paper settings.</para>
/// </remarks>
public class PLLaVAOptions : VideoLanguageOptions
{
    ...
    public PLLaVAOptions(PLLaVAOptions other)
    {
        if (other == null)
        ...
        EnableParameterFreePooling = other.EnableParameterFreePooling;
    }
