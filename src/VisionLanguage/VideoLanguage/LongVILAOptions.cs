...
/// </summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the LongVILA model. Default values follow the original paper settings.</para>
/// </remarks>
public class LongVILAOptions : VideoLanguageOptions
{
    ...
    public LongVILAOptions(LongVILAOptions other)
    {
        if (other == null)
        ...
        MaxVideoMinutes = other.MaxVideoMinutes;
    }
