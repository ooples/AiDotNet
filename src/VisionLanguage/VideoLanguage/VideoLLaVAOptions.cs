...
/// </summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the VideoLLaVA model. Default values follow the original paper settings.</para>
/// </remarks>
public class VideoLLaVAOptions : VideoLanguageOptions
{
    ...
    public VideoLLaVAOptions(VideoLLaVAOptions other)
    {
        if (other == null)
