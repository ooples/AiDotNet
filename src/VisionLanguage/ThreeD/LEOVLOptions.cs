...
/// </summary>
/// <remarks>
/// <para><b>For Beginners:</b> These options configure the LEOVL model. Default values follow the original paper settings.</para>
/// </remarks>
public class LEOVLOptions : ThreeDVLMOptions
{
    ...
    public LEOVLOptions(LEOVLOptions other)
    {
        if (other == null)
