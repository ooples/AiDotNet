...
public class HuBERTSER<T> : AudioClassifierBase<T>, IEmotionRecognizer<T>
{
    ...
    protected override void SerializeNetworkSpecificData(BinaryWriter w)
    {
        ...
        w.Write(_options.ClassifierHiddenDim); w.Write(_options.NumClasses); w.Write(_options.DropoutRate);
    ...
    protected override void DeserializeNetworkSpecificData(BinaryReader r)
    {
        ...
        _options.ClassifierHiddenDim = r.ReadInt32(); _options.NumClasses = r.ReadInt32(); _options.DropoutRate = r.ReadDouble();
    ...
    protected override IFullModel<T, Tensor<T>, Tensor<T>> CreateNewInstance() => new HuBERTSER<T>(Architecture, _options);
