...
public readonly struct Complex<T>
{
    ...
    /// - The phase of 0 + 1i is π/2 radians (90 degrees)
    /// - The phase of -1 + 0i is π radians (180 degrees)
    /// - The phase of 0 - 1i is -π/2 radians (-90 degrees)
    /// </para>
    /// </remarks>
    ...
    /// 2. Polar form: r∠θ (using magnitude and angle)
    /// </para>
    /// <para>
    /// This method converts from polar form to the standard rectangular form. The magnitude (r)
    /// represents the distance from the origin, and the phase (θ) represents the angle from the
