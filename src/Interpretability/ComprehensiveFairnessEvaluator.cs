...
{
    /// <summary>
    /// Comprehensive fairness evaluator that computes all major fairness metrics.
    /// Includes demographic parity, equal opportunity, equalized odds, predictive parity,
    /// disparate impact, and statistical parity difference.
    /// </summary>
    /// <typeparam name="T">The numeric type for calculations.</typeparam>
    public class ComprehensiveFairnessEvaluator<T> : FairnessEvaluatorBase<T>
    {
        /// <summary>
        /// Initializes a new instance of the ComprehensiveFairnessEvaluator class.
        /// </summary>
        public ComprehensiveFairnessEvaluator() : base(isHigherFairnessBetter: false)
        {
