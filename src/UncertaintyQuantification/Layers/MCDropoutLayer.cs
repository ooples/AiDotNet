...
public class MCDropoutLayer<T> : LayerBase<T>
{
    ...
    public override Tensor<T> Forward(Tensor<T> input)
    {
        ...
        return input.Shape.Length > 1 ? outputTensor.Reshape(input.Shape._dims) : outputTensor;
    }
    ...
    public override Tensor<T> Backward(Tensor<T> outputGradient)
    {
        ...
        return _lastInput.Value.Shape.Length > 1 ? inputGradientTensor.Reshape(_lastInput.Value.Shape._dims) : inputGradientTensor;
    }
