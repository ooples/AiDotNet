...
public interface IUncertaintyEstimator<T>
{
    ...
    /// <returns>A tuple containing the mean prediction and uncertainty variance.</returns>
    /// <remarks>
    ...
    /// </remarks>
    (Tensor<T> mean, Tensor<T> uncertainty) PredictWithUncertainty(Tensor<T> input);
