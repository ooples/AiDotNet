...
/// <remarks>
/// <para>
/// The SQRBF activation function is defined as f(x) = exp(-β * x²), where β is a parameter that controls
...
/// The β parameter controls how quickly the output drops off as you move away from 0:
/// - A larger β makes the bell curve narrower (drops off quickly)
/// - A smaller β makes the bell curve wider (drops off slowly)
/// 
...
public class SQRBFActivation<T> : ActivationFunctionBase<T>
{
    ...
    /// <remarks>
    /// <para>
    /// The derivative of the SQRBF function is calculated as f'(x) = -2βx * exp(-β * x²).
