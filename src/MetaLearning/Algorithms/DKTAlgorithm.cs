...
/// </para>
/// </remarks>
internal class DKTModel<T, TInput, TOutput> : MetaLearningModelBase<T, TInput, TOutput>, IAdaptedMetaModel<T>
{
    ...
    {
        return new DKTModel<T, TInput, TOutput>(BaseModel, parameters, _gpWeights, _lengthScale, _noiseVariance, _modulationFactors);
    }
    ...
    {
        return new DKTModel<T, TInput, TOutput>(
            BaseModel.DeepCopy(), _backboneParams.Clone(), _gpWeights?.Clone(),
            _lengthScale, _noiseVariance,
