...
/// </para>
/// </remarks>
internal class LaplacianShotModel<T, TInput, TOutput> : MetaLearningModelBase<T, TInput, TOutput>, IAdaptedMetaModel<T>
{
    ...
    {
        return new LaplacianShotModel<T, TInput, TOutput>(BaseModel, parameters, _refinedWeights, _modulationFactors);
    }

    /// <inheritdoc/>
    public override IFullModel<T, TInput, TOutput> DeepCopy()
    {
        return new LaplacianShotModel<T, TInput, TOutput>(
