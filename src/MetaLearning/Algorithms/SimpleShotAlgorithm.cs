...
[ModelPaper("SimpleShot: Revisiting Nearest-Neighbor Classification for Few-Shot Learning", "https://arxiv.org/abs/1911.04623", Year = 2019, Authors = "Yan Wang, Wei-Lun Chao, Kilian Q. Weinberger, Laurens van der Maaten")]
...
/// </para>
/// </remarks>
internal class SimpleShotModel<T, TInput, TOutput> : MetaLearningModelBase<T, TInput, TOutput>, IAdaptedMetaModel<T>
{
    ...
    {
        return new SimpleShotModel<T, TInput, TOutput>(BaseModel, parameters, _supportFeatures, _modulationFactors);
    }
