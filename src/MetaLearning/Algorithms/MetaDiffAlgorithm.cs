...
[ResearchPaper("MetaDiff: Meta-Learning with Conditional Diffusion for Few-Shot Learning",
...
public partial class MetaDiffAlgorithm<T, TInput, TOutput> : MetaLearnerBase<T, TInput, TOutput>
{
