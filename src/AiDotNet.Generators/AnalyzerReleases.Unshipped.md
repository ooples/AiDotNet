...
AIDN060 | AiDotNet.TypeSafety | Warning | HardcodedDoubleAnalyzer, Hardcoded double field in generic <T> class
AIDN061 | AiDotNet.TypeSafety | Warning | HardcodedDoubleAnalyzer, Hardcoded double[] field in generic <T> class
AIDN062 | AiDotNet.TypeSafety | Warning | HardcodedDoubleAnalyzer, Hardcoded double[,]/double[][] field in generic <T> class
