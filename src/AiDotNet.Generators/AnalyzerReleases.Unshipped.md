...
AIDN060 | AiDotNet.TypeSafety | Info | HardcodedDoubleAnalyzer, Hardcoded double field in generic <T> class
AIDN061 | AiDotNet.TypeSafety | Info | HardcodedDoubleAnalyzer, Hardcoded double[] field in generic <T> class
AIDN062 | AiDotNet.TypeSafety | Info | HardcodedDoubleAnalyzer, Hardcoded double[,]/double[][] field in generic <T> class
