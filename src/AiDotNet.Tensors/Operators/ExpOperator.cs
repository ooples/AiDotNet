...
/// <summary>
/// Implements the exponential function (e^x) using hardware-accelerated SIMD instructions.
/// </summary>
/// <remarks>
/// <para>
/// This operator provides optimized implementations of exp(x) for:
...
/// <para>
/// <b>Algorithm:</b>
/// For scalar operations, delegates to Math.Exp for maximum accuracy.
...
/// <para>
/// <b>Performance:</b>
/// SIMD implementations provide 4-12x speedup over scalar Math.Exp for large arrays.
/// </para>
/// </remarks>
public readonly struct ExpOperatorDouble : IUnaryOperator<double, double>
{
    /// <summary>
    /// Computes e^x for a single double value.
    /// </summary>
    public double Invoke(double x) => Math.Exp(x);

#if NET5_0_OR_GREATER
    /// <summary>
    /// Computes e^x for a Vector128 of doubles (2 values).
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Computes e^x for a Vector256 of doubles (4 values).
    /// </summary>
    ...
    /// <summary>
    /// Computes e^x for a Vector512 of doubles (8 values).
    /// </summary>
...
/// <summary>
/// Implements the exponential function (e^x) for single-precision floats using hardware-accelerated SIMD instructions.
/// </summary>
public readonly struct ExpOperatorFloat : IUnaryOperator<float, float>
{
    /// <summary>
    /// Computes e^x for a single float value.
    /// </summary>
    public float Invoke(float x) => MathF.Exp(x);

#if NET5_0_OR_GREATER
    /// <summary>
    /// Computes e^x for a Vector128 of floats (4 values).
    /// </summary>
    ...
    /// <summary>
    /// Computes e^x for a Vector256 of floats (8 values).
    /// </summary>
    ...
    /// <summary>
    /// Computes e^x for a Vector512 of floats (16 values).
    /// </summary>
