...
/// <summary>
/// Implements the hyperbolic cosine function (cosh(x)) using hardware-accelerated SIMD instructions.
/// </summary>
public readonly struct CoshOperatorDouble : IUnaryOperator<double, double>
{
    /// <summary>
    /// Computes cosh(x) for a single double value.
    /// </summary>
    public double Invoke(double x) => Math.Cosh(x);

#if NET5_0_OR_GREATER
    /// <summary>
    /// Computes cosh(x) for a Vector128 of doubles (2 values).
    /// </summary>
    ...
    /// <summary>
    /// Computes cosh(x) for a Vector256 of doubles (4 values).
    /// </summary>
    ...
    /// <summary>
    /// Computes cosh(x) for a Vector512 of doubles (8 values).
    /// </summary>
...
/// <summary>
/// Implements the hyperbolic cosine function (cosh(x)) for single-precision floats using hardware-accelerated SIMD instructions.
/// </summary>
public readonly struct CoshOperatorFloat : IUnaryOperator<float, float>
{
    /// <summary>
    /// Computes cosh(x) for a single float value.
    /// </summary>
    public float Invoke(float x) => MathF.Cosh(x);

#if NET5_0_OR_GREATER
    /// <summary>
    /// Computes cosh(x) for a Vector128 of floats (4 values).
    /// </summary>
    ...
    /// <summary>
    /// Computes cosh(x) for a Vector256 of floats (8 values).
    /// </summary>
    ...
    /// <summary>
    /// Computes cosh(x) for a Vector512 of floats (16 values).
    /// </summary>
