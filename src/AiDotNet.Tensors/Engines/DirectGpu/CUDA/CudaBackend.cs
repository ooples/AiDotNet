...
public sealed class CudaBackend : IDirectGpuBackend
{
    ...
    {
        if (!_kernelCache.TryGetValue("sgd_step", out var kernel))
            throw new InvalidOperationException("CUDA kernel not found: sgd_step");
    ...
    {
        if (!_kernelCache.TryGetValue("adam_step", out var kernel))
            throw new InvalidOperationException("CUDA kernel not found: adam_step");
    ...
    public unsafe void AdamWUpdate(IGpuBuffer param, IGpuBuffer gradient, IGpuBuffer m, IGpuBuffer v,
        float learningRate, float beta1, float beta2, float epsilon, float weightDecay, int step, int size)
    {
        if (!_kernelCache.TryGetValue("adamw_step", out var kernel))
            throw new InvalidOperationException("CUDA kernel not found: adamw_step");
    ...
    {
        if (!_kernelCache.TryGetValue("rmsprop_step", out var kernel))
            throw new InvalidOperationException("CUDA kernel not found: rmsprop_step");
    ...
    {
        if (!_kernelCache.TryGetValue("adagrad_step", out var kernel))
            throw new InvalidOperationException("CUDA kernel not found: adagrad_step");
    ...
    public unsafe void NagUpdate(IGpuBuffer param, IGpuBuffer gradient, IGpuBuffer velocity,
        float learningRate, float momentum, float weightDecay, int size)
    {
        if (!_kernelCache.TryGetValue("nag_step", out var kernel))
            throw new InvalidOperationException("CUDA kernel not found: nag_step");
    ...
    {
        if (!_kernelCache.TryGetValue("lars_step", out var kernel))
            throw new InvalidOperationException("CUDA kernel not found: lars_step");
    ...
    public unsafe void LambUpdate(IGpuBuffer param, IGpuBuffer gradient, IGpuBuffer m, IGpuBuffer v,
        float learningRate, float beta1, float beta2, float epsilon, float weightDecay, int step, int size)
    {
        if (!_kernelCache.TryGetValue("lamb_step", out var kernel))
            throw new InvalidOperationException("CUDA kernel not found: lamb_step");
        ...
        float learningRate, float weightDecay, int size)
    {
        ...
        args[3] = &weightDecay;
        int sizeArg = size;
        void** args2 = stackalloc void*[5];
        args2[0] = &paramPtr;
        args2[1] = &gradPtr;
        args2[2] = &learningRate;
        args2[3] = &weightDecay;
        args2[4] = &sizeArg;
        LaunchKernel(kernel, grid, DefaultBlockSize, args2);
    }
        ...
        float rho, float epsilon, float weightDecay, int size)
    {
        ...
        args2[0] = &paramPtr;
        args2[1] = &gradPtr;
        args2[2] = &accumGradPtr;
        args2[3] = &accumUpdatePtr;
        args2[4] = &rho;
        args2[5] = &epsilon;
        args2[6] = &weightDecay;
        args2[7] = &sizeArg;
