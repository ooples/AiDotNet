...
// Fused operation kernels for CUDA - GEMM + Bias + Activation in single pass.
// Eliminates memory round-trips for 20-50% performance gain.

namespace AiDotNet.Tensors.Engines.DirectGpu.CUDA.Kernels
{
    /// <summary>
    /// Fused CUDA kernels that combine multiple operations to eliminate memory round-trips.
    /// Uses shared memory tiling for optimal GPU performance.
    /// </summary>
    internal static class CudaFusedKernels
    {
        /// <summary>
