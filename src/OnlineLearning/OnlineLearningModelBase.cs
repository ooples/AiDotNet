...
public abstract class OnlineLearningModelBase<T> : IOnlineLearningModel<T>, IModelShape
{
    ...
    public virtual IFullModel<T, Matrix<T>, Vector<T>> DeepCopy()
    {
        ...
        using (ModelPersistenceGuard.InternalOperation())
        {
            ...
            if (copy is OnlineLearningModelBase<T> copyBase)
            {
    ...
    /// <summary>Releases resources held by this online-learning model. Override + call base for layer/tensor cleanup.</summary>
