...
public readonly struct PooledArray<T> : IDisposable
{
    ...
    /// <summary>
    /// Explicit conversion to the underlying array.
    /// </summary>
    /// <remarks>
    /// This conversion is explicit to prevent accidental use-after-return bugs.
    /// Use the <see cref="Array"/> property directly instead.
    /// </remarks>
    public static explicit operator T[](PooledArray<T> pooled) => pooled.Array;
