...
public partial class AiModelBuilder<T, TInput, TOutput> : IAiModelBuilder<T, TInput, TOutput>, AiDotNet.Configuration.IConfiguredView<T, TInput, TOutput>
{
    ...
    // Optional user-supplied speculative-decoding draft model (ConfigureDraftModel). Live object, in-process
    // serving only; used by the serving engine when DraftModelType is Custom.
