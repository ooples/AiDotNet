...
try {
    ...
    Check ($runnerCases.Count -eq 111 -and @($runnerCases | Where-Object { $_.outcome -cne 'Passed' }).Count -eq 0) `
    ...
    Check ($effectsCases.Count -eq 451 -and @($effectsCases | Where-Object { $_.outcome -cne 'Passed' }).Count -eq 0) `
